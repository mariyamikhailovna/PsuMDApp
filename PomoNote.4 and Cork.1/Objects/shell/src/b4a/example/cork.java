...
public static b4a.example.editnote _editnote = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",cork.mostCurrent._activity,"addPnl",cork.mostCurrent._addpnl,"boardPnl",cork.mostCurrent._boardpnl,"canvaBtn",cork.mostCurrent._canvabtn,"clock",Debug.moduleToString(b4a.example.clock.class),"editnote",Debug.moduleToString(b4a.example.editnote.class),"imgBtn",cork.mostCurrent._imgbtn,"LastX",cork._lastx,"LastY",cork._lasty,"Main",Debug.moduleToString(b4a.example.main.class),"note",Debug.moduleToString(b4a.example.note.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"stickyBtn",cork.mostCurrent._stickybtn,"stickyTxt",cork.mostCurrent._stickytxt,"stringBtn",cork.mostCurrent._stringbtn};
}
}