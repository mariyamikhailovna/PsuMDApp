...
try {
		Debug.PushSubsStack("addBtn_Click (note) ","note",3,note.mostCurrent.activityBA,note.mostCurrent,124);
if (RapidSub.canDelegate("addbtn_click")) { return b4a.example.note.remoteMe.runUserSub(false, "note","addbtn_click");}
 BA.debugLineNum = 124;BA.debugLine="Sub addBtn_Click";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 126;BA.debugLine="StartActivity(editnote)";
Debug.ShouldStop(536870912);
...
//C
this.state = 4;
 BA.debugLineNum = 50;BA.debugLine="Main.kvs.Remove(\"N_\" & n.noteID)";
Debug.ShouldStop(131072);
parent.mostCurrent._main._kvs /*RemoteObject*/ .runClassMethod (b4a.example.keyvaluestore.class, "_remove" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("N_"),_n.getField(true,"noteID" /*RemoteObject*/ ))));
...
try {
		Debug.PushSubsStack("noteCvl_ItemClick (note) ","note",3,note.mostCurrent.activityBA,note.mostCurrent,129);
...
Debug.locals.put("Index", _index);
Debug.locals.put("Value", _value);
 BA.debugLineNum = 129;BA.debugLine="Sub noteCvl_ItemClick (Index As Int, Value As Obje";
Debug.ShouldStop(1);
...
try {
		Debug.PushSubsStack("RefreshList (note) ","note",3,note.mostCurrent.activityBA,note.mostCurrent,90);
if (RapidSub.canDelegate("refreshlist")) { return b4a.example.note.remoteMe.runUserSub(false, "note","refreshlist", _searchquery);}
...
Debug.locals.put("SearchQuery", _searchquery);
 BA.debugLineNum = 90;BA.debugLine="Sub RefreshList(SearchQuery As String)";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 91;BA.debugLine="noteClv.Clear";
Debug.ShouldStop(67108864);
note.mostCurrent._noteclv.runVoidMethod ("_clear");
 BA.debugLineNum = 93;BA.debugLine="Dim AllNotes As List";
Debug.ShouldStop(268435456);
_allnotes = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("AllNotes", _allnotes);
 BA.debugLineNum = 94;BA.debugLine="AllNotes.Initialize";
Debug.ShouldStop(536870912);
_allnotes.runVoidMethod ("Initialize");
 BA.debugLineNum = 96;BA.debugLine="Dim keys As List = Main.kvs.ListKeys";
Debug.ShouldStop(-2147483648);
...
_keys = note.mostCurrent._main._kvs /*RemoteObject*/ .runClassMethod (b4a.example.keyvaluestore.class, "_listkeys" /*RemoteObject*/ );Debug.locals.put("keys", _keys);Debug.locals.put("keys", _keys);
 BA.debugLineNum = 98;BA.debugLine="For Each k As String In keys";
Debug.ShouldStop(2);
{
...
Debug.locals.put("k", _k);
 BA.debugLineNum = 99;BA.debugLine="If k.StartsWith(\"N_\") Then";
Debug.ShouldStop(4);
if (_k.runMethod(true,"startsWith",(Object)(RemoteObject.createImmutable("N_"))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 100;BA.debugLine="Dim n As MyNote = Main.kvs.Get(k)";
Debug.ShouldStop(8);
_n = (note.mostCurrent._main._kvs /*RemoteObject*/ .runClassMethod (b4a.example.keyvaluestore.class, "_get" /*RemoteObject*/ ,(Object)(_k)));Debug.locals.put("n", _n);Debug.locals.put("n", _n);
 BA.debugLineNum = 101;BA.debugLine="Dim query As String = SearchQuery.ToLowerCase";
Debug.ShouldStop(16);
_query = _searchquery.runMethod(true,"toLowerCase");Debug.locals.put("query", _query);Debug.locals.put("query", _query);
 BA.debugLineNum = 102;BA.debugLine="If query = \"\" Then";
Debug.ShouldStop(32);
if (RemoteObject.solveBoolean("=",_query,BA.ObjectToString(""))) { 
 BA.debugLineNum = 103;BA.debugLine="AllNotes.Add(n)";
Debug.ShouldStop(64);
_allnotes.runVoidMethod ("Add",(Object)((_n)));
 }else {
 BA.debugLineNum = 105;BA.debugLine="If n.Tags.ToLowerCase.Contains(query) Or n.Tit";
...
if (RemoteObject.solveBoolean(".",_n.getField(true,"Tags" /*RemoteObject*/ ).runMethod(true,"toLowerCase").runMethod(true,"contains",(Object)(_query))) || RemoteObject.solveBoolean(".",_n.getField(true,"Title" /*RemoteObject*/ ).runMethod(true,"toLowerCase").runMethod(true,"contains",(Object)(_query)))) { 
 BA.debugLineNum = 106;BA.debugLine="AllNotes.Add(n)";
...
;
 BA.debugLineNum = 112;BA.debugLine="AllNotes.SortType(\"Title\", True)";
Debug.ShouldStop(32768);
_allnotes.runVoidMethod ("SortType",(Object)(BA.ObjectToString("Title")),(Object)(note.mostCurrent.__c.getField(true,"True")));
 BA.debugLineNum = 114;BA.debugLine="For Each n As MyNote In AllNotes";
Debug.ShouldStop(131072);
{
...
Debug.locals.put("n", _n);
 BA.debugLineNum = 115;BA.debugLine="noteClv.AddTextItem(n.Title & CRLF & n.Tags, n)";
Debug.ShouldStop(262144);
...
try {
		Debug.PushSubsStack("searchTxt_TextChanged (note) ","note",3,note.mostCurrent.activityBA,note.mostCurrent,120);
if (RapidSub.canDelegate("searchtxt_textchanged")) { return b4a.example.note.remoteMe.runUserSub(false, "note","searchtxt_textchanged", _old, _new);}
Debug.locals.put("Old", _old);
Debug.locals.put("New", _new);
 BA.debugLineNum = 120;BA.debugLine="Sub searchTxt_TextChanged (Old As String, New As S";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 121;BA.debugLine="RefreshList(New)";
Debug.ShouldStop(16777216);
_refreshlist(_new);
