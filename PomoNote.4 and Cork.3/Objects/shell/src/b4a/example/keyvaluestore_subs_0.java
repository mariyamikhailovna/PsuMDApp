...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","94390935",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.runMethod(false,"getActivityBA"))),0);
 if (true) break;
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","94456456",RemoteObject.concat(RemoteObject.createImmutable("Failed to serialize object: "),_map.runMethod(false,"Get",(Object)((_key)))),0);
 if (true) break;
