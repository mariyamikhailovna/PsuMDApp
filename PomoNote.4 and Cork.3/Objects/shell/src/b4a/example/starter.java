...
public static b4a.example.cork _cork = null;
  public Object[] GetGlobals() {
		return new Object[] {"clock",Debug.moduleToString(b4a.example.clock.class),"cork",Debug.moduleToString(b4a.example.cork.class),"editnote",Debug.moduleToString(b4a.example.editnote.class),"Main",Debug.moduleToString(b4a.example.main.class),"note",Debug.moduleToString(b4a.example.note.class),"Service",starter.mostCurrent._service};
}
}