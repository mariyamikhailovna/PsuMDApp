...
public static b4a.example.cork _cork = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"clock",Debug.moduleToString(b4a.example.clock.class),"clockBtn",main.mostCurrent._clockbtn,"cork",Debug.moduleToString(b4a.example.cork.class),"format24h",main._format24h,"note",Debug.moduleToString(b4a.example.note.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"timerClock",main._timerclock,"xui",main._xui};
}
}