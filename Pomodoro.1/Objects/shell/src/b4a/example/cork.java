...
public static b4a.example.note _note = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",cork.mostCurrent._activity,"clock",Debug.moduleToString(b4a.example.clock.class),"Main",Debug.moduleToString(b4a.example.main.class),"note",Debug.moduleToString(b4a.example.note.class),"Starter",Debug.moduleToString(b4a.example.starter.class)};
}
}