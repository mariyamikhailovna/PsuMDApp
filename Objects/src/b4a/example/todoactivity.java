...
RDebugUtils.currentLine=24510471;
 //BA.debugLineNum = 24510471;BA.debugLine="If Starter.darkMode Then";
if (mostCurrent._starter._darkmode /*boolean*/ ) { 
RDebugUtils.currentLine=24510472;
 //BA.debugLineNum = 24510472;BA.debugLine="addTaskPanel.Color = Colors.ARGB(255, 17, 17, 17";
...
RDebugUtils.currentLine=24510474;
 //BA.debugLineNum = 24510474;BA.debugLine="addTaskPanel.Color = Colors.ARGB(255, 247, 247,";
...
RDebugUtils.currentLine=24510478;
 //BA.debugLineNum = 24510478;BA.debugLine="addTaskTextArea.Initialize(\"addTodoText\")";
mostCurrent._addtasktextarea.Initialize(mostCurrent.activityBA,"addTodoText");
RDebugUtils.currentLine=24510479;
 //BA.debugLineNum = 24510479;BA.debugLine="addTaskTextArea.Hint = \"Add a task...\"";
mostCurrent._addtasktextarea.setHint("Add a task...");
RDebugUtils.currentLine=24510480;
 //BA.debugLineNum = 24510480;BA.debugLine="If Starter.darkMode Then";
if (mostCurrent._starter._darkmode /*boolean*/ ) { 
RDebugUtils.currentLine=24510481;
 //BA.debugLineNum = 24510481;BA.debugLine="addTaskTextArea.HintColor = Colors.ARGB(255, 247";
...
RDebugUtils.currentLine=24510483;
 //BA.debugLineNum = 24510483;BA.debugLine="addTaskPanel.Color = Colors.ARGB(255, 17, 17, 17";
mostCurrent._addtaskpanel.setColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (255),(int) (17),(int) (17),(int) (17)));
 };
RDebugUtils.currentLine=24510485;
 //BA.debugLineNum = 24510485;BA.debugLine="addTaskTextArea.Tag = Null";
mostCurrent._addtasktextarea.setTag(anywheresoftware.b4a.keywords.Common.Null);
RDebugUtils.currentLine=24510487;
 //BA.debugLineNum = 24510487;BA.debugLine="enterTaskBtn.Initialize(\"enterTaskBtn\")";
mostCurrent._entertaskbtn.Initialize(mostCurrent.activityBA,"enterTaskBtn");
RDebugUtils.currentLine=24510488;
 //BA.debugLineNum = 24510488;BA.debugLine="enterTaskBtn.Text = \"Enter task\"";
mostCurrent._entertaskbtn.setText(BA.ObjectToCharSequence("Enter task"));
RDebugUtils.currentLine=24510490;
 //BA.debugLineNum = 24510490;BA.debugLine="addTaskPanel.AddView(addTaskTextArea, 0, 0, addTa";
...
RDebugUtils.currentLine=24510491;
 //BA.debugLineNum = 24510491;BA.debugLine="addTaskPanel.AddView(enterTaskBtn, 0, 50dip, addT";
...
RDebugUtils.currentLine=24510493;
 //BA.debugLineNum = 24510493;BA.debugLine="tasksList.Add(addTaskPanel, addTaskPanel)";
...
RDebugUtils.currentLine=24838155;
 //BA.debugLineNum = 24838155;BA.debugLine="If Starter.darkMode Then";
if (mostCurrent._starter._darkmode /*boolean*/ ) { 
RDebugUtils.currentLine=24838156;
 //BA.debugLineNum = 24838156;BA.debugLine="taskLBL.Initialize(\"taskLBL\")";
_tasklbl.Initialize(mostCurrent.activityBA,"taskLBL");
RDebugUtils.currentLine=24838157;
 //BA.debugLineNum = 24838157;BA.debugLine="taskLBL.Text = newTask";
_tasklbl.setText(BA.ObjectToCharSequence(_newtask));
RDebugUtils.currentLine=24838158;
 //BA.debugLineNum = 24838158;BA.debugLine="taskLBL.TextColor = Colors.White";
_tasklbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
RDebugUtils.currentLine=24838159;
 //BA.debugLineNum = 24838159;BA.debugLine="taskPNL.AddView(taskLBL, 40dip, 20dip, taskPNL.W";
...
RDebugUtils.currentLine=24838161;
 //BA.debugLineNum = 24838161;BA.debugLine="taskLBL.Initialize(\"taskLBL\")";
_tasklbl.Initialize(mostCurrent.activityBA,"taskLBL");
RDebugUtils.currentLine=24838162;
 //BA.debugLineNum = 24838162;BA.debugLine="taskLBL.Text = newTask";
_tasklbl.setText(BA.ObjectToCharSequence(_newtask));
RDebugUtils.currentLine=24838163;
 //BA.debugLineNum = 24838163;BA.debugLine="taskLBL.TextColor = Colors.Black";
_tasklbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
RDebugUtils.currentLine=24838164;
 //BA.debugLineNum = 24838164;BA.debugLine="taskPNL.AddView(taskLBL, 40dip, 20dip, taskPNL.W";
_taskpnl.AddView((android.view.View)(_tasklbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20)),(int) (_taskpnl.getWidth()-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (80))),_taskpnl.getHeight());
 };
RDebugUtils.currentLine=24838168;
 //BA.debugLineNum = 24838168;BA.debugLine="Dim divider As Panel";
_divider = new anywheresoftware.b4a.objects.PanelWrapper();
RDebugUtils.currentLine=24838169;
 //BA.debugLineNum = 24838169;BA.debugLine="divider.Initialize(\"line\")";
_divider.Initialize(mostCurrent.activityBA,"line");
RDebugUtils.currentLine=24838170;
 //BA.debugLineNum = 24838170;BA.debugLine="divider.Color = Colors.ARGB(255, 60, 60, 60)";
...
RDebugUtils.currentLine=24838171;
 //BA.debugLineNum = 24838171;BA.debugLine="taskPNL.AddView(divider, 0, 59dip, taskPNL.Width,";
...
RDebugUtils.currentLine=24838173;
 //BA.debugLineNum = 24838173;BA.debugLine="taskCheckbox.Tag = taskLBL";
_taskcheckbox.setTag((Object)(_tasklbl.getObject()));
RDebugUtils.currentLine=24838176;
 //BA.debugLineNum = 24838176;BA.debugLine="Dim checkedKey As String = \"checked_\" & currentLi";
_checkedkey = "checked_"+mostCurrent._currentlist+"_"+_newtask;
RDebugUtils.currentLine=24838177;
 //BA.debugLineNum = 24838177;BA.debugLine="If kvs.ContainsKey(checkedKey) Then";
if (_kvs._containskey(_checkedkey)) { 
RDebugUtils.currentLine=24838178;
 //BA.debugLineNum = 24838178;BA.debugLine="Dim isChecked As Boolean = kvs.Get(checkedKey)";
_ischecked = BA.ObjectToBoolean(_kvs._get(_checkedkey));
RDebugUtils.currentLine=24838179;
 //BA.debugLineNum = 24838179;BA.debugLine="taskCheckbox.Checked = isChecked";
_taskcheckbox.setChecked(_ischecked);
RDebugUtils.currentLine=24838180;
 //BA.debugLineNum = 24838180;BA.debugLine="If isChecked Then";
if (_ischecked) { 
RDebugUtils.currentLine=24838181;
 //BA.debugLineNum = 24838181;BA.debugLine="taskLBL.TextColor = Colors.ARGB(50, 0, 0, 0)";
...
RDebugUtils.currentLine=24838185;
 //BA.debugLineNum = 24838185;BA.debugLine="tasksList.Add(taskPNL, newTask)";
...
RDebugUtils.currentLine=24838187;
 //BA.debugLineNum = 24838187;BA.debugLine="End Sub";
return "";
}
