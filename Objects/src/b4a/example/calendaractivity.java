...
RDebugUtils.currentLine=12779534;
 //BA.debugLineNum = 12779534;BA.debugLine="Dim currentyear As Int = DateTime.GetYear(DateTim";
...
RDebugUtils.currentLine=12779535;
 //BA.debugLineNum = 12779535;BA.debugLine="Dim years As List";
_years = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=12779536;
 //BA.debugLineNum = 12779536;BA.debugLine="years.Initialize";
_years.Initialize();
RDebugUtils.currentLine=12779537;
 //BA.debugLineNum = 12779537;BA.debugLine="For i = currentyear -10 To currentyear+10";
{
final int step12 = 1;
...
RDebugUtils.currentLine=12779538;
 //BA.debugLineNum = 12779538;BA.debugLine="years.Add(i)";
_years.Add((Object)(_i));
 }
};
RDebugUtils.currentLine=12779540;
 //BA.debugLineNum = 12779540;BA.debugLine="YearSP.AddAll(years)";
mostCurrent._yearsp.AddAll(_years);
RDebugUtils.currentLine=12779541;
 //BA.debugLineNum = 12779541;BA.debugLine="YearSP.SelectedIndex = 10";
mostCurrent._yearsp.setSelectedIndex((int) (10));
RDebugUtils.currentLine=12779544;
 //BA.debugLineNum = 12779544;BA.debugLine="MonthSp.AddAll(Months)";
...
RDebugUtils.currentLine=12779545;
 //BA.debugLineNum = 12779545;BA.debugLine="MonthSp.SelectedIndex = DateTime.GetMonth(DateTim";
...
RDebugUtils.currentLine=12779548;
 //BA.debugLineNum = 12779548;BA.debugLine="DrawCalendar(DateTime.GetMonth(DateTime.Now), Dat";
...
RDebugUtils.currentLine=12779551;
 //BA.debugLineNum = 12779551;BA.debugLine="Dim cd As ColorDrawable";
_cd = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
RDebugUtils.currentLine=12779552;
 //BA.debugLineNum = 12779552;BA.debugLine="cd.Initialize2(Colors.White, 0, 2dip, Colors.Blac";
...
RDebugUtils.currentLine=12779554;
 //BA.debugLineNum = 12779554;BA.debugLine="Dim column As Int = 7";
_column = (int) (7);
RDebugUtils.currentLine=12779555;
 //BA.debugLineNum = 12779555;BA.debugLine="Dim cellW As Int = calendarpanel.Width/column";
_cellw = (int) (mostCurrent._calendarpanel.getWidth()/(double)_column);
RDebugUtils.currentLine=12779556;
 //BA.debugLineNum = 12779556;BA.debugLine="Dim cellH As Int = 60dip";
_cellh = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60));
RDebugUtils.currentLine=12779557;
 //BA.debugLineNum = 12779557;BA.debugLine="For c = 0 To column -1";
{
final int step25 = 1;
...
RDebugUtils.currentLine=12779567;
 //BA.debugLineNum = 12779567;BA.debugLine="celllabel.Background = cd";
_celllabel.setBackground((android.graphics.drawable.Drawable)(_cd.getObject()));
 }
};
RDebugUtils.currentLine=12779573;
 //BA.debugLineNum = 12779573;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=12910592;
 //BA.debugLineNum = 12910592;BA.debugLine="Sub DrawCalendar (month As Int, year As Int)";
RDebugUtils.currentLine=12910594;
 //BA.debugLineNum = 12910594;BA.debugLine="calendarpanel.RemoveAllViews";
mostCurrent._calendarpanel.RemoveAllViews();
RDebugUtils.currentLine=12910597;
 //BA.debugLineNum = 12910597;BA.debugLine="DateTime.DateFormat = \"yyyy-MM-dd\"";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("yyyy-MM-dd");
RDebugUtils.currentLine=12910598;
 //BA.debugLineNum = 12910598;BA.debugLine="Dim firstDay As Long = DateTime.DateParse(year &";
...
RDebugUtils.currentLine=12910599;
 //BA.debugLineNum = 12910599;BA.debugLine="Dim startDay As Int = DateTime.GetDayOfweek(first";
_startday = anywheresoftware.b4a.keywords.Common.DateTime.GetDayOfWeek(_firstday);
RDebugUtils.currentLine=12910600;
 //BA.debugLineNum = 12910600;BA.debugLine="Dim daysInmonth As Int = Daysinamonth(month, year";
_daysinmonth = _daysinamonth(_month,_year);
RDebugUtils.currentLine=12910604;
 //BA.debugLineNum = 12910604;BA.debugLine="Dim prevmonth As Int";
_prevmonth = 0;
RDebugUtils.currentLine=12910605;
 //BA.debugLineNum = 12910605;BA.debugLine="Dim prevyear As Int";
_prevyear = 0;
RDebugUtils.currentLine=12910607;
 //BA.debugLineNum = 12910607;BA.debugLine="If month = 1 Then";
if (_month==1) { 
RDebugUtils.currentLine=12910608;
 //BA.debugLineNum = 12910608;BA.debugLine="prevmonth = 12";
_prevmonth = (int) (12);
RDebugUtils.currentLine=12910609;
 //BA.debugLineNum = 12910609;BA.debugLine="prevyear = year - 1";
_prevyear = (int) (_year-1);
 }else {
RDebugUtils.currentLine=12910611;
 //BA.debugLineNum = 12910611;BA.debugLine="prevmonth = month-1";
_prevmonth = (int) (_month-1);
RDebugUtils.currentLine=12910612;
 //BA.debugLineNum = 12910612;BA.debugLine="prevyear = year";
_prevyear = _year;
 };
RDebugUtils.currentLine=12910614;
 //BA.debugLineNum = 12910614;BA.debugLine="Dim daysInprevMonth As Int = Daysinamonth(prevmon";
_daysinprevmonth = _daysinamonth(_prevmonth,_prevyear);
RDebugUtils.currentLine=12910618;
 //BA.debugLineNum = 12910618;BA.debugLine="Dim cd As ColorDrawable";
_cd = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
RDebugUtils.currentLine=12910619;
 //BA.debugLineNum = 12910619;BA.debugLine="cd.Initialize2(Colors.White, 0, 2dip, Colors.Blac";
_cd.Initialize2(anywheresoftware.b4a.keywords.Common.Colors.White,(int) (0),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.Colors.Black);
RDebugUtils.currentLine=12910621;
 //BA.debugLineNum = 12910621;BA.debugLine="Dim rows As Int = 6  'number of rows (days)";
_rows = (int) (6);
RDebugUtils.currentLine=12910622;
 //BA.debugLineNum = 12910622;BA.debugLine="Dim column As Int = 7 'number of columns (the wee";
_column = (int) (7);
RDebugUtils.currentLine=12910624;
 //BA.debugLineNum = 12910624;BA.debugLine="Dim day As Int = 1";
_day = (int) (1);
RDebugUtils.currentLine=12910625;
 //BA.debugLineNum = 12910625;BA.debugLine="Dim started As Boolean = False";
_started = anywheresoftware.b4a.keywords.Common.False;
RDebugUtils.currentLine=12910627;
 //BA.debugLineNum = 12910627;BA.debugLine="Dim index As Int = 0";
_index = (int) (0);
RDebugUtils.currentLine=12910629;
 //BA.debugLineNum = 12910629;BA.debugLine="Dim cellW As Int = calendarpanel.width / column";
_cellw = (int) (mostCurrent._calendarpanel.getWidth()/(double)_column);
RDebugUtils.currentLine=12910630;
 //BA.debugLineNum = 12910630;BA.debugLine="Dim cellH As Int = 60dip";
_cellh = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60));
RDebugUtils.currentLine=12910631;
 //BA.debugLineNum = 12910631;BA.debugLine="For r = 0 To rows -1";
{
final int step25 = 1;
...
RDebugUtils.currentLine=12910632;
 //BA.debugLineNum = 12910632;BA.debugLine="For c = 0 To column -1";
{
final int step26 = 1;
...
RDebugUtils.currentLine=12910639;
 //BA.debugLineNum = 12910639;BA.debugLine="cell.Background = cd";
_cell.setBackground((android.graphics.drawable.Drawable)(_cd.getObject()));
RDebugUtils.currentLine=12910641;
 //BA.debugLineNum = 12910641;BA.debugLine="Dim lbl As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
RDebugUtils.currentLine=12910642;
 //BA.debugLineNum = 12910642;BA.debugLine="lbl.Initialize(\"\")";
_lbl.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=12910643;
 //BA.debugLineNum = 12910643;BA.debugLine="lbl.Gravity = Gravity.CENTER_Horizontal";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_HORIZONTAL);
RDebugUtils.currentLine=12910644;
 //BA.debugLineNum = 12910644;BA.debugLine="lbl.Enabled = False";
_lbl.setEnabled(anywheresoftware.b4a.keywords.Common.False);
RDebugUtils.currentLine=12910646;
 //BA.debugLineNum = 12910646;BA.debugLine="index = index +1";
_index = (int) (_index+1);
RDebugUtils.currentLine=12910648;
 //BA.debugLineNum = 12910648;BA.debugLine="Dim displayday As Int";
_displayday = 0;
RDebugUtils.currentLine=12910649;
 //BA.debugLineNum = 12910649;BA.debugLine="Dim datestr As String";
_datestr = "";
RDebugUtils.currentLine=12910652;
 //BA.debugLineNum = 12910652;BA.debugLine="If index < startDay Then";
if (_index<_startday) { 
RDebugUtils.currentLine=12910653;
 //BA.debugLineNum = 12910653;BA.debugLine="displayday = daysInprevMonth - (startDay - ind";
_displayday = (int) (_daysinprevmonth-(_startday-_index)+1);
RDebugUtils.currentLine=12910654;
 //BA.debugLineNum = 12910654;BA.debugLine="lbl.TextColor = Colors.gray";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Gray);
RDebugUtils.currentLine=12910655;
 //BA.debugLineNum = 12910655;BA.debugLine="datestr = prevyear & \"-\" & NumberFormat(prevmo";
...
{RDebugUtils.currentLine=12910656;
 //BA.debugLineNum = 12910656;BA.debugLine="Else if index >= startDay And index < startDay";
if (_index>=_startday && _index<_startday+_daysinmonth) { 
RDebugUtils.currentLine=12910657;
 //BA.debugLineNum = 12910657;BA.debugLine="displayday = index - startDay + 1";
_displayday = (int) (_index-_startday+1);
RDebugUtils.currentLine=12910658;
 //BA.debugLineNum = 12910658;BA.debugLine="lbl.TextColor = Colors.Black";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
RDebugUtils.currentLine=12910659;
 //BA.debugLineNum = 12910659;BA.debugLine="datestr = year&\"-\"&NumberFormat(month,2,0)&\"-\"";
...
RDebugUtils.currentLine=12910661;
 //BA.debugLineNum = 12910661;BA.debugLine="displayday = index - (startDay + daysInmonth)";
_displayday = (int) (_index-(_startday+_daysinmonth)+1);
RDebugUtils.currentLine=12910662;
 //BA.debugLineNum = 12910662;BA.debugLine="lbl.TextColor = Colors.Gray";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Gray);
RDebugUtils.currentLine=12910663;
 //BA.debugLineNum = 12910663;BA.debugLine="Dim nextmonth As Int";
_nextmonth = 0;
RDebugUtils.currentLine=12910664;
 //BA.debugLineNum = 12910664;BA.debugLine="Dim nextyear As Int";
_nextyear = 0;
RDebugUtils.currentLine=12910666;
 //BA.debugLineNum = 12910666;BA.debugLine="If month = 12 Then";
if (_month==12) { 
RDebugUtils.currentLine=12910667;
 //BA.debugLineNum = 12910667;BA.debugLine="nextmonth = 1";
_nextmonth = (int) (1);
RDebugUtils.currentLine=12910668;
 //BA.debugLineNum = 12910668;BA.debugLine="nextyear = year+1";
_nextyear = (int) (_year+1);
 }else {
RDebugUtils.currentLine=12910670;
 //BA.debugLineNum = 12910670;BA.debugLine="nextmonth = month+1";
_nextmonth = (int) (_month+1);
RDebugUtils.currentLine=12910671;
 //BA.debugLineNum = 12910671;BA.debugLine="nextyear = year";
_nextyear = _year;
RDebugUtils.currentLine=12910672;
 //BA.debugLineNum = 12910672;BA.debugLine="datestr = nextyear&\"-\"&NumberFormat(nextmonth";
...
RDebugUtils.currentLine=12910677;
 //BA.debugLineNum = 12910677;BA.debugLine="lbl.Text = displayday";
_lbl.setText(BA.ObjectToCharSequence(_displayday));
RDebugUtils.currentLine=12910678;
 //BA.debugLineNum = 12910678;BA.debugLine="cell.Tag = datestr";
_cell.setTag((Object)(_datestr));
RDebugUtils.currentLine=12910679;
 //BA.debugLineNum = 12910679;BA.debugLine="lbl.Enabled = False";
_lbl.setEnabled(anywheresoftware.b4a.keywords.Common.False);
RDebugUtils.currentLine=12910680;
 //BA.debugLineNum = 12910680;BA.debugLine="cell.AddView(lbl, 0, 0, cellW, cellH)";
_cell.AddView((android.view.View)(_lbl.getObject()),(int) (0),(int) (0),_cellw,_cellh);
RDebugUtils.currentLine=12910682;
 //BA.debugLineNum = 12910682;BA.debugLine="If CalendarMap.ContainsKey(datestr) Then";
if (_calendarmap.ContainsKey((Object)(_datestr))) { 
RDebugUtils.currentLine=12910683;
 //BA.debugLineNum = 12910683;BA.debugLine="Dim eventmap As Map = CalendarMap.Get(datestr)";
...
RDebugUtils.currentLine=12910684;
 //BA.debugLineNum = 12910684;BA.debugLine="Dim allevents As List = eventmap.Get(\"AllEvent";
...
RDebugUtils.currentLine=12910690;
 //BA.debugLineNum = 12910690;BA.debugLine="Dim ev As Map = allevents.Get(i)";
...
RDebugUtils.currentLine=12910717;
 //BA.debugLineNum = 12910717;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=13172736;
 //BA.debugLineNum = 13172736;BA.debugLine="Sub Weekday (Day As Int)";
RDebugUtils.currentLine=13172737;
 //BA.debugLineNum = 13172737;BA.debugLine="If Day = 0 Then";
if (_day==0) { 
RDebugUtils.currentLine=13172738;
 //BA.debugLineNum = 13172738;BA.debugLine="day_of_week = \"Sun\"";
mostCurrent._day_of_week = "Sun";
 }else 
{RDebugUtils.currentLine=13172739;
 //BA.debugLineNum = 13172739;BA.debugLine="Else if Day = 1 Then";
if (_day==1) { 
RDebugUtils.currentLine=13172740;
 //BA.debugLineNum = 13172740;BA.debugLine="day_of_week = \"Mon\"";
mostCurrent._day_of_week = "Mon";
 }else 
{RDebugUtils.currentLine=13172741;
 //BA.debugLineNum = 13172741;BA.debugLine="Else if Day = 2 Then";
if (_day==2) { 
RDebugUtils.currentLine=13172742;
 //BA.debugLineNum = 13172742;BA.debugLine="day_of_week = \"Tue\"";
mostCurrent._day_of_week = "Tue";
 }else 
{RDebugUtils.currentLine=13172743;
 //BA.debugLineNum = 13172743;BA.debugLine="Else if Day = 3 Then";
if (_day==3) { 
RDebugUtils.currentLine=13172744;
 //BA.debugLineNum = 13172744;BA.debugLine="day_of_week = \"Wed\"";
mostCurrent._day_of_week = "Wed";
 }else 
{RDebugUtils.currentLine=13172745;
 //BA.debugLineNum = 13172745;BA.debugLine="Else if Day = 4 Then";
if (_day==4) { 
RDebugUtils.currentLine=13172746;
 //BA.debugLineNum = 13172746;BA.debugLine="day_of_week = \"Thu\"";
mostCurrent._day_of_week = "Thu";
 }else 
{RDebugUtils.currentLine=13172747;
 //BA.debugLineNum = 13172747;BA.debugLine="Else if Day = 5 Then";
if (_day==5) { 
RDebugUtils.currentLine=13172748;
 //BA.debugLineNum = 13172748;BA.debugLine="day_of_week = \"Fri\"";
mostCurrent._day_of_week = "Fri";
 }else {
RDebugUtils.currentLine=13172750;
 //BA.debugLineNum = 13172750;BA.debugLine="day_of_week = \"Sat\"";
...
RDebugUtils.currentLine=13041664;
 //BA.debugLineNum = 13041664;BA.debugLine="Sub cell_click_click";
RDebugUtils.currentLine=13041666;
 //BA.debugLineNum = 13041666;BA.debugLine="Dim p As Panel = Sender";
...
RDebugUtils.currentLine=13041667;
 //BA.debugLineNum = 13041667;BA.debugLine="Dim datestr As String = p.Tag";
_datestr = BA.ObjectToString(_p.getTag());
RDebugUtils.currentLine=13041668;
 //BA.debugLineNum = 13041668;BA.debugLine="Activity.finish";
mostCurrent._activity.Finish();
RDebugUtils.currentLine=13041669;
 //BA.debugLineNum = 13041669;BA.debugLine="StartActivity(day_module)";
...
RDebugUtils.currentLine=13041670;
 //BA.debugLineNum = 13041670;BA.debugLine="day_module.currentDate = datestr";
mostCurrent._day_module._currentdate /*String*/  = _datestr;
RDebugUtils.currentLine=13041671;
 //BA.debugLineNum = 13041671;BA.debugLine="Log(datestr)";
anywheresoftware.b4a.keywords.Common.LogImpl("113041671",_datestr,0);
...
RDebugUtils.currentLine=12845056;
 //BA.debugLineNum = 12845056;BA.debugLine="Sub CleanDebugger";
RDebugUtils.currentLine=12845057;
 //BA.debugLineNum = 12845057;BA.debugLine="CalendarMap.Clear";
_calendarmap.Clear();
RDebugUtils.currentLine=12845058;
 //BA.debugLineNum = 12845058;BA.debugLine="kvs.Put(\"CalendarKVS\", CalendarMap)";
...
RDebugUtils.currentLine=13631488;
 //BA.debugLineNum = 13631488;BA.debugLine="Private Sub Day_btn_Click";
RDebugUtils.currentLine=13631489;
 //BA.debugLineNum = 13631489;BA.debugLine="If day_module.currentDate = \"\" Then";
if ((mostCurrent._day_module._currentdate /*String*/ ).equals("")) { 
RDebugUtils.currentLine=13631490;
 //BA.debugLineNum = 13631490;BA.debugLine="Dim currentyear As Int = DateTime.GetYear(DateTi";
_currentyear = anywheresoftware.b4a.keywords.Common.DateTime.GetYear(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
RDebugUtils.currentLine=13631491;
 //BA.debugLineNum = 13631491;BA.debugLine="Dim currentmonth As Int = DateTime.GetMonth(Date";
...
RDebugUtils.currentLine=13631492;
 //BA.debugLineNum = 13631492;BA.debugLine="Dim currentday As Int = DateTime.GetDayOfMonth(D";
...
RDebugUtils.currentLine=13631493;
 //BA.debugLineNum = 13631493;BA.debugLine="Dim datestr As String= currentyear & \"-\" & Numbe";
...
RDebugUtils.currentLine=13631495;
 //BA.debugLineNum = 13631495;BA.debugLine="Log(day_module.currentDate)";
anywheresoftware.b4a.keywords.Common.LogImpl("113631495",mostCurrent._day_module._currentdate /*String*/ ,0);
 };
RDebugUtils.currentLine=13631498;
 //BA.debugLineNum = 13631498;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
RDebugUtils.currentLine=13631499;
 //BA.debugLineNum = 13631499;BA.debugLine="StartActivity(day_module)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._day_module.getObject()));
...
RDebugUtils.currentLine=13107200;
 //BA.debugLineNum = 13107200;BA.debugLine="Sub Daysinamonth(Month As Int, year As Int) As Int";
RDebugUtils.currentLine=13107201;
 //BA.debugLineNum = 13107201;BA.debugLine="Dim nextMonth As Int";
_nextmonth = 0;
RDebugUtils.currentLine=13107202;
 //BA.debugLineNum = 13107202;BA.debugLine="Dim nextyear As Int";
_nextyear = 0;
RDebugUtils.currentLine=13107204;
 //BA.debugLineNum = 13107204;BA.debugLine="If Month = 12 Then";
if (_month==12) { 
RDebugUtils.currentLine=13107205;
 //BA.debugLineNum = 13107205;BA.debugLine="nextMonth = 1";
_nextmonth = (int) (1);
RDebugUtils.currentLine=13107206;
 //BA.debugLineNum = 13107206;BA.debugLine="nextyear = year+1";
_nextyear = (int) (_year+1);
 }else {
RDebugUtils.currentLine=13107208;
 //BA.debugLineNum = 13107208;BA.debugLine="nextMonth = Month +1";
_nextmonth = (int) (_month+1);
RDebugUtils.currentLine=13107209;
 //BA.debugLineNum = 13107209;BA.debugLine="nextyear = year";
_nextyear = _year;
 };
RDebugUtils.currentLine=13107212;
 //BA.debugLineNum = 13107212;BA.debugLine="DateTime.DateFormat = \"yyyy-MM-dd\"";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("yyyy-MM-dd");
RDebugUtils.currentLine=13107213;
 //BA.debugLineNum = 13107213;BA.debugLine="Dim firstNextMonth As Long = DateTime.DateParse(n";
...
RDebugUtils.currentLine=13107214;
 //BA.debugLineNum = 13107214;BA.debugLine="Dim lastDayDate As Long = firstNextMonth - DateTi";
...
RDebugUtils.currentLine=13107217;
 //BA.debugLineNum = 13107217;BA.debugLine="Return DateTime.GetDayOfMonth(lastDayDate)";
...
RDebugUtils.currentLine=12976128;
 //BA.debugLineNum = 12976128;BA.debugLine="Sub IdentifyColor (typeofevent As String) As Int";
RDebugUtils.currentLine=12976129;
 //BA.debugLineNum = 12976129;BA.debugLine="Dim mycolor As Int";
_mycolor = 0;
RDebugUtils.currentLine=12976130;
 //BA.debugLineNum = 12976130;BA.debugLine="If typeofevent = \"Task\" Then";
if ((_typeofevent).equals("Task")) { 
RDebugUtils.currentLine=12976131;
 //BA.debugLineNum = 12976131;BA.debugLine="mycolor = Colors.Blue";
_mycolor = anywheresoftware.b4a.keywords.Common.Colors.Blue;
 }else 
{RDebugUtils.currentLine=12976132;
 //BA.debugLineNum = 12976132;BA.debugLine="Else if typeofevent = \"Event\" Then";
if ((_typeofevent).equals("Event")) { 
RDebugUtils.currentLine=12976133;
 //BA.debugLineNum = 12976133;BA.debugLine="mycolor = Colors.Green";
_mycolor = anywheresoftware.b4a.keywords.Common.Colors.Green;
 }else 
{RDebugUtils.currentLine=12976134;
 //BA.debugLineNum = 12976134;BA.debugLine="Else if typeofevent = \"Birthday\" Then";
if ((_typeofevent).equals("Birthday")) { 
RDebugUtils.currentLine=12976135;
 //BA.debugLineNum = 12976135;BA.debugLine="mycolor = Colors.Magenta";
_mycolor = anywheresoftware.b4a.keywords.Common.Colors.Magenta;
 }else 
{RDebugUtils.currentLine=12976136;
 //BA.debugLineNum = 12976136;BA.debugLine="Else if typeofevent = \"OOO\" Then";
if ((_typeofevent).equals("OOO")) { 
RDebugUtils.currentLine=12976137;
 //BA.debugLineNum = 12976137;BA.debugLine="mycolor = Colors.Yellow";
_mycolor = anywheresoftware.b4a.keywords.Common.Colors.Yellow;
 }}}}
;
RDebugUtils.currentLine=12976140;
 //BA.debugLineNum = 12976140;BA.debugLine="Return mycolor";
...
RDebugUtils.currentLine=13500416;
 //BA.debugLineNum = 13500416;BA.debugLine="Private Sub menu_btn_Click";
RDebugUtils.currentLine=13500417;
 //BA.debugLineNum = 13500417;BA.debugLine="menupanel.Visible =True";
...
RDebugUtils.currentLine=13697024;
 //BA.debugLineNum = 13697024;BA.debugLine="Private Sub Month_btn_Click";
RDebugUtils.currentLine=13697025;
 //BA.debugLineNum = 13697025;BA.debugLine="menupanel.Visible = False";
...
RDebugUtils.currentLine=13369344;
 //BA.debugLineNum = 13369344;BA.debugLine="Private Sub MonthSp_ItemClick (Position As Int, Va";
RDebugUtils.currentLine=13369345;
 //BA.debugLineNum = 13369345;BA.debugLine="Dim selectedmonth As Int = Position +1";
_selectedmonth = (int) (_position+1);
RDebugUtils.currentLine=13369347;
 //BA.debugLineNum = 13369347;BA.debugLine="DrawCalendar(selectedmonth, DateTime.GetYear(Date";
...
RDebugUtils.currentLine=13565952;
 //BA.debugLineNum = 13565952;BA.debugLine="Private Sub sched_btn_Click";
RDebugUtils.currentLine=13565953;
 //BA.debugLineNum = 13565953;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
RDebugUtils.currentLine=13565954;
 //BA.debugLineNum = 13565954;BA.debugLine="StartActivity(Schedule_module)";
...
RDebugUtils.currentLine=13434880;
 //BA.debugLineNum = 13434880;BA.debugLine="Private Sub YearSP_ItemClick (Position As Int, Val";
RDebugUtils.currentLine=13434881;
 //BA.debugLineNum = 13434881;BA.debugLine="Dim selectedyear As Int = Value";
_selectedyear = (int)(BA.ObjectToNumber(_value));
RDebugUtils.currentLine=13434883;
 //BA.debugLineNum = 13434883;BA.debugLine="DrawCalendar(MonthSp.SelectedIndex +1, selectedye";
