...
RDebugUtils.currentLine=13631498;
 //BA.debugLineNum = 13631498;BA.debugLine="kvs.Initialize(File.DirInternal, \"mydata\")";
...
RDebugUtils.currentLine=13631500;
 //BA.debugLineNum = 13631500;BA.debugLine="If kvs.ContainsKey(\"CalendarKVS\") Then";
if (_kvs._containskey("CalendarKVS")) { 
RDebugUtils.currentLine=13631501;
 //BA.debugLineNum = 13631501;BA.debugLine="CalendarMap = kvs.Get(\"CalendarKVS\")";
...
RDebugUtils.currentLine=13631503;
 //BA.debugLineNum = 13631503;BA.debugLine="CalendarMap.initialize";
_calendarmap.Initialize();
 };
RDebugUtils.currentLine=13631508;
 //BA.debugLineNum = 13631508;BA.debugLine="Dim currentyear As Int = DateTime.GetYear(DateTim";
...
RDebugUtils.currentLine=13631509;
 //BA.debugLineNum = 13631509;BA.debugLine="Dim years As List";
_years = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=13631510;
 //BA.debugLineNum = 13631510;BA.debugLine="years.Initialize";
_years.Initialize();
RDebugUtils.currentLine=13631511;
 //BA.debugLineNum = 13631511;BA.debugLine="For i = currentyear -10 To currentyear+10";
{
final int step16 = 1;
...
RDebugUtils.currentLine=13631512;
 //BA.debugLineNum = 13631512;BA.debugLine="years.Add(i)";
_years.Add((Object)(_i));
 }
};
RDebugUtils.currentLine=13631514;
 //BA.debugLineNum = 13631514;BA.debugLine="YearSP.AddAll(years)";
mostCurrent._yearsp.AddAll(_years);
RDebugUtils.currentLine=13631515;
 //BA.debugLineNum = 13631515;BA.debugLine="YearSP.SelectedIndex = 10";
mostCurrent._yearsp.setSelectedIndex((int) (10));
RDebugUtils.currentLine=13631518;
 //BA.debugLineNum = 13631518;BA.debugLine="MonthSp.AddAll(Months)";
...
RDebugUtils.currentLine=13631519;
 //BA.debugLineNum = 13631519;BA.debugLine="MonthSp.SelectedIndex = DateTime.GetMonth(DateTim";
...
RDebugUtils.currentLine=13631522;
 //BA.debugLineNum = 13631522;BA.debugLine="DrawCalendar(DateTime.GetMonth(DateTime.Now), Dat";
...
RDebugUtils.currentLine=13631525;
 //BA.debugLineNum = 13631525;BA.debugLine="Dim cd As ColorDrawable";
_cd = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
RDebugUtils.currentLine=13631526;
 //BA.debugLineNum = 13631526;BA.debugLine="cd.Initialize2(Colors.White, 0, 2dip, Colors.Blac";
...
RDebugUtils.currentLine=13631528;
 //BA.debugLineNum = 13631528;BA.debugLine="Dim column As Int = 7";
_column = (int) (7);
RDebugUtils.currentLine=13631529;
 //BA.debugLineNum = 13631529;BA.debugLine="Dim cellW As Int = calendarpanel.Width/column";
_cellw = (int) (mostCurrent._calendarpanel.getWidth()/(double)_column);
RDebugUtils.currentLine=13631530;
 //BA.debugLineNum = 13631530;BA.debugLine="Dim cellH As Int = 60dip";
_cellh = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60));
RDebugUtils.currentLine=13631531;
 //BA.debugLineNum = 13631531;BA.debugLine="For c = 0 To column -1";
{
final int step29 = 1;
...
RDebugUtils.currentLine=13631541;
 //BA.debugLineNum = 13631541;BA.debugLine="celllabel.Background = cd";
_celllabel.setBackground((android.graphics.drawable.Drawable)(_cd.getObject()));
 }
};
RDebugUtils.currentLine=13631547;
 //BA.debugLineNum = 13631547;BA.debugLine="End Sub";
return "";
}
