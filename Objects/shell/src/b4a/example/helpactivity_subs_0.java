...
try {
		Debug.PushSubsStack("backBtn_Click (helpactivity) ","helpactivity",3,helpactivity.mostCurrent.activityBA,helpactivity.mostCurrent,216);
...
try {
		Debug.PushSubsStack("closeHelp_Click (helpactivity) ","helpactivity",3,helpactivity.mostCurrent.activityBA,helpactivity.mostCurrent,222);
...
try {
		Debug.PushSubsStack("nextBtn_Click (helpactivity) ","helpactivity",3,helpactivity.mostCurrent.activityBA,helpactivity.mostCurrent,210);
