...
try {
		Debug.PushSubsStack("Activity_Create (all_active_recall) ","all_active_recall",18,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,26);
...
try {
		Debug.PushSubsStack("Activity_Pause (all_active_recall) ","all_active_recall",18,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,89);
...
try {
		Debug.PushSubsStack("Activity_Resume (all_active_recall) ","all_active_recall",18,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,85);
...
try {
		Debug.PushSubsStack("backbtn_Click (all_active_recall) ","all_active_recall",18,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,108);
...
try {
		Debug.PushSubsStack("goback_Click (all_active_recall) ","all_active_recall",18,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,135);
...
try {
		Debug.PushSubsStack("nextbtn_Click (all_active_recall) ","all_active_recall",18,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,119);
...
try {
		Debug.PushSubsStack("showAnswerbtn_Click (all_active_recall) ","all_active_recall",18,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,94);
...
try {
		Debug.PushSubsStack("Showcard (all_active_recall) ","all_active_recall",18,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,77);
...
try {
		Debug.PushSubsStack("ShowProgress (all_active_recall) ","all_active_recall",18,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,58);
...
try {
		Debug.PushSubsStack("ShuffleCards (all_active_recall) ","all_active_recall",18,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,66);
