...
try {
		Debug.PushSubsStack("Activity_Create (musicactivity) ","musicactivity",10,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,19);
...
musicactivity.mostCurrent.__c.runVoidMethod ("LogImpl","57667714",BA.ObjectToString(musicactivity.mostCurrent.__c.runMethod(false,"GetDeviceLayoutValues",musicactivity.mostCurrent.activityBA)),0);
...
try {
		Debug.PushSubsStack("Activity_Pause (musicactivity) ","musicactivity",10,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,43);
...
try {
		Debug.PushSubsStack("Activity_Resume (musicactivity) ","musicactivity",10,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,39);
...
try {
		Debug.PushSubsStack("formatSongDur (musicactivity) ","musicactivity",10,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,47);
...
Debug.locals.put("ms", _ms);
 BA.debugLineNum = 47;BA.debugLine="Sub formatSongDur(ms As Int) As String";
Debug.ShouldStop(16384);
 BA.debugLineNum = 48;BA.debugLine="Dim seconds As Int = ms / 1000";
...
_seconds = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_ms,RemoteObject.createImmutable(1000)}, "/",0, 0));Debug.locals.put("seconds", _seconds);Debug.locals.put("seconds", _seconds);
 BA.debugLineNum = 49;BA.debugLine="Dim minutes As Int = seconds / 60";
...
_minutes = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_seconds,RemoteObject.createImmutable(60)}, "/",0, 0));Debug.locals.put("minutes", _minutes);Debug.locals.put("minutes", _minutes);
 BA.debugLineNum = 50;BA.debugLine="seconds = seconds Mod 60";
...
_seconds = RemoteObject.solve(new RemoteObject[] {_seconds,RemoteObject.createImmutable(60)}, "%",0, 1);Debug.locals.put("seconds", _seconds);
 BA.debugLineNum = 51;BA.debugLine="Return NumberFormat(minutes, 2, 0) & \":\" & Number";
Debug.ShouldStop(262144);
...
try {
		Debug.PushSubsStack("ListView1_ItemClick (musicactivity) ","musicactivity",10,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,93);
...
Debug.ShouldStop(268435456);
 BA.debugLineNum = 94;BA.debugLine="CallSub2(musicService, \"setSong\", Position)";
Debug.ShouldStop(536870912);
...
try {
		Debug.PushSubsStack("nextBtn_Click (musicactivity) ","musicactivity",10,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,81);
if (RapidSub.canDelegate("nextbtn_click")) { return b4a.example.musicactivity.remoteMe.runUserSub(false, "musicactivity","nextbtn_click");}
 BA.debugLineNum = 81;BA.debugLine="Sub nextBtn_Click";
Debug.ShouldStop(65536);
 BA.debugLineNum = 82;BA.debugLine="CallSub(musicService, \"nextSong\")";
Debug.ShouldStop(131072);
...
try {
		Debug.PushSubsStack("pauseBtn_Click (musicactivity) ","musicactivity",10,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,89);
if (RapidSub.canDelegate("pausebtn_click")) { return b4a.example.musicactivity.remoteMe.runUserSub(false, "musicactivity","pausebtn_click");}
 BA.debugLineNum = 89;BA.debugLine="Sub pauseBtn_Click";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 90;BA.debugLine="CallSub(musicService, \"pauseToggle\")";
Debug.ShouldStop(33554432);
...
try {
		Debug.PushSubsStack("prevBtn_Click (musicactivity) ","musicactivity",10,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,85);
if (RapidSub.canDelegate("prevbtn_click")) { return b4a.example.musicactivity.remoteMe.runUserSub(false, "musicactivity","prevbtn_click");}
 BA.debugLineNum = 85;BA.debugLine="Sub prevBtn_Click";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 86;BA.debugLine="CallSub(musicService, \"prevSong\")";
...
try {
		Debug.PushSubsStack("SeekBar1_ValueChanged (musicactivity) ","musicactivity",10,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,75);
...
Debug.locals.put("UserChanged", _userchanged);
 BA.debugLineNum = 75;BA.debugLine="Sub SeekBar1_ValueChanged(Value As Int, UserChange";
Debug.ShouldStop(1024);
 BA.debugLineNum = 76;BA.debugLine="If UserChanged Then";
Debug.ShouldStop(2048);
if (_userchanged.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 77;BA.debugLine="musicService.mediaPlayer.Position = Value";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("uiTimer_Tick (musicactivity) ","musicactivity",10,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,55);
...
RemoteObject _title = RemoteObject.createImmutable("");
 BA.debugLineNum = 55;BA.debugLine="Sub uiTimer_Tick";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 56;BA.debugLine="If musicService.mediaPlayer.IsInitialized Then";
Debug.ShouldStop(8388608);
if (musicactivity.mostCurrent._musicservice._mediaplayer /*RemoteObject*/ .runMethod(true,"IsInitialized").<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 58;BA.debugLine="Dim title As String = musicService.musicPlaylist";
Debug.ShouldStop(33554432);
_title = BA.ObjectToString(musicactivity.mostCurrent._musicservice._musicplaylist /*RemoteObject*/ .runMethod(false,"Get",(Object)(musicactivity.mostCurrent._musicservice._currentsong /*RemoteObject*/ )));Debug.locals.put("title", _title);Debug.locals.put("title", _title);
 BA.debugLineNum = 59;BA.debugLine="title = title.SubString2(0, title.Length - 4)  '";
Debug.ShouldStop(67108864);
_title = _title.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 0)),(Object)(RemoteObject.solve(new RemoteObject[] {_title.runMethod(true,"length"),RemoteObject.createImmutable(4)}, "-",1, 1)));Debug.locals.put("title", _title);
 BA.debugLineNum = 60;BA.debugLine="title = title.SubString(7) 'remove /tracks";
Debug.ShouldStop(134217728);
_title = _title.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 7)));Debug.locals.put("title", _title);
 BA.debugLineNum = 62;BA.debugLine="SeekBar1.Max = musicService.mediaPlayer.Duration";
Debug.ShouldStop(536870912);
musicactivity.mostCurrent._seekbar1.runMethod(true,"setMax",musicactivity.mostCurrent._musicservice._mediaplayer /*RemoteObject*/ .runMethod(true,"getDuration"));
 BA.debugLineNum = 63;BA.debugLine="SeekBar1.Value = musicService.mediaPlayer.Positi";
Debug.ShouldStop(1073741824);
musicactivity.mostCurrent._seekbar1.runMethod(true,"setValue",musicactivity.mostCurrent._musicservice._mediaplayer /*RemoteObject*/ .runMethod(true,"getPosition"));
 BA.debugLineNum = 64;BA.debugLine="songRuntime.Text = formatSongDur(musicService.me";
