...
musicactivity.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("musicLayout.bal")),musicactivity.mostCurrent.activityBA);
 BA.debugLineNum = 23;BA.debugLine="StartService(musicService)";
...
musicactivity.mostCurrent.__c.runVoidMethod ("StartService",musicactivity.processBA,(Object)((musicactivity.mostCurrent._musicservice.getObject())));
 BA.debugLineNum = 25;BA.debugLine="For i = 0 To musicService.musicPlaylist.Size - 1";
Debug.ShouldStop(16777216);
{
final int step3 = 1;
final int limit3 = RemoteObject.solve(new RemoteObject[] {musicactivity.mostCurrent._musicservice._musicplaylist /*RemoteObject*/ .runMethod(true,"getSize"),RemoteObject.createImmutable(1)}, "-",1, 1).<Integer>get().intValue();
_i = 0 ;
for (;(step3 > 0 && _i <= limit3) || (step3 < 0 && _i >= limit3) ;_i = ((int)(0 + _i + step3))  ) {
Debug.locals.put("i", _i);
 BA.debugLineNum = 26;BA.debugLine="Dim title As String = musicService.musicPlaylist";
...
_title = BA.ObjectToString(musicactivity.mostCurrent._musicservice._musicplaylist /*RemoteObject*/ .runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i))));Debug.locals.put("title", _title);Debug.locals.put("title", _title);
 BA.debugLineNum = 27;BA.debugLine="title = title.SubString2(0, title.Length - 4)  '";
...
_title = _title.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 0)),(Object)(RemoteObject.solve(new RemoteObject[] {_title.runMethod(true,"length"),RemoteObject.createImmutable(4)}, "-",1, 1)));Debug.locals.put("title", _title);
 BA.debugLineNum = 28;BA.debugLine="title = title.SubString(7)";
Debug.ShouldStop(134217728);
_title = _title.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 7)));Debug.locals.put("title", _title);
 BA.debugLineNum = 29;BA.debugLine="ListView1.AddSingleLine((i + 1) & \" \" & title)";
...
musicactivity.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat((RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_i),RemoteObject.createImmutable(1)}, "+",1, 1)),RemoteObject.createImmutable(" "),_title))));
 BA.debugLineNum = 30;BA.debugLine="ListView1.SingleLineLayout.Label.TextColor = Col";
...
;
 BA.debugLineNum = 34;BA.debugLine="uiTimer.Initialize(\"uiTimer\", 500)";
Debug.ShouldStop(2);
musicactivity._uitimer.runVoidMethod ("Initialize",musicactivity.processBA,(Object)(BA.ObjectToString("uiTimer")),(Object)(BA.numberCast(long.class, 500)));
 BA.debugLineNum = 35;BA.debugLine="uiTimer.Enabled = True";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("Activity_Pause (musicactivity) ","musicactivity",21,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,42);
...
Debug.ShouldStop(512);
 BA.debugLineNum = 43;BA.debugLine="uiTimer.Enabled = False";
...
try {
		Debug.PushSubsStack("Activity_Resume (musicactivity) ","musicactivity",21,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,38);
...
Debug.ShouldStop(32);
 BA.debugLineNum = 39;BA.debugLine="uiTimer.Enabled = True";
Debug.ShouldStop(64);
musicactivity._uitimer.runMethod(true,"setEnabled",musicactivity.mostCurrent.__c.getField(true,"True"));
...
try {
		Debug.PushSubsStack("formatSongDur (musicactivity) ","musicactivity",21,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,46);
...
Debug.locals.put("ms", _ms);
 BA.debugLineNum = 46;BA.debugLine="Sub formatSongDur(ms As Int) As String";
Debug.ShouldStop(8192);
 BA.debugLineNum = 47;BA.debugLine="Dim seconds As Int = ms / 1000";
...
_seconds = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_ms,RemoteObject.createImmutable(1000)}, "/",0, 0));Debug.locals.put("seconds", _seconds);Debug.locals.put("seconds", _seconds);
 BA.debugLineNum = 48;BA.debugLine="Dim minutes As Int = seconds / 60";
...
_minutes = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_seconds,RemoteObject.createImmutable(60)}, "/",0, 0));Debug.locals.put("minutes", _minutes);Debug.locals.put("minutes", _minutes);
 BA.debugLineNum = 49;BA.debugLine="seconds = seconds Mod 60";
...
_seconds = RemoteObject.solve(new RemoteObject[] {_seconds,RemoteObject.createImmutable(60)}, "%",0, 1);Debug.locals.put("seconds", _seconds);
 BA.debugLineNum = 50;BA.debugLine="Return NumberFormat(minutes, 2, 0) & \":\" & Number";
...
try {
		Debug.PushSubsStack("ListView1_ItemClick (musicactivity) ","musicactivity",21,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,92);
...
Debug.ShouldStop(134217728);
 BA.debugLineNum = 93;BA.debugLine="CallSub2(musicService, \"setSong\", Position)";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("nextBtn_Click (musicactivity) ","musicactivity",21,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,80);
if (RapidSub.canDelegate("nextbtn_click")) { return b4a.example.musicactivity.remoteMe.runUserSub(false, "musicactivity","nextbtn_click");}
 BA.debugLineNum = 80;BA.debugLine="Sub nextBtn_Click";
Debug.ShouldStop(32768);
 BA.debugLineNum = 81;BA.debugLine="CallSub(musicService, \"nextSong\")";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("pauseBtn_Click (musicactivity) ","musicactivity",21,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,88);
if (RapidSub.canDelegate("pausebtn_click")) { return b4a.example.musicactivity.remoteMe.runUserSub(false, "musicactivity","pausebtn_click");}
 BA.debugLineNum = 88;BA.debugLine="Sub pauseBtn_Click";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 89;BA.debugLine="CallSub(musicService, \"pauseToggle\")";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("prevBtn_Click (musicactivity) ","musicactivity",21,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,84);
if (RapidSub.canDelegate("prevbtn_click")) { return b4a.example.musicactivity.remoteMe.runUserSub(false, "musicactivity","prevbtn_click");}
 BA.debugLineNum = 84;BA.debugLine="Sub prevBtn_Click";
Debug.ShouldStop(524288);
 BA.debugLineNum = 85;BA.debugLine="CallSub(musicService, \"prevSong\")";
...
try {
		Debug.PushSubsStack("SeekBar1_ValueChanged (musicactivity) ","musicactivity",21,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,74);
...
Debug.locals.put("UserChanged", _userchanged);
 BA.debugLineNum = 74;BA.debugLine="Sub SeekBar1_ValueChanged(Value As Int, UserChange";
Debug.ShouldStop(512);
 BA.debugLineNum = 75;BA.debugLine="If UserChanged Then";
Debug.ShouldStop(1024);
if (_userchanged.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 76;BA.debugLine="musicService.mediaPlayer.Position = Value";
Debug.ShouldStop(2048);
...
try {
		Debug.PushSubsStack("uiTimer_Tick (musicactivity) ","musicactivity",21,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,54);
...
RemoteObject _title = RemoteObject.createImmutable("");
 BA.debugLineNum = 54;BA.debugLine="Sub uiTimer_Tick";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 55;BA.debugLine="If musicService.mediaPlayer.IsInitialized Then";
Debug.ShouldStop(4194304);
if (musicactivity.mostCurrent._musicservice._mediaplayer /*RemoteObject*/ .runMethod(true,"IsInitialized").<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 57;BA.debugLine="Dim title As String = musicService.musicPlaylist";
Debug.ShouldStop(16777216);
_title = BA.ObjectToString(musicactivity.mostCurrent._musicservice._musicplaylist /*RemoteObject*/ .runMethod(false,"Get",(Object)(musicactivity.mostCurrent._musicservice._currentsong /*RemoteObject*/ )));Debug.locals.put("title", _title);Debug.locals.put("title", _title);
 BA.debugLineNum = 58;BA.debugLine="title = title.SubString2(0, title.Length - 4)  '";
Debug.ShouldStop(33554432);
_title = _title.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 0)),(Object)(RemoteObject.solve(new RemoteObject[] {_title.runMethod(true,"length"),RemoteObject.createImmutable(4)}, "-",1, 1)));Debug.locals.put("title", _title);
 BA.debugLineNum = 59;BA.debugLine="title = title.SubString(7) 'remove /tracks";
Debug.ShouldStop(67108864);
_title = _title.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 7)));Debug.locals.put("title", _title);
 BA.debugLineNum = 61;BA.debugLine="SeekBar1.Max = musicService.mediaPlayer.Duration";
Debug.ShouldStop(268435456);
musicactivity.mostCurrent._seekbar1.runMethod(true,"setMax",musicactivity.mostCurrent._musicservice._mediaplayer /*RemoteObject*/ .runMethod(true,"getDuration"));
 BA.debugLineNum = 62;BA.debugLine="SeekBar1.Value = musicService.mediaPlayer.Positi";
Debug.ShouldStop(536870912);
musicactivity.mostCurrent._seekbar1.runMethod(true,"setValue",musicactivity.mostCurrent._musicservice._mediaplayer /*RemoteObject*/ .runMethod(true,"getPosition"));
 BA.debugLineNum = 63;BA.debugLine="songRuntime.Text = formatSongDur(musicService.me";
