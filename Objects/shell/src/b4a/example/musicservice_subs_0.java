...
try {
		Debug.PushSubsStack("nextSong (musicservice) ","musicservice",8,musicservice.processBA,musicservice.mostCurrent,86);
...
try {
		Debug.PushSubsStack("pauseToggle (musicservice) ","musicservice",8,musicservice.processBA,musicservice.mostCurrent,52);
...
try {
		Debug.PushSubsStack("playSong (musicservice) ","musicservice",8,musicservice.processBA,musicservice.mostCurrent,65);
...
try {
		Debug.PushSubsStack("prevSong (musicservice) ","musicservice",8,musicservice.processBA,musicservice.mostCurrent,94);
...
try {
		Debug.PushSubsStack("Service_Destroy (musicservice) ","musicservice",8,musicservice.processBA,musicservice.mostCurrent,48);
...
try {
		Debug.PushSubsStack("Service_Start (musicservice) ","musicservice",8,musicservice.processBA,musicservice.mostCurrent,43);
...
try {
		Debug.PushSubsStack("setSong (musicservice) ","musicservice",8,musicservice.processBA,musicservice.mostCurrent,60);
...
try {
		Debug.PushSubsStack("songTimer_Tick (musicservice) ","musicservice",8,musicservice.processBA,musicservice.mostCurrent,76);
...
try {
		Debug.PushSubsStack("waitStarter (musicservice) ","musicservice",8,musicservice.processBA,musicservice.mostCurrent,102);
