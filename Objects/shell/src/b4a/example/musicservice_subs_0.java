...
try {
		Debug.PushSubsStack("CopyTracksIfNeeded (musicservice) ","musicservice",9,musicservice.processBA,musicservice.mostCurrent,47);
...
try {
		Debug.PushSubsStack("nextSong (musicservice) ","musicservice",9,musicservice.processBA,musicservice.mostCurrent,104);
...
try {
		Debug.PushSubsStack("pauseToggle (musicservice) ","musicservice",9,musicservice.processBA,musicservice.mostCurrent,71);
...
try {
		Debug.PushSubsStack("playSong (musicservice) ","musicservice",9,musicservice.processBA,musicservice.mostCurrent,84);
...
try {
		Debug.PushSubsStack("prevSong (musicservice) ","musicservice",9,musicservice.processBA,musicservice.mostCurrent,112);
...
try {
		Debug.PushSubsStack("Service_Destroy (musicservice) ","musicservice",9,musicservice.processBA,musicservice.mostCurrent,67);
...
try {
		Debug.PushSubsStack("Service_Start (musicservice) ","musicservice",9,musicservice.processBA,musicservice.mostCurrent,63);
...
try {
		Debug.PushSubsStack("setSong (musicservice) ","musicservice",9,musicservice.processBA,musicservice.mostCurrent,79);
...
try {
		Debug.PushSubsStack("songTimer_Tick (musicservice) ","musicservice",9,musicservice.processBA,musicservice.mostCurrent,95);
