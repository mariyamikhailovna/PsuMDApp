...
try {
		Debug.PushSubsStack("Activity_Create (navactivity) ","navactivity",23,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,18);
...
Debug.ShouldStop(131072);
 BA.debugLineNum = 20;BA.debugLine="If Starter.darkMode = False Then";
...
if (RemoteObject.solveBoolean("=",navactivity.mostCurrent._starter._darkmode /*RemoteObject*/ ,navactivity.mostCurrent.__c.getField(true,"False"))) { 
 BA.debugLineNum = 21;BA.debugLine="Activity.LoadLayout(\"navAct\")";
...
navactivity.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("navAct")),navactivity.mostCurrent.activityBA);
 ...
 BA.debugLineNum = 23;BA.debugLine="Activity.LoadLayout(\"navActDark\")";
...
try {
		Debug.PushSubsStack("Activity_Pause (navactivity) ","navactivity",23,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,32);
...
try {
		Debug.PushSubsStack("Activity_Resume (navactivity) ","navactivity",23,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,28);
...
try {
		Debug.PushSubsStack("calendarBtn_Click (navactivity) ","navactivity",23,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,37);
...
Debug.ShouldStop(16);
 BA.debugLineNum = 38;BA.debugLine="StartActivity(CalendarActivity)";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("clkBtn_Click (navactivity) ","navactivity",23,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,41);
...
Debug.ShouldStop(256);
 BA.debugLineNum = 42;BA.debugLine="StartActivity(clockActivity)";
...
try {
		Debug.PushSubsStack("corkpadBtn_Click (navactivity) ","navactivity",23,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,45);
...
Debug.ShouldStop(4096);
 BA.debugLineNum = 46;BA.debugLine="StartActivity(corkActivity)";
...
try {
		Debug.PushSubsStack("exitBtn_Click (navactivity) ","navactivity",23,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,73);
...
try {
		Debug.PushSubsStack("flashBtn_Click (navactivity) ","navactivity",23,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,49);
...
Debug.ShouldStop(65536);
 BA.debugLineNum = 50;BA.debugLine="StartActivity(FlashcardActivity)";
Debug.ShouldStop(131072);
...
try {
		Debug.PushSubsStack("helpBtn_Click (navactivity) ","navactivity",23,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,65);
...
Debug.ShouldStop(1);
 BA.debugLineNum = 66;BA.debugLine="StartActivity(helpActivity)";
Debug.ShouldStop(2);
...
try {
		Debug.PushSubsStack("musicBtn_Click (navactivity) ","navactivity",23,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,53);
...
Debug.ShouldStop(1048576);
 BA.debugLineNum = 54;BA.debugLine="StartActivity(musicActivity)";
...
try {
		Debug.PushSubsStack("ntpdBtn_Click (navactivity) ","navactivity",23,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,57);
...
Debug.ShouldStop(16777216);
 BA.debugLineNum = 58;BA.debugLine="StartActivity(noteActivity)";
Debug.ShouldStop(33554432);
...
try {
		Debug.PushSubsStack("themeBtn_Click (navactivity) ","navactivity",23,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,69);
...
Debug.ShouldStop(16);
 BA.debugLineNum = 70;BA.debugLine="StartActivity(themeActivity)";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("todoBtn_Click (navactivity) ","navactivity",23,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,61);
...
Debug.ShouldStop(268435456);
 BA.debugLineNum = 62;BA.debugLine="StartActivity(todoActivity)";
Debug.ShouldStop(536870912);
