...
try {
		Debug.PushSubsStack("Activity_Create (add_card_module2) ","add_card_module2",16,add_card_module2.mostCurrent.activityBA,add_card_module2.mostCurrent,22);
...
try {
		Debug.PushSubsStack("Activity_Pause (add_card_module2) ","add_card_module2",16,add_card_module2.mostCurrent.activityBA,add_card_module2.mostCurrent,52);
...
try {
		Debug.PushSubsStack("Activity_Resume (add_card_module2) ","add_card_module2",16,add_card_module2.mostCurrent.activityBA,add_card_module2.mostCurrent,48);
...
try {
		Debug.PushSubsStack("backbtn_Click (add_card_module2) ","add_card_module2",16,add_card_module2.mostCurrent.activityBA,add_card_module2.mostCurrent,59);
...
try {
		Debug.PushSubsStack("SaveCard_Click (add_card_module2) ","add_card_module2",16,add_card_module2.mostCurrent.activityBA,add_card_module2.mostCurrent,64);
...
try {
		Debug.PushSubsStack("SaveDecks (add_card_module2) ","add_card_module2",16,add_card_module2.mostCurrent.activityBA,add_card_module2.mostCurrent,44);
