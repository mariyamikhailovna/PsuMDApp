...
try {
		Debug.PushSubsStack("Activity_Pause (deck_all_cards) ","deck_all_cards",18,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,93);
...
try {
		Debug.PushSubsStack("Activity_Resume (deck_all_cards) ","deck_all_cards",18,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,89);
...
try {
		Debug.PushSubsStack("addbtn_Click (deck_all_cards) ","deck_all_cards",18,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,98);
...
try {
		Debug.PushSubsStack("backbtn_Click (deck_all_cards) ","deck_all_cards",18,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,102);
