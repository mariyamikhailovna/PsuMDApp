...
try {
		Debug.PushSubsStack("Activity_Create (deck_all_cards) ","deck_all_cards",22,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,20);
...
try {
		Debug.PushSubsStack("Activity_Pause (deck_all_cards) ","deck_all_cards",22,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,86);
...
try {
		Debug.PushSubsStack("Activity_Resume (deck_all_cards) ","deck_all_cards",22,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,82);
...
try {
		Debug.PushSubsStack("addbtn_Click (deck_all_cards) ","deck_all_cards",22,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,91);
...
try {
		Debug.PushSubsStack("backbtn_Click (deck_all_cards) ","deck_all_cards",22,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,95);
...
try {
		Debug.PushSubsStack("ShowALLCards (deck_all_cards) ","deck_all_cards",22,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,44);
