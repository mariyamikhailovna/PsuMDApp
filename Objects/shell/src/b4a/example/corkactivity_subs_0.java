...
try {
		Debug.PushSubsStack("Activity_Create (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,55);
...
try {
		Debug.PushSubsStack("Activity_Pause (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,159);
...
try {
		Debug.PushSubsStack("Activity_Resume (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,153);
...
try {
		Debug.PushSubsStack("AddCanvas (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,233);
...
try {
		Debug.PushSubsStack("addcBtn_Click (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,342);
...
try {
		Debug.PushSubsStack("addnBtn_Click (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,331);
...
try {
		Debug.PushSubsStack("AddStickyNote (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,165);
...
Debug.ShouldStop(32);
corkactivity.mostCurrent.__c.runVoidMethod ("LogImpl","815204385",RemoteObject.concat(RemoteObject.createImmutable("deleteLbl initialized: "),(corkactivity.mostCurrent._deletelbl.runMethod(true,"IsInitialized"))),0);
...
try {
		Debug.PushSubsStack("canvaBtn_Click (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,364);
...
try {
		Debug.PushSubsStack("CanvasDrag_PlacedView (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,494);
...
try {
		Debug.PushSubsStack("CanvasPanel_Touch (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,268);
...
try {
		Debug.PushSubsStack("canvasWindow (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,311);
...
try {
		Debug.PushSubsStack("CC_Result (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,208);
...
try {
		Debug.PushSubsStack("colorsSpnr_ItemClick (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,398);
...
try {
		Debug.PushSubsStack("imgBtn_Click (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,360);
...
try {
		Debug.PushSubsStack("ImgDrag_PlacedView (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,470);
...
try {
		Debug.PushSubsStack("NoteDrag_PlacedView (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,446);
...
try {
		Debug.PushSubsStack("NoteText_TextChanged (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,201);
...
try {
		Debug.PushSubsStack("noteWindow (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,291);
...
try {
		Debug.PushSubsStack("penSpnr_ItemClick (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,415);
...
try {
		Debug.PushSubsStack("sizeSpnr_ItemClick (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,375);
...
try {
		Debug.PushSubsStack("stickyBtn_Click (corkactivity) ","corkactivity",14,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,352);
