...
Debug.ShouldStop(4);
corkactivity.mostCurrent.__c.runVoidMethod ("LogImpl","65832737",RemoteObject.concat(RemoteObject.createImmutable("deleteLbl initialized: "),(corkactivity.mostCurrent._deletelbl.runMethod(true,"IsInitialized"))),0);
