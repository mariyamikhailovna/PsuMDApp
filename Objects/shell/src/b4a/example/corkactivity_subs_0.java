...
try {
		Debug.PushSubsStack("Activity_Create (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,55);
...
try {
		Debug.PushSubsStack("Activity_Pause (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,156);
...
try {
		Debug.PushSubsStack("Activity_Resume (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,150);
...
try {
		Debug.PushSubsStack("AddCanvas (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,230);
...
try {
		Debug.PushSubsStack("addcBtn_Click (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,339);
...
try {
		Debug.PushSubsStack("addnBtn_Click (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,328);
...
try {
		Debug.PushSubsStack("AddStickyNote (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,162);
...
Debug.ShouldStop(4);
corkactivity.mostCurrent.__c.runVoidMethod ("LogImpl","67471137",RemoteObject.concat(RemoteObject.createImmutable("deleteLbl initialized: "),(corkactivity.mostCurrent._deletelbl.runMethod(true,"IsInitialized"))),0);
...
try {
		Debug.PushSubsStack("canvaBtn_Click (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,361);
...
try {
		Debug.PushSubsStack("CanvasDrag_PlacedView (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,491);
...
try {
		Debug.PushSubsStack("CanvasPanel_Touch (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,265);
...
try {
		Debug.PushSubsStack("canvasWindow (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,308);
...
try {
		Debug.PushSubsStack("CC_Result (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,205);
...
try {
		Debug.PushSubsStack("colorsSpnr_ItemClick (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,395);
...
try {
		Debug.PushSubsStack("imgBtn_Click (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,357);
...
try {
		Debug.PushSubsStack("ImgDrag_PlacedView (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,467);
...
try {
		Debug.PushSubsStack("NoteDrag_PlacedView (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,443);
...
try {
		Debug.PushSubsStack("NoteText_TextChanged (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,198);
...
try {
		Debug.PushSubsStack("noteWindow (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,288);
...
try {
		Debug.PushSubsStack("penSpnr_ItemClick (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,412);
...
try {
		Debug.PushSubsStack("sizeSpnr_ItemClick (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,372);
...
try {
		Debug.PushSubsStack("stickyBtn_Click (corkactivity) ","corkactivity",6,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,349);
