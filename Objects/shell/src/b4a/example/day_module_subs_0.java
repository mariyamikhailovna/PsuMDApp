...
try {
		Debug.PushSubsStack("Activity_Create (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,52);
...
day_module.mostCurrent.__c.runVoidMethod ("LogImpl","314549002",day_module._currentdate,0);
...
try {
		Debug.PushSubsStack("Activity_Pause (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,390);
...
try {
		Debug.PushSubsStack("Activity_Resume (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,382);
...
try {
		Debug.PushSubsStack("Addevent_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,413);
if (RapidSub.canDelegate("addevent_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","addevent_btn_click");}
 BA.debugLineNum = 413;BA.debugLine="Private Sub Addevent_btn_Click";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 414;BA.debugLine="addpanel.Visible = False";
Debug.ShouldStop(536870912);
day_module.mostCurrent._addpanel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 415;BA.debugLine="add_events_module.eventtype = \"Event\"";
Debug.ShouldStop(1073741824);
day_module.mostCurrent._add_events_module._eventtype /*RemoteObject*/  = BA.ObjectToString("Event");
 BA.debugLineNum = 416;BA.debugLine="StartActivity(add_events_module)";
Debug.ShouldStop(-2147483648);
...
try {
		Debug.PushSubsStack("addnew_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,419);
if (RapidSub.canDelegate("addnew_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","addnew_btn_click");}
 BA.debugLineNum = 419;BA.debugLine="Private Sub addnew_btn_Click";
Debug.ShouldStop(4);
 BA.debugLineNum = 421;BA.debugLine="If addpanel.Visible =True Then";
Debug.ShouldStop(16);
if (RemoteObject.solveBoolean("=",day_module.mostCurrent._addpanel.runMethod(true,"getVisible"),day_module.mostCurrent.__c.getField(true,"True"))) { 
 BA.debugLineNum = 422;BA.debugLine="addpanel.Visible = False";
Debug.ShouldStop(32);
day_module.mostCurrent._addpanel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 425;BA.debugLine="addpanel.Visible = True";
...
try {
		Debug.PushSubsStack("Addtask_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,430);
if (RapidSub.canDelegate("addtask_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","addtask_btn_click");}
 BA.debugLineNum = 430;BA.debugLine="Private Sub Addtask_btn_Click";
Debug.ShouldStop(8192);
 BA.debugLineNum = 431;BA.debugLine="addpanel.Visible = False";
Debug.ShouldStop(16384);
day_module.mostCurrent._addpanel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 432;BA.debugLine="add_events_module.eventtype = \"Task\"";
Debug.ShouldStop(32768);
day_module.mostCurrent._add_events_module._eventtype /*RemoteObject*/  = BA.ObjectToString("Task");
 BA.debugLineNum = 433;BA.debugLine="StartActivity(add_events_module)";
...
try {
		Debug.PushSubsStack("birthday_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,436);
if (RapidSub.canDelegate("birthday_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","birthday_btn_click");}
 BA.debugLineNum = 436;BA.debugLine="Private Sub birthday_btn_Click";
Debug.ShouldStop(524288);
 BA.debugLineNum = 437;BA.debugLine="addpanel.Visible = False";
Debug.ShouldStop(1048576);
day_module.mostCurrent._addpanel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 438;BA.debugLine="add_events_module.eventtype = \"Birthday\"";
Debug.ShouldStop(2097152);
day_module.mostCurrent._add_events_module._eventtype /*RemoteObject*/  = BA.ObjectToString("Birthday");
 BA.debugLineNum = 439;BA.debugLine="StartActivity(add_events_module)";
Debug.ShouldStop(4194304);
day_module.mostCurrent.__c.runVoidMethod ("StartActivity",day_module.processBA,(Object)((day_module.mostCurrent._add_events_module.getObject())));
...
try {
		Debug.PushSubsStack("birthdayrb_CheckedChange (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,536);
...
Debug.locals.put("Checked", _checked);
 BA.debugLineNum = 536;BA.debugLine="Private Sub birthdayrb_CheckedChange(Checked As Bo";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 537;BA.debugLine="eventtype = \"Birthday\"";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("cancelDelete_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,485);
if (RapidSub.canDelegate("canceldelete_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","canceldelete_btn_click");}
 BA.debugLineNum = 485;BA.debugLine="Private Sub cancelDelete_btn_Click";
Debug.ShouldStop(16);
 BA.debugLineNum = 486;BA.debugLine="deletepanel.Visible = False";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("cancelEdit_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,463);
if (RapidSub.canDelegate("canceledit_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","canceledit_btn_click");}
 BA.debugLineNum = 463;BA.debugLine="Private Sub cancelEdit_btn_Click";
Debug.ShouldStop(16384);
 BA.debugLineNum = 464;BA.debugLine="EditInfoPanel.Visible = False";
Debug.ShouldStop(32768);
...
try {
		Debug.PushSubsStack("cancelTLdelete_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,508);
if (RapidSub.canDelegate("canceltldelete_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","canceltldelete_btn_click");}
 BA.debugLineNum = 508;BA.debugLine="Private Sub cancelTLdelete_btn_Click";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 509;BA.debugLine="deleteTLevent_confirmationpanel.Visible = False";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("confirmdelete_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,489);
...
RemoteObject _allevents = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
 BA.debugLineNum = 489;BA.debugLine="Private Sub confirmdelete_btn_Click";
Debug.ShouldStop(256);
 BA.debugLineNum = 490;BA.debugLine="Dim eventmap As Map = CalendarActivity.CalendarMa";
...
_eventmap = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runMethod(false,"Get",(Object)((day_module._currentdate))));Debug.locals.put("eventmap", _eventmap);Debug.locals.put("eventmap", _eventmap);
 BA.debugLineNum = 491;BA.debugLine="Dim allevents As List = eventmap.Get(\"AllEvents\")";
...
_allevents = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _eventmap.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("AllEvents")))));Debug.locals.put("allevents", _allevents);Debug.locals.put("allevents", _allevents);
 BA.debugLineNum = 492;BA.debugLine="allevents.RemoveAt(currentIndex)";
Debug.ShouldStop(2048);
_allevents.runVoidMethod ("RemoveAt",(Object)(day_module._currentindex));
 BA.debugLineNum = 493;BA.debugLine="deletepanel.Visible = False";
Debug.ShouldStop(4096);
day_module.mostCurrent._deletepanel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 494;BA.debugLine="eventInfo_panel.Visible = False";
Debug.ShouldStop(8192);
day_module.mostCurrent._eventinfo_panel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 495;BA.debugLine="SaveCalendar";
Debug.ShouldStop(16384);
_savecalendar();
 BA.debugLineNum = 496;BA.debugLine="DrawMainEvents";
Debug.ShouldStop(32768);
_drawmainevents();
...
try {
		Debug.PushSubsStack("Day_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,404);
...
try {
		Debug.PushSubsStack("DeleteEvent_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,459);
if (RapidSub.canDelegate("deleteevent_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","deleteevent_btn_click");}
 BA.debugLineNum = 459;BA.debugLine="Private Sub DeleteEvent_btn_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 460;BA.debugLine="deletepanel.Visible = True";
Debug.ShouldStop(2048);
...
try {
		Debug.PushSubsStack("deleteTLconfirm_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,512);
...
RemoteObject _ev = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 512;BA.debugLine="Private Sub deleteTLconfirm_btn_Click";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 513;BA.debugLine="Dim eventmap As Map = CalendarActivity.CalendarMa";
Debug.ShouldStop(1);
_eventmap = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_eventmap = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runMethod(false,"Get",(Object)((day_module._currentdate))));Debug.locals.put("eventmap", _eventmap);Debug.locals.put("eventmap", _eventmap);
 BA.debugLineNum = 514;BA.debugLine="Dim timeline As List = eventmap.Get(\"Timeline\")";
Debug.ShouldStop(2);
...
_timeline = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _eventmap.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Timeline")))));Debug.locals.put("timeline", _timeline);Debug.locals.put("timeline", _timeline);
 BA.debugLineNum = 516;BA.debugLine="For i = timeline.Size -1 To 0 Step -1";
Debug.ShouldStop(8);
{
final int step3 = -1;
final int limit3 = 0;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 517;BA.debugLine="Dim ev As Map = timeline.Get(i)";
Debug.ShouldStop(16);
...
;
 BA.debugLineNum = 524;BA.debugLine="addTL_et.Text = \"\"";
Debug.ShouldStop(2048);
day_module.mostCurrent._addtl_et.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 525;BA.debugLine="deleteTLevent_confirmationpanel.Visible = False";
Debug.ShouldStop(4096);
day_module.mostCurrent._deletetlevent_confirmationpanel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 526;BA.debugLine="addEventTL_panel.Visible = False";
Debug.ShouldStop(8192);
day_module.mostCurrent._addeventtl_panel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 527;BA.debugLine="SaveCalendar";
Debug.ShouldStop(16384);
_savecalendar();
 BA.debugLineNum = 528;BA.debugLine="UpdateTimeLine";
Debug.ShouldStop(32768);
_updatetimeline();
...
try {
		Debug.PushSubsStack("deleteTLevent_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,504);
if (RapidSub.canDelegate("deletetlevent_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","deletetlevent_btn_click");}
 BA.debugLineNum = 504;BA.debugLine="Private Sub deleteTLevent_btn_Click";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 505;BA.debugLine="deleteTLevent_confirmationpanel.Visible = True";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("DrawHourLabels (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,144);
...
try {
		Debug.PushSubsStack("DrawMainEvents (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,80);
...
day_module.mostCurrent._svevents.runMethod(false,"getPanel").runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 82;BA.debugLine="If Not(CalendarActivity.CalendarMap.ContainsKey(c";
Debug.ShouldStop(131072);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 86;BA.debugLine="Dim eventmap As Map = CalendarActivity.CalendarMa";
Debug.ShouldStop(2097152);
_eventmap = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_eventmap = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runMethod(false,"Get",(Object)((day_module._currentdate))));Debug.locals.put("eventmap", _eventmap);Debug.locals.put("eventmap", _eventmap);
...
try {
		Debug.PushSubsStack("DrawTimelineEvents (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,191);
...
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 192;BA.debugLine="If Not(CalendarActivity.CalendarMap.ContainsKey(c";
Debug.ShouldStop(-2147483648);
if (day_module.mostCurrent.__c.runMethod(true,"Not",(Object)(day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runMethod(true,"ContainsKey",(Object)((day_module._currentdate))))).<Boolean>get().booleanValue()) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 194;BA.debugLine="Dim eventmap As Map = CalendarActivity.CalendarMa";
Debug.ShouldStop(2);
_eventmap = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_eventmap = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runMethod(false,"Get",(Object)((day_module._currentdate))));Debug.locals.put("eventmap", _eventmap);Debug.locals.put("eventmap", _eventmap);
...
try {
		Debug.PushSubsStack("editeventinfo_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,448);
if (RapidSub.canDelegate("editeventinfo_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","editeventinfo_btn_click");}
 BA.debugLineNum = 448;BA.debugLine="Private Sub editeventinfo_btn_Click";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 449;BA.debugLine="EditInfoPanel.Visible = True";
Debug.ShouldStop(1);
day_module.mostCurrent._editinfopanel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 450;BA.debugLine="editTitle_et.text = currenttaggedEvent.Get(\"Title";
Debug.ShouldStop(2);
day_module.mostCurrent._edittitle_et.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(day_module.mostCurrent._currenttaggedevent.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Title"))))));
 BA.debugLineNum = 451;BA.debugLine="editDescription_et.Text = currenttaggedEvent.Get(";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("eventrb_CheckedChange (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,540);
...
Debug.locals.put("Checked", _checked);
 BA.debugLineNum = 540;BA.debugLine="Private Sub eventrb_CheckedChange(Checked As Boole";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 541;BA.debugLine="eventtype = \"Event\"";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("GetTimeString (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,166);
...
try {
		Debug.PushSubsStack("hour_click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,251);
...
_eventmap = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("eventmap", _eventmap);
 BA.debugLineNum = 259;BA.debugLine="If CalendarActivity.CalendarMap.ContainsKey(curre";
Debug.ShouldStop(4);
if (day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runMethod(true,"ContainsKey",(Object)((day_module._currentdate))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 260;BA.debugLine="eventmap = CalendarActivity.CalendarMap.Get(curr";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("IdentifyColor (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,123);
...
try {
		Debug.PushSubsStack("mainEvent_click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,107);
...
Debug.ShouldStop(1024);
 BA.debugLineNum = 108;BA.debugLine="Dim eventmap As Map = CalendarActivity.CalendarMa";
Debug.ShouldStop(2048);
_eventmap = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_eventmap = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runMethod(false,"Get",(Object)(((day_module._currentdate)))));Debug.locals.put("eventmap", _eventmap);Debug.locals.put("eventmap", _eventmap);
...
try {
		Debug.PushSubsStack("MapInitializer (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,282);
...
Debug.ShouldStop(16);
_eventmap.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("Timeline"))),(Object)((_timeline.getObject())));
 BA.debugLineNum = 295;BA.debugLine="CalendarActivity.CalendarMap.Put(currentDate, eve";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("menu_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,395);
...
try {
		Debug.PushSubsStack("Month_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,408);
if (RapidSub.canDelegate("month_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","month_btn_click");}
 BA.debugLineNum = 408;BA.debugLine="Private Sub Month_btn_Click";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 409;BA.debugLine="Activity.Finish";
Debug.ShouldStop(16777216);
day_module.mostCurrent._activity.runVoidMethod ("Finish");
 BA.debugLineNum = 410;BA.debugLine="StartActivity(CalendarActivity)";
Debug.ShouldStop(33554432);
...
try {
		Debug.PushSubsStack("ooo_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,442);
if (RapidSub.canDelegate("ooo_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","ooo_btn_click");}
 BA.debugLineNum = 442;BA.debugLine="Private Sub ooo_btn_Click";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 443;BA.debugLine="addpanel.Visible = False";
Debug.ShouldStop(67108864);
day_module.mostCurrent._addpanel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 444;BA.debugLine="add_events_module.eventtype = \"OOO\"";
Debug.ShouldStop(134217728);
...
try {
		Debug.PushSubsStack("ooorb_CheckedChange (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,532);
...
Debug.locals.put("Checked", _checked);
 BA.debugLineNum = 532;BA.debugLine="Private Sub ooorb_CheckedChange(Checked As Boolean";
Debug.ShouldStop(524288);
 BA.debugLineNum = 533;BA.debugLine="eventtype = \"OOO\"";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("SaveCalendar (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,76);
...
Debug.ShouldStop(2048);
 BA.debugLineNum = 77;BA.debugLine="CalendarActivity.kvs.put(\"CalendarKVS\", CalendarA";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("saveEdit_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,467);
if (RapidSub.canDelegate("saveedit_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","saveedit_btn_click");}
 BA.debugLineNum = 467;BA.debugLine="Private Sub saveEdit_btn_Click";
Debug.ShouldStop(262144);
 BA.debugLineNum = 468;BA.debugLine="If editTitle_et.text = \"\" Then";
Debug.ShouldStop(524288);
if (RemoteObject.solveBoolean("=",day_module.mostCurrent._edittitle_et.runMethod(true,"getText"),BA.ObjectToString(""))) { 
 BA.debugLineNum = 469;BA.debugLine="MsgboxAsync(\"Event must have name\", \"Error\")";
Debug.ShouldStop(1048576);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 472;BA.debugLine="currenttaggedEvent.Put(\"Title\", editTitle_et.Text";
Debug.ShouldStop(8388608);
day_module.mostCurrent._currenttaggedevent.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("Title"))),(Object)((day_module.mostCurrent._edittitle_et.runMethod(true,"getText"))));
 BA.debugLineNum = 473;BA.debugLine="currenttaggedEvent.Put(\"Description\", editDescrip";
Debug.ShouldStop(16777216);
day_module.mostCurrent._currenttaggedevent.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("Description"))),(Object)((day_module.mostCurrent._editdescription_et.runMethod(true,"getText"))));
 BA.debugLineNum = 475;BA.debugLine="x_EventInfo_btn_Click";
Debug.ShouldStop(67108864);
_x_eventinfo_btn_click();
 BA.debugLineNum = 476;BA.debugLine="eventTitle_lbl.text = editTitle_et.Text";
Debug.ShouldStop(134217728);
day_module.mostCurrent._eventtitle_lbl.runMethod(true,"setText",BA.ObjectToCharSequence(day_module.mostCurrent._edittitle_et.runMethod(true,"getText")));
 BA.debugLineNum = 477;BA.debugLine="eventdescription_lbl.Text = editDescription_et.te";
Debug.ShouldStop(268435456);
day_module.mostCurrent._eventdescription_lbl.runMethod(true,"setText",BA.ObjectToCharSequence(day_module.mostCurrent._editdescription_et.runMethod(true,"getText")));
 BA.debugLineNum = 478;BA.debugLine="eventInfo_panel.Visible = True";
Debug.ShouldStop(536870912);
day_module.mostCurrent._eventinfo_panel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 479;BA.debugLine="SaveCalendar";
Debug.ShouldStop(1073741824);
_savecalendar();
 BA.debugLineNum = 480;BA.debugLine="DrawMainEvents";
Debug.ShouldStop(-2147483648);
_drawmainevents();
...
try {
		Debug.PushSubsStack("saveTL_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,300);
...
Debug.ShouldStop(2048);
 BA.debugLineNum = 301;BA.debugLine="Dim eventmap As Map = CalendarActivity.CalendarMa";
Debug.ShouldStop(4096);
_eventmap = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_eventmap = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runMethod(false,"Get",(Object)((day_module._currentdate))));Debug.locals.put("eventmap", _eventmap);Debug.locals.put("eventmap", _eventmap);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 307;BA.debugLine="If CalendarActivity.CalendarMap.ContainsKey(curre";
Debug.ShouldStop(262144);
if (day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runMethod(true,"ContainsKey",(Object)((day_module._currentdate))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 308;BA.debugLine="eventmap = CalendarActivity.CalendarMap.Get(curr";
Debug.ShouldStop(524288);
_eventmap = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runMethod(false,"Get",(Object)((day_module._currentdate))));Debug.locals.put("eventmap", _eventmap);
 }else {
...
try {
		Debug.PushSubsStack("sched_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,399);
...
try {
		Debug.PushSubsStack("SetDate (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,343);
...
try {
		Debug.PushSubsStack("SetUpSpinners (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,66);
...
try {
		Debug.PushSubsStack("taskrb_CheckedChange (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,544);
...
Debug.locals.put("Checked", _checked);
 BA.debugLineNum = 544;BA.debugLine="Private Sub taskrb_CheckedChange(Checked As Boolea";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 545;BA.debugLine="eventtype = \"Task\"";
Debug.ShouldStop(1);
...
try {
		Debug.PushSubsStack("timelineEvent_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,229);
...
try {
		Debug.PushSubsStack("UpdateTimeLine (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,138);
...
try {
		Debug.PushSubsStack("x_EventInfo_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,454);
if (RapidSub.canDelegate("x_eventinfo_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","x_eventinfo_btn_click");}
 BA.debugLineNum = 454;BA.debugLine="Private Sub x_EventInfo_btn_Click";
Debug.ShouldStop(32);
 BA.debugLineNum = 455;BA.debugLine="eventInfo_panel.Visible = False";
Debug.ShouldStop(64);
day_module.mostCurrent._eventinfo_panel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 456;BA.debugLine="EditInfoPanel.visible = False";
Debug.ShouldStop(128);
day_module.mostCurrent._editinfopanel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("x_TLevent_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,499);
if (RapidSub.canDelegate("x_tlevent_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","x_tlevent_btn_click");}
 BA.debugLineNum = 499;BA.debugLine="Private Sub x_TLevent_btn_Click";
Debug.ShouldStop(262144);
 BA.debugLineNum = 500;BA.debugLine="addEventTL_panel.Visible = False";
Debug.ShouldStop(524288);
day_module.mostCurrent._addeventtl_panel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 501;BA.debugLine="addTL_et.text = \"\"";
Debug.ShouldStop(1048576);
day_module.mostCurrent._addtl_et.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
