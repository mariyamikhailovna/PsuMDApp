...
try {
		Debug.PushSubsStack("Activity_Create (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,52);
...
if (RemoteObject.solveBoolean("=",day_module.mostCurrent._starter._darkmode /*RemoteObject*/ ,day_module.mostCurrent.__c.getField(true,"False"))) { 
 BA.debugLineNum = 56;BA.debugLine="Activity.LoadLayout(\"Day_ModuleLayout\")";
...
day_module.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Day_ModuleLayout")),day_module.mostCurrent.activityBA);
 ...
 BA.debugLineNum = 58;BA.debugLine="Activity.LoadLayout(\"Day_ModuleLayoutDark\")";
...
day_module.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Day_ModuleLayoutDark")),day_module.mostCurrent.activityBA);
 ...
 BA.debugLineNum = 61;BA.debugLine="Day_btn.Color = Colors.blue";
...
day_module.mostCurrent._day_btn.runVoidMethod ("setColor",day_module.mostCurrent.__c.getField(false,"Colors").getField(true,"Blue"));
 BA.debugLineNum = 62;BA.debugLine="date_todaylbl.Text = SetDate(currentDate)";
...
day_module.mostCurrent._date_todaylbl.runMethod(true,"setText",BA.ObjectToCharSequence(_setdate(day_module._currentdate)));
 BA.debugLineNum = 63;BA.debugLine="add_events_module.currentDate = SetDate(currentDa";
Debug.ShouldStop(1073741824);
day_module.mostCurrent._add_events_module._currentdate /*RemoteObject*/  = _setdate(day_module._currentdate);
 BA.debugLineNum = 64;BA.debugLine="SetUpSpinners";
Debug.ShouldStop(-2147483648);
_setupspinners();
 BA.debugLineNum = 66;BA.debugLine="Log(currentDate)";
Debug.ShouldStop(2);
day_module.mostCurrent.__c.runVoidMethod ("LogImpl","615597582",day_module._currentdate,0);
...
try {
		Debug.PushSubsStack("Activity_Pause (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,394);
...
try {
		Debug.PushSubsStack("Activity_Resume (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,386);
if (RapidSub.canDelegate("activity_resume")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","activity_resume");}
 BA.debugLineNum = 386;BA.debugLine="Sub Activity_Resume";
Debug.ShouldStop(2);
 BA.debugLineNum = 387;BA.debugLine="UpdateTimeLine";
Debug.ShouldStop(4);
_updatetimeline();
 BA.debugLineNum = 388;BA.debugLine="If addeventsfeedback = True Then";
Debug.ShouldStop(8);
if (RemoteObject.solveBoolean("=",day_module._addeventsfeedback,day_module.mostCurrent.__c.getField(true,"True"))) { 
 BA.debugLineNum = 389;BA.debugLine="addeventsfeedback = False";
Debug.ShouldStop(16);
day_module._addeventsfeedback = day_module.mostCurrent.__c.getField(true,"False");
 BA.debugLineNum = 390;BA.debugLine="MsgboxAsync(\"Event Saved\", \"Saved\")";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("Addevent_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,417);
if (RapidSub.canDelegate("addevent_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","addevent_btn_click");}
 BA.debugLineNum = 417;BA.debugLine="Private Sub Addevent_btn_Click";
Debug.ShouldStop(1);
 BA.debugLineNum = 418;BA.debugLine="addpanel.Visible = False";
Debug.ShouldStop(2);
day_module.mostCurrent._addpanel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 419;BA.debugLine="add_events_module.eventtype = \"Event\"";
Debug.ShouldStop(4);
day_module.mostCurrent._add_events_module._eventtype /*RemoteObject*/  = BA.ObjectToString("Event");
 BA.debugLineNum = 420;BA.debugLine="StartActivity(add_events_module)";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("addnew_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,423);
if (RapidSub.canDelegate("addnew_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","addnew_btn_click");}
 BA.debugLineNum = 423;BA.debugLine="Private Sub addnew_btn_Click";
Debug.ShouldStop(64);
 BA.debugLineNum = 425;BA.debugLine="If addpanel.Visible =True Then";
...
if (RemoteObject.solveBoolean("=",day_module.mostCurrent._addpanel.runMethod(true,"getVisible"),day_module.mostCurrent.__c.getField(true,"True"))) { 
 BA.debugLineNum = 426;BA.debugLine="addpanel.Visible = False";
Debug.ShouldStop(512);
day_module.mostCurrent._addpanel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 429;BA.debugLine="addpanel.Visible = True";
...
try {
		Debug.PushSubsStack("Addtask_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,434);
if (RapidSub.canDelegate("addtask_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","addtask_btn_click");}
 BA.debugLineNum = 434;BA.debugLine="Private Sub Addtask_btn_Click";
Debug.ShouldStop(131072);
 BA.debugLineNum = 435;BA.debugLine="addpanel.Visible = False";
Debug.ShouldStop(262144);
day_module.mostCurrent._addpanel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 436;BA.debugLine="add_events_module.eventtype = \"Task\"";
Debug.ShouldStop(524288);
...
try {
		Debug.PushSubsStack("birthday_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,440);
if (RapidSub.canDelegate("birthday_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","birthday_btn_click");}
 BA.debugLineNum = 440;BA.debugLine="Private Sub birthday_btn_Click";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 441;BA.debugLine="addpanel.Visible = False";
Debug.ShouldStop(16777216);
day_module.mostCurrent._addpanel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 442;BA.debugLine="add_events_module.eventtype = \"Birthday\"";
Debug.ShouldStop(33554432);
day_module.mostCurrent._add_events_module._eventtype /*RemoteObject*/  = BA.ObjectToString("Birthday");
 BA.debugLineNum = 443;BA.debugLine="StartActivity(add_events_module)";
...
try {
		Debug.PushSubsStack("birthdayrb_CheckedChange (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,540);
...
Debug.locals.put("Checked", _checked);
 BA.debugLineNum = 540;BA.debugLine="Private Sub birthdayrb_CheckedChange(Checked As Bo";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 541;BA.debugLine="eventtype = \"Birthday\"";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("cancelDelete_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,489);
if (RapidSub.canDelegate("canceldelete_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","canceldelete_btn_click");}
 BA.debugLineNum = 489;BA.debugLine="Private Sub cancelDelete_btn_Click";
Debug.ShouldStop(256);
 BA.debugLineNum = 490;BA.debugLine="deletepanel.Visible = False";
Debug.ShouldStop(512);
...
try {
		Debug.PushSubsStack("cancelEdit_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,467);
if (RapidSub.canDelegate("canceledit_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","canceledit_btn_click");}
 BA.debugLineNum = 467;BA.debugLine="Private Sub cancelEdit_btn_Click";
Debug.ShouldStop(262144);
 BA.debugLineNum = 468;BA.debugLine="EditInfoPanel.Visible = False";
Debug.ShouldStop(524288);
...
try {
		Debug.PushSubsStack("cancelTLdelete_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,512);
if (RapidSub.canDelegate("canceltldelete_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","canceltldelete_btn_click");}
 BA.debugLineNum = 512;BA.debugLine="Private Sub cancelTLdelete_btn_Click";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 513;BA.debugLine="deleteTLevent_confirmationpanel.Visible = False";
Debug.ShouldStop(1);
...
try {
		Debug.PushSubsStack("confirmdelete_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,493);
...
RemoteObject _allevents = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
 BA.debugLineNum = 493;BA.debugLine="Private Sub confirmdelete_btn_Click";
Debug.ShouldStop(4096);
 BA.debugLineNum = 494;BA.debugLine="Dim eventmap As Map = CalendarActivity.CalendarMa";
...
_eventmap = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runMethod(false,"Get",(Object)((day_module._currentdate))));Debug.locals.put("eventmap", _eventmap);Debug.locals.put("eventmap", _eventmap);
 BA.debugLineNum = 495;BA.debugLine="Dim allevents As List = eventmap.Get(\"AllEvents\")";
...
_allevents = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _eventmap.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("AllEvents")))));Debug.locals.put("allevents", _allevents);Debug.locals.put("allevents", _allevents);
 BA.debugLineNum = 496;BA.debugLine="allevents.RemoveAt(currentIndex)";
Debug.ShouldStop(32768);
_allevents.runVoidMethod ("RemoveAt",(Object)(day_module._currentindex));
 BA.debugLineNum = 497;BA.debugLine="deletepanel.Visible = False";
Debug.ShouldStop(65536);
day_module.mostCurrent._deletepanel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 498;BA.debugLine="eventInfo_panel.Visible = False";
Debug.ShouldStop(131072);
day_module.mostCurrent._eventinfo_panel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 499;BA.debugLine="SaveCalendar";
Debug.ShouldStop(262144);
_savecalendar();
 BA.debugLineNum = 500;BA.debugLine="DrawMainEvents";
Debug.ShouldStop(524288);
_drawmainevents();
...
try {
		Debug.PushSubsStack("Day_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,408);
if (RapidSub.canDelegate("day_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","day_btn_click");}
 BA.debugLineNum = 408;BA.debugLine="Private Sub Day_btn_Click";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 409;BA.debugLine="menupanel.Visible = False";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("DeleteEvent_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,463);
if (RapidSub.canDelegate("deleteevent_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","deleteevent_btn_click");}
 BA.debugLineNum = 463;BA.debugLine="Private Sub DeleteEvent_btn_Click";
Debug.ShouldStop(16384);
 BA.debugLineNum = 464;BA.debugLine="deletepanel.Visible = True";
Debug.ShouldStop(32768);
...
try {
		Debug.PushSubsStack("deleteTLconfirm_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,516);
...
RemoteObject _ev = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 516;BA.debugLine="Private Sub deleteTLconfirm_btn_Click";
Debug.ShouldStop(8);
 BA.debugLineNum = 517;BA.debugLine="Dim eventmap As Map = CalendarActivity.CalendarMa";
Debug.ShouldStop(16);
_eventmap = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_eventmap = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runMethod(false,"Get",(Object)((day_module._currentdate))));Debug.locals.put("eventmap", _eventmap);Debug.locals.put("eventmap", _eventmap);
 BA.debugLineNum = 518;BA.debugLine="Dim timeline As List = eventmap.Get(\"Timeline\")";
Debug.ShouldStop(32);
...
_timeline = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _eventmap.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Timeline")))));Debug.locals.put("timeline", _timeline);Debug.locals.put("timeline", _timeline);
 BA.debugLineNum = 520;BA.debugLine="For i = timeline.Size -1 To 0 Step -1";
Debug.ShouldStop(128);
{
final int step3 = -1;
final int limit3 = 0;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 521;BA.debugLine="Dim ev As Map = timeline.Get(i)";
Debug.ShouldStop(256);
...
;
 BA.debugLineNum = 528;BA.debugLine="addTL_et.Text = \"\"";
Debug.ShouldStop(32768);
day_module.mostCurrent._addtl_et.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 529;BA.debugLine="deleteTLevent_confirmationpanel.Visible = False";
Debug.ShouldStop(65536);
day_module.mostCurrent._deletetlevent_confirmationpanel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 530;BA.debugLine="addEventTL_panel.Visible = False";
Debug.ShouldStop(131072);
day_module.mostCurrent._addeventtl_panel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 531;BA.debugLine="SaveCalendar";
Debug.ShouldStop(262144);
_savecalendar();
 BA.debugLineNum = 532;BA.debugLine="UpdateTimeLine";
Debug.ShouldStop(524288);
_updatetimeline();
...
try {
		Debug.PushSubsStack("deleteTLevent_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,508);
if (RapidSub.canDelegate("deletetlevent_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","deletetlevent_btn_click");}
 BA.debugLineNum = 508;BA.debugLine="Private Sub deleteTLevent_btn_Click";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 509;BA.debugLine="deleteTLevent_confirmationpanel.Visible = True";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("DrawHourLabels (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,148);
...
RemoteObject _lbl = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
 BA.debugLineNum = 148;BA.debugLine="Sub DrawHourLabels";
Debug.ShouldStop(524288);
 BA.debugLineNum = 150;BA.debugLine="Svtimeline.Panel.RemoveAllViews";
Debug.ShouldStop(2097152);
day_module.mostCurrent._svtimeline.runMethod(false,"getPanel").runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 152;BA.debugLine="Dim rowh As Int = 60dip";
Debug.ShouldStop(8388608);
_rowh = day_module.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 60)));Debug.locals.put("rowh", _rowh);Debug.locals.put("rowh", _rowh);
 BA.debugLineNum = 153;BA.debugLine="Svtimeline.Panel.Height = 24 * rowh";
Debug.ShouldStop(16777216);
day_module.mostCurrent._svtimeline.runMethod(false,"getPanel").runMethod(true,"setHeight",RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(24),_rowh}, "*",0, 1));
 BA.debugLineNum = 156;BA.debugLine="For h = 0 To 23";
Debug.ShouldStop(134217728);
{
final int step4 = 1;
final int limit4 = 23;
...
_p = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");Debug.locals.put("p", _p);
 BA.debugLineNum = 158;BA.debugLine="p.Initialize(\"hour\")";
Debug.ShouldStop(536870912);
_p.runVoidMethod ("Initialize",day_module.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("hour")));
 BA.debugLineNum = 159;BA.debugLine="p.Tag = h";
Debug.ShouldStop(1073741824);
_p.runMethod(false,"setTag",RemoteObject.createImmutable((_h)));
 BA.debugLineNum = 160;BA.debugLine="Svtimeline.Panel.AddView(p, 0, h*rowh, Svtimelin";
Debug.ShouldStop(-2147483648);
...
_lbl.runVoidMethod ("Initialize",day_module.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 164;BA.debugLine="lbl.Text = GetTimeString(h)";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("DrawMainEvents (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,84);
...
RemoteObject _lbl = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
RemoteObject _ev = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 84;BA.debugLine="Sub DrawMainEvents";
Debug.ShouldStop(524288);
 BA.debugLineNum = 85;BA.debugLine="svEvents.Panel.RemoveAllViews";
Debug.ShouldStop(1048576);
day_module.mostCurrent._svevents.runMethod(false,"getPanel").runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 86;BA.debugLine="If Not(CalendarActivity.CalendarMap.ContainsKey(c";
Debug.ShouldStop(2097152);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 90;BA.debugLine="Dim eventmap As Map = CalendarActivity.CalendarMa";
Debug.ShouldStop(33554432);
_eventmap = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_eventmap = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runMethod(false,"Get",(Object)((day_module._currentdate))));Debug.locals.put("eventmap", _eventmap);Debug.locals.put("eventmap", _eventmap);
 BA.debugLineNum = 91;BA.debugLine="Dim allevents As List = eventmap.Get(\"AllEvents\")";
Debug.ShouldStop(67108864);
_allevents = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_allevents = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _eventmap.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("AllEvents")))));Debug.locals.put("allevents", _allevents);Debug.locals.put("allevents", _allevents);
 BA.debugLineNum = 93;BA.debugLine="Dim y As Int = 0";
Debug.ShouldStop(268435456);
_y = BA.numberCast(int.class, 0);Debug.locals.put("y", _y);Debug.locals.put("y", _y);
 BA.debugLineNum = 94;BA.debugLine="Dim rowHeight As Int = 50dip";
Debug.ShouldStop(536870912);
_rowheight = day_module.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 50)));Debug.locals.put("rowHeight", _rowheight);Debug.locals.put("rowHeight", _rowheight);
 BA.debugLineNum = 95;BA.debugLine="For i = 0 To allevents.Size -1";
Debug.ShouldStop(1073741824);
{
final int step9 = 1;
...
Debug.ShouldStop(-2147483648);
_lbl = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");Debug.locals.put("lbl", _lbl);
 BA.debugLineNum = 97;BA.debugLine="Dim ev As Map = allevents.Get(i)";
Debug.ShouldStop(1);
_ev = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
...
_lbl.runVoidMethod ("setColor",_identifycolor(BA.ObjectToString(_ev.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Tags")))))));
 BA.debugLineNum = 105;BA.debugLine="svEvents.Panel.AddView(lbl, 0, y, svEvents.Width";
Debug.ShouldStop(256);
day_module.mostCurrent._svevents.runMethod(false,"getPanel").runVoidMethod ("AddView",(Object)((_lbl.getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(_y),(Object)(day_module.mostCurrent._svevents.runMethod(true,"getWidth")),(Object)(_rowheight));
 BA.debugLineNum = 106;BA.debugLine="y = y+rowHeight";
Debug.ShouldStop(512);
...
try {
		Debug.PushSubsStack("DrawTimelineEvents (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,195);
...
RemoteObject _lbl = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
 BA.debugLineNum = 195;BA.debugLine="Sub DrawTimelineEvents";
Debug.ShouldStop(4);
 BA.debugLineNum = 196;BA.debugLine="If Not(CalendarActivity.CalendarMap.ContainsKey(c";
Debug.ShouldStop(8);
if (day_module.mostCurrent.__c.runMethod(true,"Not",(Object)(day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runMethod(true,"ContainsKey",(Object)((day_module._currentdate))))).<Boolean>get().booleanValue()) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 198;BA.debugLine="Dim eventmap As Map = CalendarActivity.CalendarMa";
Debug.ShouldStop(32);
_eventmap = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_eventmap = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runMethod(false,"Get",(Object)((day_module._currentdate))));Debug.locals.put("eventmap", _eventmap);Debug.locals.put("eventmap", _eventmap);
 BA.debugLineNum = 199;BA.debugLine="Dim timeline As List = eventmap.Get(\"Timeline\")";
Debug.ShouldStop(64);
_timeline = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_timeline = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _eventmap.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Timeline")))));Debug.locals.put("timeline", _timeline);Debug.locals.put("timeline", _timeline);
 BA.debugLineNum = 201;BA.debugLine="Dim rowh As Int = 60dip";
Debug.ShouldStop(256);
_rowh = day_module.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 60)));Debug.locals.put("rowh", _rowh);Debug.locals.put("rowh", _rowh);
...
Debug.locals.put("h", _h);
 BA.debugLineNum = 204;BA.debugLine="Dim hourPanel As Panel = Svtimeline.Panel.GetVie";
Debug.ShouldStop(2048);
...
_hourpanel = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.PanelWrapper"), day_module.mostCurrent._svtimeline.runMethod(false,"getPanel").runMethod(false,"GetView",(Object)(BA.numberCast(int.class, _h))).getObject());Debug.locals.put("hourPanel", _hourpanel);Debug.locals.put("hourPanel", _hourpanel);
 BA.debugLineNum = 206;BA.debugLine="If hourPanel.NumberOfViews > 1 Then";
Debug.ShouldStop(8192);
if (RemoteObject.solveBoolean(">",_hourpanel.runMethod(true,"getNumberOfViews"),BA.numberCast(double.class, 1))) { 
 BA.debugLineNum = 207;BA.debugLine="hourPanel.RemoveViewAt(1)";
Debug.ShouldStop(16384);
...
;
 BA.debugLineNum = 211;BA.debugLine="For Each ev  As Map In timeline";
Debug.ShouldStop(262144);
_ev = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
{
...
Debug.locals.put("ev", _ev);
 BA.debugLineNum = 212;BA.debugLine="Dim starth As Int = ev.Get(\"Start\")";
Debug.ShouldStop(524288);
_starth = BA.numberCast(int.class, _ev.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Start")))));Debug.locals.put("starth", _starth);Debug.locals.put("starth", _starth);
 BA.debugLineNum = 213;BA.debugLine="Dim endh As Int = ev.Get(\"End\")";
Debug.ShouldStop(1048576);
_endh = BA.numberCast(int.class, _ev.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("End")))));Debug.locals.put("endh", _endh);Debug.locals.put("endh", _endh);
 BA.debugLineNum = 214;BA.debugLine="Dim title As String = ev.Get(\"Title\")";
Debug.ShouldStop(2097152);
_title = BA.ObjectToString(_ev.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Title")))));Debug.locals.put("title", _title);Debug.locals.put("title", _title);
 BA.debugLineNum = 215;BA.debugLine="Dim color As Int = IdentifyColor(ev.Get(\"Tags\"))";
Debug.ShouldStop(4194304);
_color = _identifycolor(BA.ObjectToString(_ev.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Tags"))))));Debug.locals.put("color", _color);Debug.locals.put("color", _color);
 BA.debugLineNum = 216;BA.debugLine="For h = starth To endh - 1";
Debug.ShouldStop(8388608);
{
final int step16 = 1;
...
Debug.locals.put("h", _h);
 BA.debugLineNum = 217;BA.debugLine="If h >= 0 And h <= 23 Then";
Debug.ShouldStop(16777216);
if (RemoteObject.solveBoolean("g",RemoteObject.createImmutable(_h),BA.numberCast(double.class, 0)) && RemoteObject.solveBoolean("k",RemoteObject.createImmutable(_h),BA.numberCast(double.class, 23))) { 
 BA.debugLineNum = 218;BA.debugLine="Dim hourPanel As Panel = Svtimeline.Panel.GetV";
Debug.ShouldStop(33554432);
_hourpanel = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");
_hourpanel = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.PanelWrapper"), day_module.mostCurrent._svtimeline.runMethod(false,"getPanel").runMethod(false,"GetView",(Object)(BA.numberCast(int.class, _h))).getObject());Debug.locals.put("hourPanel", _hourpanel);Debug.locals.put("hourPanel", _hourpanel);
 BA.debugLineNum = 219;BA.debugLine="Dim lbl As Label";
Debug.ShouldStop(67108864);
_lbl = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");Debug.locals.put("lbl", _lbl);
 BA.debugLineNum = 220;BA.debugLine="lbl.initialize(\"TimelineEvent\")";
Debug.ShouldStop(134217728);
_lbl.runVoidMethod ("Initialize",day_module.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("TimelineEvent")));
 BA.debugLineNum = 221;BA.debugLine="lbl.Tag = ev";
Debug.ShouldStop(268435456);
_lbl.runMethod(false,"setTag",(_ev.getObject()));
 BA.debugLineNum = 222;BA.debugLine="lbl.Text = title";
Debug.ShouldStop(536870912);
_lbl.runMethod(true,"setText",BA.ObjectToCharSequence(_title));
 BA.debugLineNum = 223;BA.debugLine="lbl.TextColor = Colors.Black";
Debug.ShouldStop(1073741824);
_lbl.runMethod(true,"setTextColor",day_module.mostCurrent.__c.getField(false,"Colors").getField(true,"Black"));
 BA.debugLineNum = 224;BA.debugLine="lbl.Gravity = Gravity.CENTER_VERTICAL";
Debug.ShouldStop(-2147483648);
_lbl.runMethod(true,"setGravity",day_module.mostCurrent.__c.getField(false,"Gravity").getField(true,"CENTER_VERTICAL"));
 BA.debugLineNum = 225;BA.debugLine="lbl.Color = color";
Debug.ShouldStop(1);
_lbl.runVoidMethod ("setColor",_color);
 BA.debugLineNum = 226;BA.debugLine="hourPanel.AddView(lbl, 65dip, 0, hourPanel.Wid";
Debug.ShouldStop(2);
...
try {
		Debug.PushSubsStack("editeventinfo_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,452);
if (RapidSub.canDelegate("editeventinfo_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","editeventinfo_btn_click");}
 BA.debugLineNum = 452;BA.debugLine="Private Sub editeventinfo_btn_Click";
Debug.ShouldStop(8);
 BA.debugLineNum = 453;BA.debugLine="EditInfoPanel.Visible = True";
Debug.ShouldStop(16);
day_module.mostCurrent._editinfopanel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 454;BA.debugLine="editTitle_et.text = currenttaggedEvent.Get(\"Title";
Debug.ShouldStop(32);
day_module.mostCurrent._edittitle_et.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(day_module.mostCurrent._currenttaggedevent.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Title"))))));
 BA.debugLineNum = 455;BA.debugLine="editDescription_et.Text = currenttaggedEvent.Get(";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("eventrb_CheckedChange (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,544);
...
Debug.locals.put("Checked", _checked);
 BA.debugLineNum = 544;BA.debugLine="Private Sub eventrb_CheckedChange(Checked As Boole";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 545;BA.debugLine="eventtype = \"Event\"";
Debug.ShouldStop(1);
...
try {
		Debug.PushSubsStack("GetTimeString (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,170);
...
Debug.locals.put("h", _h);
 BA.debugLineNum = 170;BA.debugLine="Sub GetTimeString (h As Int) As String";
Debug.ShouldStop(512);
 BA.debugLineNum = 171;BA.debugLine="Dim num As Int";
Debug.ShouldStop(1024);
_num = RemoteObject.createImmutable(0);Debug.locals.put("num", _num);
 BA.debugLineNum = 172;BA.debugLine="Dim ampm As String";
Debug.ShouldStop(2048);
_ampm = RemoteObject.createImmutable("");Debug.locals.put("ampm", _ampm);
 BA.debugLineNum = 173;BA.debugLine="If h = 0 Then";
Debug.ShouldStop(4096);
if (RemoteObject.solveBoolean("=",_h,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 174;BA.debugLine="num = 12";
Debug.ShouldStop(8192);
_num = BA.numberCast(int.class, 12);Debug.locals.put("num", _num);
 BA.debugLineNum = 175;BA.debugLine="ampm = \"am\"";
Debug.ShouldStop(16384);
_ampm = BA.ObjectToString("am");Debug.locals.put("ampm", _ampm);
 }else 
{ BA.debugLineNum = 176;BA.debugLine="Else if h = 12 Then";
Debug.ShouldStop(32768);
if (RemoteObject.solveBoolean("=",_h,BA.numberCast(double.class, 12))) { 
 BA.debugLineNum = 177;BA.debugLine="num = h";
Debug.ShouldStop(65536);
_num = _h;Debug.locals.put("num", _num);
 BA.debugLineNum = 178;BA.debugLine="ampm = \"pm\"";
Debug.ShouldStop(131072);
_ampm = BA.ObjectToString("pm");Debug.locals.put("ampm", _ampm);
 }else 
{ BA.debugLineNum = 179;BA.debugLine="Else if h > 12 Then";
Debug.ShouldStop(262144);
if (RemoteObject.solveBoolean(">",_h,BA.numberCast(double.class, 12))) { 
 BA.debugLineNum = 180;BA.debugLine="num = h - 12";
Debug.ShouldStop(524288);
_num = RemoteObject.solve(new RemoteObject[] {_h,RemoteObject.createImmutable(12)}, "-",1, 1);Debug.locals.put("num", _num);
 BA.debugLineNum = 181;BA.debugLine="If num = 12 Then";
Debug.ShouldStop(1048576);
if (RemoteObject.solveBoolean("=",_num,BA.numberCast(double.class, 12))) { 
 BA.debugLineNum = 182;BA.debugLine="ampm = \"am\"";
Debug.ShouldStop(2097152);
_ampm = BA.ObjectToString("am");Debug.locals.put("ampm", _ampm);
 }else {
 BA.debugLineNum = 184;BA.debugLine="ampm = \"pm\"";
Debug.ShouldStop(8388608);
_ampm = BA.ObjectToString("pm");Debug.locals.put("ampm", _ampm);
 };
 }else {
 BA.debugLineNum = 188;BA.debugLine="num = h";
Debug.ShouldStop(134217728);
_num = _h;Debug.locals.put("num", _num);
 BA.debugLineNum = 189;BA.debugLine="ampm = \"am\"";
Debug.ShouldStop(268435456);
_ampm = BA.ObjectToString("am");Debug.locals.put("ampm", _ampm);
 }}}
;
 BA.debugLineNum = 192;BA.debugLine="Return num & \":00\" & ampm";
Debug.ShouldStop(-2147483648);
...
try {
		Debug.PushSubsStack("hour_click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,255);
...
RemoteObject _eventmap = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
RemoteObject _timeline = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
 BA.debugLineNum = 255;BA.debugLine="Sub hour_click";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 256;BA.debugLine="Dim p As Panel =  Sender";
Debug.ShouldStop(-2147483648);
...
_p = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.PanelWrapper"), day_module.mostCurrent.__c.runMethod(false,"Sender",day_module.mostCurrent.activityBA));Debug.locals.put("p", _p);Debug.locals.put("p", _p);
 BA.debugLineNum = 257;BA.debugLine="Dim tappedIndex = p.tag";
Debug.ShouldStop(1);
...
if (day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runMethod(true,"ContainsKey",(Object)((day_module._currentdate))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 264;BA.debugLine="eventmap = CalendarActivity.CalendarMap.Get(curr";
Debug.ShouldStop(128);
...
_timeline = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _eventmap.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Timeline")))));Debug.locals.put("timeline", _timeline);
 ...
 BA.debugLineNum = 272;BA.debugLine="timeline.Initialize";
Debug.ShouldStop(32768);
_timeline.runVoidMethod ("Initialize");
 BA.debugLineNum = 273;BA.debugLine="eventmap.Put(\"Timeline\", timeline)";
Debug.ShouldStop(65536);
_eventmap.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("Timeline"))),(Object)((_timeline.getObject())));
 };
 BA.debugLineNum = 276;BA.debugLine="starttimelineSP.SelectedIndex = timeIndex";
Debug.ShouldStop(524288);
day_module.mostCurrent._starttimelinesp.runMethod(true,"setSelectedIndex",day_module._timeindex);
 BA.debugLineNum = 277;BA.debugLine="endtimelineSP.SelectedIndex = Min(timeIndex +1, 2";
Debug.ShouldStop(1048576);
day_module.mostCurrent._endtimelinesp.runMethod(true,"setSelectedIndex",BA.numberCast(int.class, day_module.mostCurrent.__c.runMethod(true,"Min",(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {day_module._timeindex,RemoteObject.createImmutable(1)}, "+",1, 1))),(Object)(BA.numberCast(double.class, 24)))));
 BA.debugLineNum = 278;BA.debugLine="eventrb.Checked = True";
Debug.ShouldStop(2097152);
...
try {
		Debug.PushSubsStack("IdentifyColor (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,127);
...
try {
		Debug.PushSubsStack("mainEvent_click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,111);
...
RemoteObject _lbl = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
RemoteObject _ev = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 111;BA.debugLine="Sub mainEvent_click";
Debug.ShouldStop(16384);
 BA.debugLineNum = 112;BA.debugLine="Dim eventmap As Map = CalendarActivity.CalendarMa";
Debug.ShouldStop(32768);
_eventmap = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_eventmap = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runMethod(false,"Get",(Object)(((day_module._currentdate)))));Debug.locals.put("eventmap", _eventmap);Debug.locals.put("eventmap", _eventmap);
 BA.debugLineNum = 113;BA.debugLine="Dim allevents As List = eventmap.Get(\"AllEvents\")";
Debug.ShouldStop(65536);
_allevents = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_allevents = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _eventmap.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("AllEvents")))));Debug.locals.put("allevents", _allevents);Debug.locals.put("allevents", _allevents);
 BA.debugLineNum = 114;BA.debugLine="Dim lbl As Label = Sender";
Debug.ShouldStop(131072);
...
_lbl = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.LabelWrapper"), day_module.mostCurrent.__c.runMethod(false,"Sender",day_module.mostCurrent.activityBA));Debug.locals.put("lbl", _lbl);Debug.locals.put("lbl", _lbl);
 BA.debugLineNum = 115;BA.debugLine="Dim ev As Map = allevents.get(lbl.Tag)";
Debug.ShouldStop(262144);
_ev = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
...
day_module.mostCurrent._eventtitle_lbl.runMethod(true,"setText",BA.ObjectToCharSequence(_ev.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Title"))))));
 BA.debugLineNum = 122;BA.debugLine="eventdescription_lbl.Text = ev.Get(\"Description\")";
Debug.ShouldStop(33554432);
day_module.mostCurrent._eventdescription_lbl.runMethod(true,"setText",BA.ObjectToCharSequence(_ev.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Description"))))));
 BA.debugLineNum = 123;BA.debugLine="tags_lbl.text = ev.Get(\"Tags\")";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("MapInitializer (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,286);
if (RapidSub.canDelegate("mapinitializer")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","mapinitializer");}
RemoteObject _eventmap = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
RemoteObject _allevents = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
RemoteObject _timeline = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
 BA.debugLineNum = 286;BA.debugLine="Sub MapInitializer As Map";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 287;BA.debugLine="Dim eventmap As Map";
Debug.ShouldStop(1073741824);
_eventmap = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("eventmap", _eventmap);
 BA.debugLineNum = 289;BA.debugLine="eventmap.Initialize";
Debug.ShouldStop(1);
_eventmap.runVoidMethod ("Initialize");
 BA.debugLineNum = 290;BA.debugLine="Dim allevents As List";
Debug.ShouldStop(2);
_allevents = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("allevents", _allevents);
 BA.debugLineNum = 291;BA.debugLine="allevents.initialize";
Debug.ShouldStop(4);
_allevents.runVoidMethod ("Initialize");
 BA.debugLineNum = 293;BA.debugLine="Dim timeline As List";
Debug.ShouldStop(16);
_timeline = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("timeline", _timeline);
 BA.debugLineNum = 294;BA.debugLine="timeline.initialize";
Debug.ShouldStop(32);
_timeline.runVoidMethod ("Initialize");
 BA.debugLineNum = 296;BA.debugLine="eventmap.Put(\"AllEvents\", allevents)";
Debug.ShouldStop(128);
_eventmap.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("AllEvents"))),(Object)((_allevents.getObject())));
 BA.debugLineNum = 297;BA.debugLine="eventmap.Put(\"Timeline\", timeline)";
Debug.ShouldStop(256);
_eventmap.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("Timeline"))),(Object)((_timeline.getObject())));
 BA.debugLineNum = 299;BA.debugLine="CalendarActivity.CalendarMap.Put(currentDate, eve";
Debug.ShouldStop(1024);
day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runVoidMethod ("Put",(Object)((day_module._currentdate)),(Object)((_eventmap.getObject())));
 BA.debugLineNum = 301;BA.debugLine="Return eventmap";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("menu_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,399);
if (RapidSub.canDelegate("menu_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","menu_btn_click");}
 BA.debugLineNum = 399;BA.debugLine="Private Sub menu_btn_Click";
Debug.ShouldStop(16384);
 BA.debugLineNum = 400;BA.debugLine="menupanel.Visible =True";
Debug.ShouldStop(32768);
...
try {
		Debug.PushSubsStack("Month_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,412);
if (RapidSub.canDelegate("month_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","month_btn_click");}
 BA.debugLineNum = 412;BA.debugLine="Private Sub Month_btn_Click";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 413;BA.debugLine="Activity.Finish";
Debug.ShouldStop(268435456);
day_module.mostCurrent._activity.runVoidMethod ("Finish");
 BA.debugLineNum = 414;BA.debugLine="StartActivity(CalendarActivity)";
Debug.ShouldStop(536870912);
...
try {
		Debug.PushSubsStack("ooo_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,446);
if (RapidSub.canDelegate("ooo_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","ooo_btn_click");}
 BA.debugLineNum = 446;BA.debugLine="Private Sub ooo_btn_Click";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 447;BA.debugLine="addpanel.Visible = False";
Debug.ShouldStop(1073741824);
day_module.mostCurrent._addpanel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 448;BA.debugLine="add_events_module.eventtype = \"OOO\"";
Debug.ShouldStop(-2147483648);
day_module.mostCurrent._add_events_module._eventtype /*RemoteObject*/  = BA.ObjectToString("OOO");
 BA.debugLineNum = 449;BA.debugLine="StartActivity(add_events_module)";
Debug.ShouldStop(1);
day_module.mostCurrent.__c.runVoidMethod ("StartActivity",day_module.processBA,(Object)((day_module.mostCurrent._add_events_module.getObject())));
...
try {
		Debug.PushSubsStack("ooorb_CheckedChange (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,536);
...
Debug.locals.put("Checked", _checked);
 BA.debugLineNum = 536;BA.debugLine="Private Sub ooorb_CheckedChange(Checked As Boolean";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 537;BA.debugLine="eventtype = \"OOO\"";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("SaveCalendar (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,80);
if (RapidSub.canDelegate("savecalendar")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","savecalendar");}
 BA.debugLineNum = 80;BA.debugLine="Sub SaveCalendar";
Debug.ShouldStop(32768);
 BA.debugLineNum = 81;BA.debugLine="CalendarActivity.kvs.put(\"CalendarKVS\", CalendarA";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("saveEdit_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,471);
if (RapidSub.canDelegate("saveedit_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","saveedit_btn_click");}
 BA.debugLineNum = 471;BA.debugLine="Private Sub saveEdit_btn_Click";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 472;BA.debugLine="If editTitle_et.text = \"\" Then";
Debug.ShouldStop(8388608);
if (RemoteObject.solveBoolean("=",day_module.mostCurrent._edittitle_et.runMethod(true,"getText"),BA.ObjectToString(""))) { 
 BA.debugLineNum = 473;BA.debugLine="MsgboxAsync(\"Event must have name\", \"Error\")";
Debug.ShouldStop(16777216);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 476;BA.debugLine="currenttaggedEvent.Put(\"Title\", editTitle_et.Text";
Debug.ShouldStop(134217728);
day_module.mostCurrent._currenttaggedevent.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("Title"))),(Object)((day_module.mostCurrent._edittitle_et.runMethod(true,"getText"))));
 BA.debugLineNum = 477;BA.debugLine="currenttaggedEvent.Put(\"Description\", editDescrip";
Debug.ShouldStop(268435456);
day_module.mostCurrent._currenttaggedevent.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("Description"))),(Object)((day_module.mostCurrent._editdescription_et.runMethod(true,"getText"))));
 BA.debugLineNum = 479;BA.debugLine="x_EventInfo_btn_Click";
Debug.ShouldStop(1073741824);
_x_eventinfo_btn_click();
 BA.debugLineNum = 480;BA.debugLine="eventTitle_lbl.text = editTitle_et.Text";
Debug.ShouldStop(-2147483648);
day_module.mostCurrent._eventtitle_lbl.runMethod(true,"setText",BA.ObjectToCharSequence(day_module.mostCurrent._edittitle_et.runMethod(true,"getText")));
 BA.debugLineNum = 481;BA.debugLine="eventdescription_lbl.Text = editDescription_et.te";
Debug.ShouldStop(1);
day_module.mostCurrent._eventdescription_lbl.runMethod(true,"setText",BA.ObjectToCharSequence(day_module.mostCurrent._editdescription_et.runMethod(true,"getText")));
 BA.debugLineNum = 482;BA.debugLine="eventInfo_panel.Visible = True";
Debug.ShouldStop(2);
day_module.mostCurrent._eventinfo_panel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 483;BA.debugLine="SaveCalendar";
Debug.ShouldStop(4);
_savecalendar();
 BA.debugLineNum = 484;BA.debugLine="DrawMainEvents";
Debug.ShouldStop(8);
_drawmainevents();
...
try {
		Debug.PushSubsStack("saveTL_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,304);
...
RemoteObject _en = RemoteObject.createImmutable(0);
 BA.debugLineNum = 304;BA.debugLine="Private Sub saveTL_btn_Click";
Debug.ShouldStop(32768);
 BA.debugLineNum = 305;BA.debugLine="Dim eventmap As Map = CalendarActivity.CalendarMa";
Debug.ShouldStop(65536);
_eventmap = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_eventmap = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runMethod(false,"Get",(Object)((day_module._currentdate))));Debug.locals.put("eventmap", _eventmap);Debug.locals.put("eventmap", _eventmap);
 BA.debugLineNum = 306;BA.debugLine="If addTL_et.text = \"\" Then";
Debug.ShouldStop(131072);
if (RemoteObject.solveBoolean("=",day_module.mostCurrent._addtl_et.runMethod(true,"getText"),BA.ObjectToString(""))) { 
 BA.debugLineNum = 307;BA.debugLine="MsgboxAsync(\"Event must have a name\", \"Error\")";
Debug.ShouldStop(262144);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 311;BA.debugLine="If CalendarActivity.CalendarMap.ContainsKey(curre";
Debug.ShouldStop(4194304);
if (day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runMethod(true,"ContainsKey",(Object)((day_module._currentdate))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 312;BA.debugLine="eventmap = CalendarActivity.CalendarMap.Get(curr";
Debug.ShouldStop(8388608);
_eventmap = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), day_module.mostCurrent._calendaractivity._calendarmap /*RemoteObject*/ .runMethod(false,"Get",(Object)((day_module._currentdate))));Debug.locals.put("eventmap", _eventmap);
 }else {
 BA.debugLineNum = 314;BA.debugLine="eventmap = MapInitializer";
Debug.ShouldStop(33554432);
_eventmap = _mapinitializer();Debug.locals.put("eventmap", _eventmap);
 };
 BA.debugLineNum = 316;BA.debugLine="Dim timeline As List = eventmap.Get(\"Timeline\")";
Debug.ShouldStop(134217728);
_timeline = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_timeline = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _eventmap.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Timeline")))));Debug.locals.put("timeline", _timeline);Debug.locals.put("timeline", _timeline);
 BA.debugLineNum = 317;BA.debugLine="Dim ev As Map";
Debug.ShouldStop(268435456);
_ev = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("ev", _ev);
 BA.debugLineNum = 318;BA.debugLine="ev.Initialize";
Debug.ShouldStop(536870912);
_ev.runVoidMethod ("Initialize");
 BA.debugLineNum = 320;BA.debugLine="ev.Put(\"Title\", addTL_et.Text)";
Debug.ShouldStop(-2147483648);
_ev.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("Title"))),(Object)((day_module.mostCurrent._addtl_et.runMethod(true,"getText"))));
 BA.debugLineNum = 321;BA.debugLine="ev.Put(\"Start\", starttimelineSP.SelectedIndex)";
Debug.ShouldStop(1);
_ev.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("Start"))),(Object)((day_module.mostCurrent._starttimelinesp.runMethod(true,"getSelectedIndex"))));
 BA.debugLineNum = 322;BA.debugLine="ev.Put(\"End\", endtimelineSP.SelectedIndex)";
Debug.ShouldStop(2);
_ev.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("End"))),(Object)((day_module.mostCurrent._endtimelinesp.runMethod(true,"getSelectedIndex"))));
 BA.debugLineNum = 323;BA.debugLine="ev.Put(\"Tags\", eventtype)";
Debug.ShouldStop(4);
_ev.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("Tags"))),(Object)((day_module.mostCurrent._eventtype)));
 BA.debugLineNum = 326;BA.debugLine="For i = timeline.Size - 1 To 0 Step -1";
Debug.ShouldStop(32);
{
final int step18 = -1;
final int limit18 = 0;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 327;BA.debugLine="Dim existing As Map = timeline.Get(i)";
Debug.ShouldStop(64);
...
_existing = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _timeline.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i))));Debug.locals.put("existing", _existing);Debug.locals.put("existing", _existing);
 BA.debugLineNum = 328;BA.debugLine="Dim st As Int = existing.Get(\"Start\")";
Debug.ShouldStop(128);
_st = BA.numberCast(int.class, _existing.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Start")))));Debug.locals.put("st", _st);Debug.locals.put("st", _st);
 BA.debugLineNum = 329;BA.debugLine="Dim en As Int = existing.Get(\"End\")";
Debug.ShouldStop(256);
_en = BA.numberCast(int.class, _existing.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("End")))));Debug.locals.put("en", _en);Debug.locals.put("en", _en);
 BA.debugLineNum = 332;BA.debugLine="If (starttimelineSP.SelectedIndex < en) And (end";
Debug.ShouldStop(2048);
if (RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean("<",day_module.mostCurrent._starttimelinesp.runMethod(true,"getSelectedIndex"),BA.numberCast(double.class, _en))))) && RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean(">",day_module.mostCurrent._endtimelinesp.runMethod(true,"getSelectedIndex"),BA.numberCast(double.class, _st)))))) { 
 BA.debugLineNum = 333;BA.debugLine="timeline.RemoveAt(i)";
Debug.ShouldStop(4096);
_timeline.runVoidMethod ("RemoveAt",(Object)(BA.numberCast(int.class, _i)));
...
;
 BA.debugLineNum = 338;BA.debugLine="timeline.add(ev)";
Debug.ShouldStop(131072);
_timeline.runVoidMethod ("Add",(Object)((_ev.getObject())));
 BA.debugLineNum = 340;BA.debugLine="SaveCalendar";
Debug.ShouldStop(524288);
_savecalendar();
 BA.debugLineNum = 341;BA.debugLine="UpdateTimeLine";
Debug.ShouldStop(1048576);
_updatetimeline();
 BA.debugLineNum = 342;BA.debugLine="addEventTL_panel.Visible  = False";
Debug.ShouldStop(2097152);
day_module.mostCurrent._addeventtl_panel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("sched_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,403);
if (RapidSub.canDelegate("sched_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","sched_btn_click");}
 BA.debugLineNum = 403;BA.debugLine="Private Sub sched_btn_Click";
Debug.ShouldStop(262144);
 BA.debugLineNum = 404;BA.debugLine="Activity.Finish";
Debug.ShouldStop(524288);
day_module.mostCurrent._activity.runVoidMethod ("Finish");
 BA.debugLineNum = 405;BA.debugLine="StartActivity(Schedule_module)";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("SetDate (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,347);
...
Debug.locals.put("Tagdate", _tagdate);
 BA.debugLineNum = 347;BA.debugLine="Sub SetDate(Tagdate As String) As String";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 349;BA.debugLine="Dim parts() As String = Regex.Split(\"-\", Tagdate)";
Debug.ShouldStop(268435456);
_parts = day_module.mostCurrent.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString("-")),(Object)(_tagdate));Debug.locals.put("parts", _parts);Debug.locals.put("parts", _parts);
 BA.debugLineNum = 350;BA.debugLine="Dim year As String = parts(0)";
Debug.ShouldStop(536870912);
_year = _parts.getArrayElement(true,BA.numberCast(int.class, 0));Debug.locals.put("year", _year);Debug.locals.put("year", _year);
 BA.debugLineNum = 351;BA.debugLine="Dim monthNum As Int = parts(1)";
Debug.ShouldStop(1073741824);
...
_ts = day_module.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"DateParse",(Object)(_tagdate));Debug.locals.put("ts", _ts);Debug.locals.put("ts", _ts);
 BA.debugLineNum = 371;BA.debugLine="Dim weekdayNum As Int = DateTime.GetDayOfWeek(ts)";
Debug.ShouldStop(262144);
_weekdaynum = day_module.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"GetDayOfWeek",(Object)(_ts));Debug.locals.put("weekdayNum", _weekdaynum);Debug.locals.put("weekdayNum", _weekdaynum);
 BA.debugLineNum = 372;BA.debugLine="Dim week As String";
Debug.ShouldStop(524288);
_week = RemoteObject.createImmutable("");Debug.locals.put("week", _week);
 BA.debugLineNum = 373;BA.debugLine="Select weekdayNum";
Debug.ShouldStop(1048576);
...
case 0: {
 BA.debugLineNum = 374;BA.debugLine="Case 1: week = \"Sunday\"";
Debug.ShouldStop(2097152);
_week = BA.ObjectToString("Sunday");Debug.locals.put("week", _week);
 break; }
case 1: {
 BA.debugLineNum = 375;BA.debugLine="Case 2: week = \"Monday\"";
Debug.ShouldStop(4194304);
_week = BA.ObjectToString("Monday");Debug.locals.put("week", _week);
 break; }
case 2: {
 BA.debugLineNum = 376;BA.debugLine="Case 3: week = \"Tuesday\"";
Debug.ShouldStop(8388608);
_week = BA.ObjectToString("Tuesday");Debug.locals.put("week", _week);
 break; }
case 3: {
 BA.debugLineNum = 377;BA.debugLine="Case 4: week = \"Wednesday\"";
Debug.ShouldStop(16777216);
_week = BA.ObjectToString("Wednesday");Debug.locals.put("week", _week);
 break; }
case 4: {
 BA.debugLineNum = 378;BA.debugLine="Case 5: week = \"Thursday\"";
Debug.ShouldStop(33554432);
_week = BA.ObjectToString("Thursday");Debug.locals.put("week", _week);
 break; }
case 5: {
 BA.debugLineNum = 379;BA.debugLine="Case 6: week = \"Friday\"";
Debug.ShouldStop(67108864);
_week = BA.ObjectToString("Friday");Debug.locals.put("week", _week);
 break; }
case 6: {
 BA.debugLineNum = 380;BA.debugLine="Case 7: week = \"Saturday\"";
Debug.ShouldStop(134217728);
_week = BA.ObjectToString("Saturday");Debug.locals.put("week", _week);
 break; }
}
;
 BA.debugLineNum = 383;BA.debugLine="Return week & \", \" & monthName & \" \" & day & \", \"";
Debug.ShouldStop(1073741824);
...
try {
		Debug.PushSubsStack("SetUpSpinners (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,70);
...
int _i = 0;
 BA.debugLineNum = 70;BA.debugLine="Sub SetUpSpinners";
Debug.ShouldStop(32);
 BA.debugLineNum = 71;BA.debugLine="Dim hours As List";
Debug.ShouldStop(64);
_hours = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("hours", _hours);
 BA.debugLineNum = 72;BA.debugLine="hours.Initialize";
Debug.ShouldStop(128);
_hours.runVoidMethod ("Initialize");
 BA.debugLineNum = 73;BA.debugLine="For i = 0 To 24";
Debug.ShouldStop(256);
{
final int step3 = 1;
final int limit3 = 24;
...
for (;(step3 > 0 && _i <= limit3) || (step3 < 0 && _i >= limit3) ;_i = ((int)(0 + _i + step3))  ) {
Debug.locals.put("i", _i);
 BA.debugLineNum = 74;BA.debugLine="hours.Add(GetTimeString(i))";
Debug.ShouldStop(512);
_hours.runVoidMethod ("Add",(Object)((_gettimestring(BA.numberCast(int.class, _i)))));
 }
}Debug.locals.put("i", _i);
;
 BA.debugLineNum = 76;BA.debugLine="starttimelineSP.AddAll(hours)";
Debug.ShouldStop(2048);
day_module.mostCurrent._starttimelinesp.runVoidMethod ("AddAll",(Object)(_hours));
 BA.debugLineNum = 77;BA.debugLine="endtimelineSP.AddAll(hours)";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("taskrb_CheckedChange (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,548);
...
Debug.locals.put("Checked", _checked);
 BA.debugLineNum = 548;BA.debugLine="Private Sub taskrb_CheckedChange(Checked As Boolea";
Debug.ShouldStop(8);
 BA.debugLineNum = 549;BA.debugLine="eventtype = \"Task\"";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("timelineEvent_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,233);
...
RemoteObject _lbl = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
RemoteObject _ev = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 233;BA.debugLine="Sub timelineEvent_Click";
Debug.ShouldStop(256);
 BA.debugLineNum = 234;BA.debugLine="Dim lbl As Label = Sender";
Debug.ShouldStop(512);
_lbl = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");
_lbl = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.LabelWrapper"), day_module.mostCurrent.__c.runMethod(false,"Sender",day_module.mostCurrent.activityBA));Debug.locals.put("lbl", _lbl);Debug.locals.put("lbl", _lbl);
 BA.debugLineNum = 235;BA.debugLine="Dim ev As Map = lbl.Tag";
Debug.ShouldStop(1024);
_ev = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_ev = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _lbl.runMethod(false,"getTag"));Debug.locals.put("ev", _ev);Debug.locals.put("ev", _ev);
 BA.debugLineNum = 236;BA.debugLine="currenttaggedEvent = ev";
Debug.ShouldStop(2048);
day_module.mostCurrent._currenttaggedevent = _ev;
 BA.debugLineNum = 239;BA.debugLine="addEventTL_panel.Visible = True";
Debug.ShouldStop(16384);
day_module.mostCurrent._addeventtl_panel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 242;BA.debugLine="addTL_et.Text = ev.Get(\"Title\")";
Debug.ShouldStop(131072);
day_module.mostCurrent._addtl_et.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(_ev.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Title"))))));
 BA.debugLineNum = 243;BA.debugLine="starttimelineSP.SelectedIndex = ev.Get(\"Start\")";
Debug.ShouldStop(262144);
day_module.mostCurrent._starttimelinesp.runMethod(true,"setSelectedIndex",BA.numberCast(int.class, _ev.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Start"))))));
 BA.debugLineNum = 244;BA.debugLine="endtimelineSP.SelectedIndex = ev.Get(\"End\")";
Debug.ShouldStop(524288);
day_module.mostCurrent._endtimelinesp.runMethod(true,"setSelectedIndex",BA.numberCast(int.class, _ev.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("End"))))));
 BA.debugLineNum = 247;BA.debugLine="Select Case ev.Get(\"Tags\")";
Debug.ShouldStop(4194304);
...
case 0: {
 BA.debugLineNum = 248;BA.debugLine="Case \"Task\": taskrb.Checked = True";
Debug.ShouldStop(8388608);
day_module.mostCurrent._taskrb.runMethodAndSync(true,"setChecked",day_module.mostCurrent.__c.getField(true,"True"));
 break; }
case 1: {
 BA.debugLineNum = 249;BA.debugLine="Case \"Event\": eventrb.Checked = True";
Debug.ShouldStop(16777216);
day_module.mostCurrent._eventrb.runMethodAndSync(true,"setChecked",day_module.mostCurrent.__c.getField(true,"True"));
 break; }
case 2: {
 BA.debugLineNum = 250;BA.debugLine="Case \"Birthday\": birthdayrb.Checked = True";
Debug.ShouldStop(33554432);
day_module.mostCurrent._birthdayrb.runMethodAndSync(true,"setChecked",day_module.mostCurrent.__c.getField(true,"True"));
 break; }
case 3: {
 BA.debugLineNum = 251;BA.debugLine="Case \"OOO\": ooorb.Checked = True";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("UpdateTimeLine (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,142);
if (RapidSub.canDelegate("updatetimeline")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","updatetimeline");}
 BA.debugLineNum = 142;BA.debugLine="Sub UpdateTimeLine";
Debug.ShouldStop(8192);
 BA.debugLineNum = 143;BA.debugLine="DrawMainEvents";
Debug.ShouldStop(16384);
_drawmainevents();
 BA.debugLineNum = 144;BA.debugLine="DrawHourLabels";
Debug.ShouldStop(32768);
_drawhourlabels();
 BA.debugLineNum = 145;BA.debugLine="DrawTimelineEvents";
Debug.ShouldStop(65536);
_drawtimelineevents();
...
try {
		Debug.PushSubsStack("x_EventInfo_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,458);
if (RapidSub.canDelegate("x_eventinfo_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","x_eventinfo_btn_click");}
 BA.debugLineNum = 458;BA.debugLine="Private Sub x_EventInfo_btn_Click";
Debug.ShouldStop(512);
 BA.debugLineNum = 459;BA.debugLine="eventInfo_panel.Visible = False";
Debug.ShouldStop(1024);
day_module.mostCurrent._eventinfo_panel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 460;BA.debugLine="EditInfoPanel.visible = False";
Debug.ShouldStop(2048);
day_module.mostCurrent._editinfopanel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("x_TLevent_btn_Click (day_module) ","day_module",16,day_module.mostCurrent.activityBA,day_module.mostCurrent,503);
if (RapidSub.canDelegate("x_tlevent_btn_click")) { return b4a.example.day_module.remoteMe.runUserSub(false, "day_module","x_tlevent_btn_click");}
 BA.debugLineNum = 503;BA.debugLine="Private Sub x_TLevent_btn_Click";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 504;BA.debugLine="addEventTL_panel.Visible = False";
Debug.ShouldStop(8388608);
day_module.mostCurrent._addeventtl_panel.runMethod(true,"setVisible",day_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 505;BA.debugLine="addTL_et.text = \"\"";
Debug.ShouldStop(16777216);
day_module.mostCurrent._addtl_et.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
