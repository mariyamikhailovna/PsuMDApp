...
public static b4a.example.musicactivity _musicactivity = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",todoactivity.mostCurrent._activity,"addTaskBtn",todoactivity.mostCurrent._addtaskbtn,"addTaskBtnPNL",todoactivity.mostCurrent._addtaskbtnpnl,"addTaskPanel",todoactivity.mostCurrent._addtaskpanel,"addTaskTextArea",todoactivity.mostCurrent._addtasktextarea,"addTitleTextArea",todoactivity.mostCurrent._addtitletextarea,"clockActivity",Debug.moduleToString(b4a.example.clockactivity.class),"corkActivity",Debug.moduleToString(b4a.example.corkactivity.class),"currentList",todoactivity.mostCurrent._currentlist,"editnote",Debug.moduleToString(b4a.example.editnote.class),"enterTaskBtn",todoactivity.mostCurrent._entertaskbtn,"helpActivity",Debug.moduleToString(b4a.example.helpactivity.class),"isAddingList",todoactivity._isaddinglist,"kvs",todoactivity._kvs,"listsList",todoactivity.mostCurrent._listslist,"Main",Debug.moduleToString(b4a.example.main.class),"MainActivity",Debug.moduleToString(b4a.example.mainactivity.class),"musicActivity",Debug.moduleToString(b4a.example.musicactivity.class),"musicService",Debug.moduleToString(b4a.example.musicservice.class),"navActivity",Debug.moduleToString(b4a.example.navactivity.class),"newListBtn",todoactivity.mostCurrent._newlistbtn,"noteActivity",Debug.moduleToString(b4a.example.noteactivity.class),"progressBar",todoactivity.mostCurrent._progressbar,"progressNumber",todoactivity.mostCurrent._progressnumber,"progressPercent",todoactivity.mostCurrent._progresspercent,"Starter",Debug.moduleToString(b4a.example.starter.class),"tasksList",todoactivity.mostCurrent._taskslist,"untitledNo",todoactivity._untitledno,"xui",todoactivity._xui};
}
}