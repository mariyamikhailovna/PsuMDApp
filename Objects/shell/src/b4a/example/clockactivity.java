...
public static b4a.example.corkactivity _corkactivity = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",clockactivity.mostCurrent._activity,"centerLeft",clockactivity._centerleft,"centerTop",clockactivity._centertop,"corkActivity",Debug.moduleToString(b4a.example.corkactivity.class),"counter",clockactivity._counter,"editnote",Debug.moduleToString(b4a.example.editnote.class),"helpActivity",Debug.moduleToString(b4a.example.helpactivity.class),"longDef",clockactivity._longdef,"longTxt",clockactivity.mostCurrent._longtxt,"Main",Debug.moduleToString(b4a.example.main.class),"MainActivity",Debug.moduleToString(b4a.example.mainactivity.class),"navActivity",Debug.moduleToString(b4a.example.navactivity.class),"noteActivity",Debug.moduleToString(b4a.example.noteactivity.class),"playBtn",clockactivity.mostCurrent._playbtn,"playing",clockactivity._playing,"pomoCounter",clockactivity.mostCurrent._pomocounter,"pomoDef",clockactivity._pomodef,"pomotimerLbl",clockactivity.mostCurrent._pomotimerlbl,"pomoTxt",clockactivity.mostCurrent._pomotxt,"secondsRemain",clockactivity._secondsremain,"settingsBtn",clockactivity.mostCurrent._settingsbtn,"settingsPnl",clockactivity.mostCurrent._settingspnl,"shortDef",clockactivity._shortdef,"shortTxt",clockactivity.mostCurrent._shorttxt,"Starter",Debug.moduleToString(b4a.example.starter.class),"timerCount",clockactivity._timercount,"timerState",clockactivity._timerstate,"xui",clockactivity._xui};
}
}