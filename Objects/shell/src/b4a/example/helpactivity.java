...
public static b4a.example.corkactivity _corkactivity = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",helpactivity.mostCurrent._activity,"backBtn",helpactivity.mostCurrent._backbtn,"clockActivity",Debug.moduleToString(b4a.example.clockactivity.class),"corkActivity",Debug.moduleToString(b4a.example.corkactivity.class),"descriptionLbl",helpactivity.mostCurrent._descriptionlbl,"editnote",Debug.moduleToString(b4a.example.editnote.class),"format24h",helpactivity._format24h,"helpimage",helpactivity.mostCurrent._helpimage,"helpPage",helpactivity._helppage,"kvs",helpactivity._kvs,"Main",Debug.moduleToString(b4a.example.main.class),"MainActivity",Debug.moduleToString(b4a.example.mainactivity.class),"navActivity",Debug.moduleToString(b4a.example.navactivity.class),"nextBtn",helpactivity.mostCurrent._nextbtn,"noteActivity",Debug.moduleToString(b4a.example.noteactivity.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"titleLbl",helpactivity.mostCurrent._titlelbl,"xui",helpactivity._xui};
}
}