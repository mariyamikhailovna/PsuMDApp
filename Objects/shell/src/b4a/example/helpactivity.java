...
public static RemoteObject _iconbutton1 = RemoteObject.declareNull("anywheresoftware.b4a.objects.ImageViewWrapper");
public static RemoteObject _iconbutton2 = RemoteObject.declareNull("anywheresoftware.b4a.objects.ImageViewWrapper");
public static RemoteObject _iconbutton3 = RemoteObject.declareNull("anywheresoftware.b4a.objects.ImageViewWrapper");
...
public static b4a.example.todoactivity _todoactivity = null;
  public Object[] GetGlobals() {
		return new Object[] {"active_recall",Debug.moduleToString(b4a.example.active_recall.class),"Activity",helpactivity.mostCurrent._activity,"Add_card_module",Debug.moduleToString(b4a.example.add_card_module.class),"add_card_module2",Debug.moduleToString(b4a.example.add_card_module2.class),"add_events_module",Debug.moduleToString(b4a.example.add_events_module.class),"all_active_recall",Debug.moduleToString(b4a.example.all_active_recall.class),"backBtn",helpactivity.mostCurrent._backbtn,"CalendarActivity",Debug.moduleToString(b4a.example.calendaractivity.class),"Card_Module",Debug.moduleToString(b4a.example.card_module.class),"clockActivity",Debug.moduleToString(b4a.example.clockactivity.class),"corkActivity",Debug.moduleToString(b4a.example.corkactivity.class),"day_module",Debug.moduleToString(b4a.example.day_module.class),"deck_all_cards",Debug.moduleToString(b4a.example.deck_all_cards.class),"descriptionLbl",helpactivity.mostCurrent._descriptionlbl,"editnote",Debug.moduleToString(b4a.example.editnote.class),"FlashcardActivity",Debug.moduleToString(b4a.example.flashcardactivity.class),"format24h",helpactivity._format24h,"helpimage",helpactivity.mostCurrent._helpimage,"helpPage",helpactivity._helppage,"iconButton1",helpactivity.mostCurrent._iconbutton1,"iconButton2",helpactivity.mostCurrent._iconbutton2,"iconButton3",helpactivity.mostCurrent._iconbutton3,"kvs",helpactivity._kvs,"Main",Debug.moduleToString(b4a.example.main.class),"MainActivity",Debug.moduleToString(b4a.example.mainactivity.class),"musicActivity",Debug.moduleToString(b4a.example.musicactivity.class),"musicCodeModule",Debug.moduleToString(b4a.example.musiccodemodule.class),"musicService",Debug.moduleToString(b4a.example.musicservice.class),"navActivity",Debug.moduleToString(b4a.example.navactivity.class),"nextBtn",helpactivity.mostCurrent._nextbtn,"noteActivity",Debug.moduleToString(b4a.example.noteactivity.class),"Schedule_module",Debug.moduleToString(b4a.example.schedule_module.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"Subdeck_Module",Debug.moduleToString(b4a.example.subdeck_module.class),"themeActivity",Debug.moduleToString(b4a.example.themeactivity.class),"titleLbl",helpactivity.mostCurrent._titlelbl,"todoActivity",Debug.moduleToString(b4a.example.todoactivity.class),"xui",helpactivity._xui};
}
}