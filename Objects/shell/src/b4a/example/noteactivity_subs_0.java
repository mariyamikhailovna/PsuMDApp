...
try {
		Debug.PushSubsStack("Activity_Pause (noteactivity) ","noteactivity",6,noteactivity.mostCurrent.activityBA,noteactivity.mostCurrent,35);
...
try {
		Debug.PushSubsStack("Activity_Resume (noteactivity) ","noteactivity",6,noteactivity.mostCurrent.activityBA,noteactivity.mostCurrent,31);
...
try {
		Debug.PushSubsStack("addBtn_Click (noteactivity) ","noteactivity",6,noteactivity.mostCurrent.activityBA,noteactivity.mostCurrent,94);
...
try {
		Debug.PushSubsStack("noteClv_ItemClick (noteactivity) ","noteactivity",6,noteactivity.mostCurrent.activityBA,noteactivity.mostCurrent,39);
...
try {
		Debug.PushSubsStack("noteClv_ItemLongClick (noteactivity) ","noteactivity",6,noteactivity.mostCurrent.activityBA,noteactivity.mostCurrent,49);
...
//C
this.state = 4;
 BA.debugLineNum = 55;BA.debugLine="Main.kvs.Remove(\"N_\" & n.noteID)";
Debug.ShouldStop(4194304);
...
try {
		Debug.PushSubsStack("noteCvl_ItemClick (noteactivity) ","noteactivity",6,noteactivity.mostCurrent.activityBA,noteactivity.mostCurrent,98);
...
try {
		Debug.PushSubsStack("RefreshList (noteactivity) ","noteactivity",6,noteactivity.mostCurrent.activityBA,noteactivity.mostCurrent,61);
...
try {
		Debug.PushSubsStack("searchTxt_TextChanged (noteactivity) ","noteactivity",6,noteactivity.mostCurrent.activityBA,noteactivity.mostCurrent,90);
