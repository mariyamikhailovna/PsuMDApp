...
Debug.ShouldStop(1048576);
 BA.debugLineNum = 22;BA.debugLine="Activity.LoadLayout(\"notepadLayout\")";
...
Debug.ShouldStop(33554432);
 BA.debugLineNum = 27;BA.debugLine="RefreshList(\"\")";
...
Debug.ShouldStop(16777216);
 BA.debugLineNum = 90;BA.debugLine="StartActivity(editnote)";
Debug.ShouldStop(33554432);
...
Debug.locals.put("Value", _value);
 BA.debugLineNum = 34;BA.debugLine="Sub noteClv_ItemClick (Index As Int, Value As Obje";
Debug.ShouldStop(2);
 BA.debugLineNum = 36;BA.debugLine="Dim selectedNote As MyNote = Value";
Debug.ShouldStop(8);
_selectednote = (_value);Debug.locals.put("selectedNote", _selectednote);Debug.locals.put("selectedNote", _selectednote);
 BA.debugLineNum = 39;BA.debugLine="editnote.ActiveNote = selectedNote";
Debug.ShouldStop(64);
noteactivity.mostCurrent._editnote._activenote /*RemoteObject*/  = _selectednote;
 BA.debugLineNum = 41;BA.debugLine="StartActivity(editnote)";
...
Debug.locals.put("Index", _index);
Debug.locals.put("Value", _value);
 BA.debugLineNum = 45;BA.debugLine="Dim n As MyNote = Value";
Debug.ShouldStop(4096);
_n = (_value);Debug.locals.put("n", _n);Debug.locals.put("n", _n);
 BA.debugLineNum = 47;BA.debugLine="Msgbox2Async(\"Are you sure you want to delete '\"";
...
parent.mostCurrent.__c.runVoidMethod ("Msgbox2Async",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Are you sure you want to delete '"),_n.getField(true,"Title" /*RemoteObject*/ ),RemoteObject.createImmutable("'?")))),(Object)(BA.ObjectToCharSequence("Delete Note")),(Object)(BA.ObjectToString("No")),(Object)(BA.ObjectToString("")),(Object)(BA.ObjectToString("Yes")),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper"), parent.mostCurrent.__c.getField(false,"Null")),noteactivity.processBA,(Object)(parent.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 48;BA.debugLine="Wait For Msgbox_Result (res As Int)";
...
;
 BA.debugLineNum = 49;BA.debugLine="If res = DialogResponse.NEGATIVE Then";
...
parent.mostCurrent._main._kvs /*RemoteObject*/ .runVoidMethod ("_remove",(Object)(RemoteObject.concat(RemoteObject.createImmutable("N_"),_n.getField(true,"noteID" /*RemoteObject*/ ))));
 BA.debugLineNum = 51;BA.debugLine="RefreshList(\"\")";
Debug.ShouldStop(262144);
_refreshlist(RemoteObject.createImmutable(""));
 BA.debugLineNum = 52;BA.debugLine="ToastMessageShow(\"Note deleted\", False)";
...
Debug.locals.put("Index", _index);
Debug.locals.put("Value", _value);
 BA.debugLineNum = 93;BA.debugLine="Sub noteCvl_ItemClick (Index As Int, Value As Obje";
...
Debug.locals.put("SearchQuery", _searchquery);
 BA.debugLineNum = 56;BA.debugLine="Sub RefreshList(SearchQuery As String)";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 57;BA.debugLine="noteClv.Clear";
Debug.ShouldStop(16777216);
noteactivity.mostCurrent._noteclv.runVoidMethod ("_clear");
 BA.debugLineNum = 58;BA.debugLine="Dim AllNotes As List";
Debug.ShouldStop(33554432);
_allnotes = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("AllNotes", _allnotes);
 BA.debugLineNum = 59;BA.debugLine="AllNotes.Initialize";
Debug.ShouldStop(67108864);
_allnotes.runVoidMethod ("Initialize");
 BA.debugLineNum = 61;BA.debugLine="Dim keys As List = MainActivity.kvs.ListKeys";
Debug.ShouldStop(268435456);
...
Debug.locals.put("k", _k);
 BA.debugLineNum = 64;BA.debugLine="If k.StartsWith(\"N_\") Then";
Debug.ShouldStop(-2147483648);
if (_k.runMethod(true,"startsWith",(Object)(RemoteObject.createImmutable("N_"))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 65;BA.debugLine="Dim N As MyNote = MainActivity.kvs.Get(k)";
Debug.ShouldStop(1);
_n = (noteactivity.mostCurrent._mainactivity._kvs /*RemoteObject*/ .runMethod(false,"_get",(Object)(_k)));Debug.locals.put("N", _n);Debug.locals.put("N", _n);
 BA.debugLineNum = 66;BA.debugLine="Dim query As String = SearchQuery.ToLowerCase";
Debug.ShouldStop(2);
_query = _searchquery.runMethod(true,"toLowerCase");Debug.locals.put("query", _query);Debug.locals.put("query", _query);
 BA.debugLineNum = 67;BA.debugLine="If query = \"\" Then";
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("=",_query,BA.ObjectToString(""))) { 
 BA.debugLineNum = 68;BA.debugLine="AllNotes.Add(N)";
Debug.ShouldStop(8);
_allnotes.runVoidMethod ("Add",(Object)((_n)));
 }else {
 BA.debugLineNum = 70;BA.debugLine="If N.Tags.ToLowerCase.Contains(query) Or N.Tit";
Debug.ShouldStop(32);
if (RemoteObject.solveBoolean(".",_n.getField(true,"Tags" /*RemoteObject*/ ).runMethod(true,"toLowerCase").runMethod(true,"contains",(Object)(_query))) || RemoteObject.solveBoolean(".",_n.getField(true,"Title" /*RemoteObject*/ ).runMethod(true,"toLowerCase").runMethod(true,"contains",(Object)(_query)))) { 
 BA.debugLineNum = 71;BA.debugLine="AllNotes.Add(N)";
Debug.ShouldStop(64);
_allnotes.runVoidMethod ("Add",(Object)((_n)));
 };
 };
...
;
 BA.debugLineNum = 77;BA.debugLine="AllNotes.SortType(\"Title\", True)";
Debug.ShouldStop(4096);
_allnotes.runVoidMethod ("SortType",(Object)(BA.ObjectToString("Title")),(Object)(noteactivity.mostCurrent.__c.getField(true,"True")));
 BA.debugLineNum = 79;BA.debugLine="For Each n As MyNote In AllNotes";
Debug.ShouldStop(16384);
{
...
Debug.locals.put("N", _n);
 BA.debugLineNum = 80;BA.debugLine="noteClv.AddTextItem(n.Title & CRLF & n.Tags, n)";
Debug.ShouldStop(32768);
...
Debug.locals.put("New", _new);
 BA.debugLineNum = 85;BA.debugLine="Sub searchTxt_TextChanged (Old As String, New As S";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 86;BA.debugLine="RefreshList(New)";
Debug.ShouldStop(2097152);
_refreshlist(_new);
