...
try {
		Debug.PushSubsStack("Activity_Pause (add_card_module) ","add_card_module",12,add_card_module.mostCurrent.activityBA,add_card_module.mostCurrent,44);
...
try {
		Debug.PushSubsStack("Activity_Resume (add_card_module) ","add_card_module",12,add_card_module.mostCurrent.activityBA,add_card_module.mostCurrent,40);
...
try {
		Debug.PushSubsStack("backbtn_Click (add_card_module) ","add_card_module",12,add_card_module.mostCurrent.activityBA,add_card_module.mostCurrent,89);
...
try {
		Debug.PushSubsStack("SaveCard_Click (add_card_module) ","add_card_module",12,add_card_module.mostCurrent.activityBA,add_card_module.mostCurrent,52);
...
try {
		Debug.PushSubsStack("SaveDecks (add_card_module) ","add_card_module",12,add_card_module.mostCurrent.activityBA,add_card_module.mostCurrent,47);
