...
try {
		Debug.PushSubsStack("Activity_Create (editnote) ","editnote",19,editnote.mostCurrent.activityBA,editnote.mostCurrent,22);
...
try {
		Debug.PushSubsStack("Activity_Pause (editnote) ","editnote",19,editnote.mostCurrent.activityBA,editnote.mostCurrent,43);
...
try {
		Debug.PushSubsStack("Activity_Resume (editnote) ","editnote",19,editnote.mostCurrent.activityBA,editnote.mostCurrent,39);
...
try {
		Debug.PushSubsStack("saveBtn_Click (editnote) ","editnote",19,editnote.mostCurrent.activityBA,editnote.mostCurrent,47);
