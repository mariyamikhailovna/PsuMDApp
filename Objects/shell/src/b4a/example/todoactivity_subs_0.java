...
try {
		Debug.PushSubsStack("showRenameTaskPanel (todoactivity) ","todoactivity",6,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,455);
...
try {
		Debug.PushSubsStack("taskCheckbox_CheckedChange (todoactivity) ","todoactivity",6,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,481);
...
try {
		Debug.PushSubsStack("tasksList_ItemLongClick (todoactivity) ","todoactivity",6,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,432);
...
try {
		Debug.PushSubsStack("tasksListUI (todoactivity) ","todoactivity",6,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,499);
...
try {
		Debug.PushSubsStack("updateProgress (todoactivity) ","todoactivity",6,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,544);
