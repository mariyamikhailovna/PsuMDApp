...
try {
		Debug.PushSubsStack("Activity_Create (add_events_module) ","add_events_module",15,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,26);
...
try {
		Debug.PushSubsStack("Activity_Pause (add_events_module) ","add_events_module",15,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,50);
...
try {
		Debug.PushSubsStack("Activity_Resume (add_events_module) ","add_events_module",15,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,38);
...
try {
		Debug.PushSubsStack("birthdayrb_CheckedChange (add_events_module) ","add_events_module",15,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,115);
...
try {
		Debug.PushSubsStack("eventrb_CheckedChange (add_events_module) ","add_events_module",15,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,119);
...
try {
		Debug.PushSubsStack("MapInitializer (add_events_module) ","add_events_module",15,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,67);
...
try {
		Debug.PushSubsStack("ooorb_CheckedChange (add_events_module) ","add_events_module",15,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,111);
...
try {
		Debug.PushSubsStack("save_btn_Click (add_events_module) ","add_events_module",15,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,85);
...
try {
		Debug.PushSubsStack("SaveCalendar (add_events_module) ","add_events_module",15,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,63);
...
try {
		Debug.PushSubsStack("taskrb_CheckedChange (add_events_module) ","add_events_module",15,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,123);
...
try {
		Debug.PushSubsStack("x_btn_Click (add_events_module) ","add_events_module",15,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,59);
