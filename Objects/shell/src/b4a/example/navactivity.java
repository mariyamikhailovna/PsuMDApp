...
public static b4a.example.mainactivity _mainactivity = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",navactivity.mostCurrent._activity,"clockActivity",Debug.moduleToString(b4a.example.clockactivity.class),"helpActivity",Debug.moduleToString(b4a.example.helpactivity.class),"Main",Debug.moduleToString(b4a.example.main.class),"MainActivity",Debug.moduleToString(b4a.example.mainactivity.class),"Starter",Debug.moduleToString(b4a.example.starter.class)};
}
}