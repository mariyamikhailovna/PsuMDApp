...
try {
		Debug.PushSubsStack("Activity_Pause (active_recall) ","active_recall",11,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,82);
...
try {
		Debug.PushSubsStack("Activity_Resume (active_recall) ","active_recall",11,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,78);
...
try {
		Debug.PushSubsStack("backbtn_Click (active_recall) ","active_recall",11,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,128);
...
try {
		Debug.PushSubsStack("goback_Click (active_recall) ","active_recall",11,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,123);
...
try {
		Debug.PushSubsStack("nextbtn_Click (active_recall) ","active_recall",11,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,106);
...
try {
		Debug.PushSubsStack("showAnswerbtn_Click (active_recall) ","active_recall",11,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,87);
...
try {
		Debug.PushSubsStack("ShowCard (active_recall) ","active_recall",11,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,68);
...
try {
		Debug.PushSubsStack("ShowProgress (active_recall) ","active_recall",11,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,49);
...
try {
		Debug.PushSubsStack("ShuffleCards (active_recall) ","active_recall",11,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,57);
