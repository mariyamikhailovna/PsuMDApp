...
public class calendaractivity_subs_1 {
...
calendaractivity.mostCurrent._yearsp.runMethod(true,"setSelectedIndex",BA.numberCast(int.class, 10));
 BA.debugLineNum = 67;BA.debugLine="If Starter.darkMode = True Then";
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("=",calendaractivity.mostCurrent._starter._darkmode /*RemoteObject*/ ,calendaractivity.mostCurrent.__c.getField(true,"True"))) { 
 BA.debugLineNum = 68;BA.debugLine="YearSP.DropdownBackgroundColor = Colors.Black";
Debug.ShouldStop(8);
calendaractivity.mostCurrent._yearsp.runMethod(true,"setDropdownBackgroundColor",calendaractivity.mostCurrent.__c.getField(false,"Colors").getField(true,"Black"));
 ...
 BA.debugLineNum = 72;BA.debugLine="MonthSp.AddAll(Months)";
...
calendaractivity.mostCurrent._monthsp.runVoidMethod ("AddAll",(Object)(calendaractivity.mostCurrent.__c.runMethod(false, "ArrayToList", (Object)(calendaractivity.mostCurrent._months))));
 BA.debugLineNum = 73;BA.debugLine="MonthSp.SelectedIndex = DateTime.GetMonth(DateTim";
...
calendaractivity.mostCurrent._monthsp.runMethod(true,"setSelectedIndex",RemoteObject.solve(new RemoteObject[] {calendaractivity.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"GetMonth",(Object)(calendaractivity.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"getNow"))),RemoteObject.createImmutable(1)}, "-",1, 1));
 BA.debugLineNum = 74;BA.debugLine="If Starter.darkMode = True Then";
Debug.ShouldStop(512);
if (RemoteObject.solveBoolean("=",calendaractivity.mostCurrent._starter._darkmode /*RemoteObject*/ ,calendaractivity.mostCurrent.__c.getField(true,"True"))) { 
 BA.debugLineNum = 75;BA.debugLine="MonthSp.DropdownBackgroundColor = Colors.Black";
...
{
final int step31 = 1;
final int limit31 = RemoteObject.solve(new RemoteObject[] {_column,RemoteObject.createImmutable(1)}, "-",1, 1).<Integer>get().intValue();
_c = 0 ;
...
try {
		Debug.PushSubsStack("Activity_Pause (calendaractivity) ","calendaractivity",7,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,308);
...
try {
		Debug.PushSubsStack("Activity_Resume (calendaractivity) ","calendaractivity",7,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,304);
...
try {
		Debug.PushSubsStack("cell_click_click (calendaractivity) ","calendaractivity",7,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,253);
...
RemoteObject _datestr = RemoteObject.createImmutable("");
 BA.debugLineNum = 253;BA.debugLine="Sub cell_click_click";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 255;BA.debugLine="Dim p As Panel = Sender";
Debug.ShouldStop(1073741824);
...
_p = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.PanelWrapper"), calendaractivity.mostCurrent.__c.runMethod(false,"Sender",calendaractivity.mostCurrent.activityBA));Debug.locals.put("p", _p);Debug.locals.put("p", _p);
 BA.debugLineNum = 256;BA.debugLine="Dim datestr As String = p.Tag";
...
calendaractivity.mostCurrent._activity.runVoidMethod ("Finish");
 BA.debugLineNum = 258;BA.debugLine="StartActivity(day_module)";
Debug.ShouldStop(2);
calendaractivity.mostCurrent.__c.runVoidMethod ("StartActivity",calendaractivity.processBA,(Object)((calendaractivity.mostCurrent._day_module.getObject())));
 BA.debugLineNum = 259;BA.debugLine="day_module.currentDate = datestr";
Debug.ShouldStop(4);
calendaractivity.mostCurrent._day_module._currentdate /*RemoteObject*/  = _datestr;
 BA.debugLineNum = 260;BA.debugLine="Log(datestr)";
Debug.ShouldStop(8);
calendaractivity.mostCurrent.__c.runVoidMethod ("LogImpl","56160391",_datestr,0);
...
try {
		Debug.PushSubsStack("CleanDebugger (calendaractivity) ","calendaractivity",7,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,106);
...
try {
		Debug.PushSubsStack("Day_btn_Click (calendaractivity) ","calendaractivity",7,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,334);
...
RemoteObject _datestr = RemoteObject.createImmutable("");
 BA.debugLineNum = 334;BA.debugLine="Private Sub Day_btn_Click";
Debug.ShouldStop(8192);
 BA.debugLineNum = 335;BA.debugLine="If day_module.currentDate = \"\" Then";
Debug.ShouldStop(16384);
if (RemoteObject.solveBoolean("=",calendaractivity.mostCurrent._day_module._currentdate /*RemoteObject*/ ,BA.ObjectToString(""))) { 
 BA.debugLineNum = 336;BA.debugLine="Dim currentyear As Int = DateTime.GetYear(DateTi";
Debug.ShouldStop(32768);
_currentyear = calendaractivity.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"GetYear",(Object)(calendaractivity.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"getNow")));Debug.locals.put("currentyear", _currentyear);Debug.locals.put("currentyear", _currentyear);
 BA.debugLineNum = 337;BA.debugLine="Dim currentmonth As Int = DateTime.GetMonth(Date";
...
_currentmonth = calendaractivity.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"GetMonth",(Object)(calendaractivity.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"getNow")));Debug.locals.put("currentmonth", _currentmonth);Debug.locals.put("currentmonth", _currentmonth);
 BA.debugLineNum = 338;BA.debugLine="Dim currentday As Int = DateTime.GetDayOfMonth(D";
Debug.ShouldStop(131072);
_currentday = calendaractivity.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"GetDayOfMonth",(Object)(calendaractivity.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"getNow")));Debug.locals.put("currentday", _currentday);Debug.locals.put("currentday", _currentday);
 BA.debugLineNum = 339;BA.debugLine="Dim datestr As String= currentyear & \"-\" & Numbe";
Debug.ShouldStop(262144);
_datestr = RemoteObject.concat(_currentyear,RemoteObject.createImmutable("-"),calendaractivity.mostCurrent.__c.runMethod(true,"NumberFormat",(Object)(BA.numberCast(double.class, _currentmonth)),(Object)(BA.numberCast(int.class, 2)),(Object)(BA.numberCast(int.class, 0))),RemoteObject.createImmutable("-"),calendaractivity.mostCurrent.__c.runMethod(true,"NumberFormat",(Object)(BA.numberCast(double.class, _currentday)),(Object)(BA.numberCast(int.class, 2)),(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("datestr", _datestr);Debug.locals.put("datestr", _datestr);
 BA.debugLineNum = 340;BA.debugLine="day_module.currentDate = datestr";
Debug.ShouldStop(524288);
calendaractivity.mostCurrent._day_module._currentdate /*RemoteObject*/  = _datestr;
 BA.debugLineNum = 341;BA.debugLine="Log(day_module.currentDate)";
Debug.ShouldStop(1048576);
calendaractivity.mostCurrent.__c.runVoidMethod ("LogImpl","56750215",calendaractivity.mostCurrent._day_module._currentdate /*RemoteObject*/ ,0);
 };
 BA.debugLineNum = 344;BA.debugLine="Activity.Finish";
Debug.ShouldStop(8388608);
calendaractivity.mostCurrent._activity.runVoidMethod ("Finish");
 BA.debugLineNum = 345;BA.debugLine="StartActivity(day_module)";
Debug.ShouldStop(16777216);
calendaractivity.mostCurrent.__c.runVoidMethod ("StartActivity",calendaractivity.processBA,(Object)((calendaractivity.mostCurrent._day_module.getObject())));
...
try {
		Debug.PushSubsStack("Daysinamonth (calendaractivity) ","calendaractivity",7,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,265);
...
Debug.locals.put("year", _year);
 BA.debugLineNum = 265;BA.debugLine="Sub Daysinamonth(Month As Int, year As Int) As Int";
Debug.ShouldStop(256);
 BA.debugLineNum = 266;BA.debugLine="Dim nextMonth As Int";
Debug.ShouldStop(512);
_nextmonth = RemoteObject.createImmutable(0);Debug.locals.put("nextMonth", _nextmonth);
 BA.debugLineNum = 267;BA.debugLine="Dim nextyear As Int";
Debug.ShouldStop(1024);
_nextyear = RemoteObject.createImmutable(0);Debug.locals.put("nextyear", _nextyear);
 BA.debugLineNum = 269;BA.debugLine="If Month = 12 Then";
Debug.ShouldStop(4096);
if (RemoteObject.solveBoolean("=",_month,BA.numberCast(double.class, 12))) { 
 BA.debugLineNum = 270;BA.debugLine="nextMonth = 1";
Debug.ShouldStop(8192);
_nextmonth = BA.numberCast(int.class, 1);Debug.locals.put("nextMonth", _nextmonth);
 BA.debugLineNum = 271;BA.debugLine="nextyear = year+1";
Debug.ShouldStop(16384);
_nextyear = RemoteObject.solve(new RemoteObject[] {_year,RemoteObject.createImmutable(1)}, "+",1, 1);Debug.locals.put("nextyear", _nextyear);
 ...
 BA.debugLineNum = 273;BA.debugLine="nextMonth = Month +1";
Debug.ShouldStop(65536);
_nextmonth = RemoteObject.solve(new RemoteObject[] {_month,RemoteObject.createImmutable(1)}, "+",1, 1);Debug.locals.put("nextMonth", _nextmonth);
 BA.debugLineNum = 274;BA.debugLine="nextyear = year";
Debug.ShouldStop(131072);
_nextyear = _year;Debug.locals.put("nextyear", _nextyear);
 };
 BA.debugLineNum = 277;BA.debugLine="DateTime.DateFormat = \"yyyy-MM-dd\"";
Debug.ShouldStop(1048576);
calendaractivity.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("yyyy-MM-dd"));
 BA.debugLineNum = 278;BA.debugLine="Dim firstNextMonth As Long = DateTime.DateParse(n";
Debug.ShouldStop(2097152);
_firstnextmonth = calendaractivity.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"DateParse",(Object)(RemoteObject.concat(_nextyear,RemoteObject.createImmutable("-"),calendaractivity.mostCurrent.__c.runMethod(true,"NumberFormat",(Object)(BA.numberCast(double.class, _nextmonth)),(Object)(BA.numberCast(int.class, 2)),(Object)(BA.numberCast(int.class, 0))),RemoteObject.createImmutable("-01"))));Debug.locals.put("firstNextMonth", _firstnextmonth);Debug.locals.put("firstNextMonth", _firstnextmonth);
 BA.debugLineNum = 279;BA.debugLine="Dim lastDayDate As Long = firstNextMonth - DateTi";
Debug.ShouldStop(4194304);
_lastdaydate = RemoteObject.solve(new RemoteObject[] {_firstnextmonth,calendaractivity.mostCurrent.__c.getField(false,"DateTime").getField(true,"TicksPerDay")}, "-",1, 2);Debug.locals.put("lastDayDate", _lastdaydate);Debug.locals.put("lastDayDate", _lastdaydate);
 BA.debugLineNum = 282;BA.debugLine="Return DateTime.GetDayOfMonth(lastDayDate)";
Debug.ShouldStop(33554432);
...
try {
		Debug.PushSubsStack("DrawCalendar (calendaractivity) ","calendaractivity",7,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,111);
...
try {
		Debug.PushSubsStack("IdentifyColor (calendaractivity) ","calendaractivity",7,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,238);
...
if (RemoteObject.solveBoolean("=",_typeofevent,BA.ObjectToString("Task"))) { 
 BA.debugLineNum = 241;BA.debugLine="mycolor = Colors.ARGB(255, 0, 191, 255)";
Debug.ShouldStop(65536);
...
if (RemoteObject.solveBoolean("=",_typeofevent,BA.ObjectToString("Event"))) { 
 BA.debugLineNum = 243;BA.debugLine="mycolor = Colors.ARGB(255, 152, 255, 152)";
Debug.ShouldStop(262144);
...
if (RemoteObject.solveBoolean("=",_typeofevent,BA.ObjectToString("Birthday"))) { 
 BA.debugLineNum = 245;BA.debugLine="mycolor = Colors.ARGB(255, 255, 182, 193)";
Debug.ShouldStop(1048576);
...
if (RemoteObject.solveBoolean("=",_typeofevent,BA.ObjectToString("OOO"))) { 
 BA.debugLineNum = 247;BA.debugLine="mycolor = Colors.ARGB(255, 255, 215, 0)";
Debug.ShouldStop(4194304);
...
;
 BA.debugLineNum = 249;BA.debugLine="Return mycolor";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("menu_btn_Click (calendaractivity) ","calendaractivity",7,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,325);
if (RapidSub.canDelegate("menu_btn_click")) { return b4a.example.calendaractivity.remoteMe.runUserSub(false, "calendaractivity","menu_btn_click");}
 BA.debugLineNum = 325;BA.debugLine="Private Sub menu_btn_Click";
Debug.ShouldStop(16);
 BA.debugLineNum = 326;BA.debugLine="menupanel.Visible =True";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("Month_btn_Click (calendaractivity) ","calendaractivity",7,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,348);
if (RapidSub.canDelegate("month_btn_click")) { return b4a.example.calendaractivity.remoteMe.runUserSub(false, "calendaractivity","month_btn_click");}
 BA.debugLineNum = 348;BA.debugLine="Private Sub Month_btn_Click";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 349;BA.debugLine="menupanel.Visible = False";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("MonthSp_ItemClick (calendaractivity) ","calendaractivity",7,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,313);
...
Debug.locals.put("Value", _value);
 BA.debugLineNum = 313;BA.debugLine="Private Sub MonthSp_ItemClick (Position As Int, Va";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 314;BA.debugLine="Dim selectedmonth As Int = Position +1";
Debug.ShouldStop(33554432);
_selectedmonth = RemoteObject.solve(new RemoteObject[] {_position,RemoteObject.createImmutable(1)}, "+",1, 1);Debug.locals.put("selectedmonth", _selectedmonth);Debug.locals.put("selectedmonth", _selectedmonth);
 BA.debugLineNum = 316;BA.debugLine="DrawCalendar(selectedmonth, DateTime.GetYear(Date";
Debug.ShouldStop(134217728);
...
try {
		Debug.PushSubsStack("sched_btn_Click (calendaractivity) ","calendaractivity",7,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,329);
if (RapidSub.canDelegate("sched_btn_click")) { return b4a.example.calendaractivity.remoteMe.runUserSub(false, "calendaractivity","sched_btn_click");}
 BA.debugLineNum = 329;BA.debugLine="Private Sub sched_btn_Click";
Debug.ShouldStop(256);
 BA.debugLineNum = 330;BA.debugLine="Activity.Finish";
Debug.ShouldStop(512);
calendaractivity.mostCurrent._activity.runVoidMethod ("Finish");
 BA.debugLineNum = 331;BA.debugLine="StartActivity(Schedule_module)";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("Weekday (calendaractivity) ","calendaractivity",7,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,286);
...
try {
		Debug.PushSubsStack("YearSP_ItemClick (calendaractivity) ","calendaractivity",7,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,319);
...
Debug.locals.put("Position", _position);
Debug.locals.put("Value", _value);
 BA.debugLineNum = 319;BA.debugLine="Private Sub YearSP_ItemClick (Position As Int, Val";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 320;BA.debugLine="Dim selectedyear As Int = Value";
Debug.ShouldStop(-2147483648);
_selectedyear = BA.numberCast(int.class, _value);Debug.locals.put("selectedyear", _selectedyear);Debug.locals.put("selectedyear", _selectedyear);
 BA.debugLineNum = 322;BA.debugLine="DrawCalendar(MonthSp.SelectedIndex +1, selectedye";
Debug.ShouldStop(2);
