...
try {
		Debug.PushSubsStack("Application_Error (starter) ","starter",22,starter.processBA,starter.mostCurrent,28);
...
try {
		Debug.PushSubsStack("Service_Create (starter) ","starter",22,starter.processBA,starter.mostCurrent,13);
...
try {
		Debug.PushSubsStack("Service_Destroy (starter) ","starter",22,starter.processBA,starter.mostCurrent,32);
...
try {
		Debug.PushSubsStack("Service_Start (starter) ","starter",22,starter.processBA,starter.mostCurrent,19);
...
try {
		Debug.PushSubsStack("Service_TaskRemoved (starter) ","starter",22,starter.processBA,starter.mostCurrent,23);
