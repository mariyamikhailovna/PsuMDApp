...
public static b4a.example.corkactivity _corkactivity = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",mainactivity.mostCurrent._activity,"clockActivity",Debug.moduleToString(b4a.example.clockactivity.class),"clockBtn",mainactivity.mostCurrent._clockbtn,"clockLightBtn",mainactivity.mostCurrent._clocklightbtn,"computerGif",mainactivity.mostCurrent._computergif,"corkActivity",Debug.moduleToString(b4a.example.corkactivity.class),"darkModeLayout",mainactivity.mostCurrent._darkmodelayout,"dcomputerGif",mainactivity.mostCurrent._dcomputergif,"editnote",Debug.moduleToString(b4a.example.editnote.class),"format24h",mainactivity._format24h,"helpActivity",Debug.moduleToString(b4a.example.helpactivity.class),"hsv",mainactivity.mostCurrent._hsv,"infoDescLbl",mainactivity.mostCurrent._infodesclbl,"infoPage",mainactivity._infopage,"infoPageLbl",mainactivity.mostCurrent._infopagelbl,"infoPnl",mainactivity.mostCurrent._infopnl,"infoTitleLbl",mainactivity.mostCurrent._infotitlelbl,"kvs",mainactivity._kvs,"Main",Debug.moduleToString(b4a.example.main.class),"navActivity",Debug.moduleToString(b4a.example.navactivity.class),"noteActivity",Debug.moduleToString(b4a.example.noteactivity.class),"regLayout",mainactivity.mostCurrent._reglayout,"size",mainactivity._size,"Starter",Debug.moduleToString(b4a.example.starter.class),"timerClock",mainactivity._timerclock,"xui",mainactivity._xui};
}
}