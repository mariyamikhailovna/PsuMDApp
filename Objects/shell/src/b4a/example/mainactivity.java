...
public static b4a.example.helpactivity _helpactivity = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",mainactivity.mostCurrent._activity,"clockActivity",Debug.moduleToString(b4a.example.clockactivity.class),"darkModeLayout",mainactivity.mostCurrent._darkmodelayout,"helpActivity",Debug.moduleToString(b4a.example.helpactivity.class),"Main",Debug.moduleToString(b4a.example.main.class),"navActivity",Debug.moduleToString(b4a.example.navactivity.class),"regLayout",mainactivity.mostCurrent._reglayout,"Starter",Debug.moduleToString(b4a.example.starter.class),"xui",mainactivity._xui};
}
}