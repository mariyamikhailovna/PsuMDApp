...
try {
		Debug.PushSubsStack("Activity_Create (themeactivity) ","themeactivity",8,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,23);
...
try {
		Debug.PushSubsStack("Activity_Pause (themeactivity) ","themeactivity",8,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,37);
...
try {
		Debug.PushSubsStack("Activity_Resume (themeactivity) ","themeactivity",8,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,33);
...
try {
		Debug.PushSubsStack("applyBtn_Click (themeactivity) ","themeactivity",8,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,79);
...
try {
		Debug.PushSubsStack("backBtn_Click (themeactivity) ","themeactivity",8,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,69);
...
try {
		Debug.PushSubsStack("closeHelp_Click (themeactivity) ","themeactivity",8,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,75);
...
try {
		Debug.PushSubsStack("nextBtn_Click (themeactivity) ","themeactivity",8,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,63);
...
try {
		Debug.PushSubsStack("showThemePage (themeactivity) ","themeactivity",8,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,41);
