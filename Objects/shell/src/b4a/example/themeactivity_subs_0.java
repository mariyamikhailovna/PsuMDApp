...
try {
		Debug.PushSubsStack("Activity_Pause (themeactivity) ","themeactivity",2,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,37);
...
try {
		Debug.PushSubsStack("Activity_Resume (themeactivity) ","themeactivity",2,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,33);
...
try {
		Debug.PushSubsStack("applyBtn_Click (themeactivity) ","themeactivity",2,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,79);
...
themeactivity.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("Theme changed!")),(Object)(themeactivity.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 91;BA.debugLine="MainActivity.kvsPref.Put(\"themeNumber\", Starter.t";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("backBtn_Click (themeactivity) ","themeactivity",2,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,69);
...
try {
		Debug.PushSubsStack("closeHelp_Click (themeactivity) ","themeactivity",2,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,75);
...
try {
		Debug.PushSubsStack("nextBtn_Click (themeactivity) ","themeactivity",2,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,63);
...
try {
		Debug.PushSubsStack("showThemePage (themeactivity) ","themeactivity",2,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,41);
