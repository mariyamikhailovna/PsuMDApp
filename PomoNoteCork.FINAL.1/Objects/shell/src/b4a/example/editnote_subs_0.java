...
try {
		Debug.PushSubsStack("Activity_Create (editnote) ","editnote",4,editnote.mostCurrent.activityBA,editnote.mostCurrent,22);
...
try {
		Debug.PushSubsStack("Activity_Pause (editnote) ","editnote",4,editnote.mostCurrent.activityBA,editnote.mostCurrent,40);
...
try {
		Debug.PushSubsStack("Activity_Resume (editnote) ","editnote",4,editnote.mostCurrent.activityBA,editnote.mostCurrent,36);
...
try {
		Debug.PushSubsStack("saveBtn_Click (editnote) ","editnote",4,editnote.mostCurrent.activityBA,editnote.mostCurrent,44);
...
_n.runVoidMethod ("Initialize");
 BA.debugLineNum = 54;BA.debugLine="If ActiveNote.IsInitialized And ActiveNote.noteID";
Debug.ShouldStop(2097152);
...
_n.setField ("DateAdded" /*RemoteObject*/ ,editnote.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"getNow"));
 BA.debugLineNum = 70;BA.debugLine="Main.kvs.Put(\"N_\" & n.noteID, n)";
Debug.ShouldStop(32);
editnote.mostCurrent._main._kvs /*RemoteObject*/ .runClassMethod (b4a.example.keyvaluestore.class, "_put" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("N_"),_n.getField(true,"noteID" /*RemoteObject*/ ))),(Object)((_n)));
