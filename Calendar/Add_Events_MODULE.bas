...
Sub MapInitializer As Map
	...
	Main.CalendarMap.Put(day_module.currentDate, eventmap)
...
Private Sub save_btn_Click
	...
	If Main.CalendarMap.ContainsKey(Day_MODULE.currentDate) Then
		eventmap = Main.CalendarMap.Get(Day_MODULE.currentDate)
	Else
