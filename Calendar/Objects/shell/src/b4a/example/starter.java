...
public static b4a.example.add_events_module _add_events_module = null;
  public Object[] GetGlobals() {
		return new Object[] {"Add_Events_MODULE",Debug.moduleToString(b4a.example.add_events_module.class),"Day_MODULE",Debug.moduleToString(b4a.example.day_module.class),"Main",Debug.moduleToString(b4a.example.main.class),"Schedule_MODULE",Debug.moduleToString(b4a.example.schedule_module.class),"Service",starter.mostCurrent._service,"Week_MODULE",Debug.moduleToString(b4a.example.week_module.class)};
}
}