...
try {
		Debug.PushSubsStack("Activity_Create (add_events_module) ","add_events_module",5,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,26);
...
Debug.ShouldStop(33554432);
 BA.debugLineNum = 29;BA.debugLine="Activity.LoadLayout(\"Layout5\")";
Debug.ShouldStop(268435456);
add_events_module.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Layout5")),add_events_module.mostCurrent.activityBA);
...
try {
		Debug.PushSubsStack("Activity_Pause (add_events_module) ","add_events_module",5,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,46);
...
try {
		Debug.PushSubsStack("Activity_Resume (add_events_module) ","add_events_module",5,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,34);
...
try {
		Debug.PushSubsStack("birthdayrb_CheckedChange (add_events_module) ","add_events_module",5,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,110);
...
try {
		Debug.PushSubsStack("eventrb_CheckedChange (add_events_module) ","add_events_module",5,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,114);
...
try {
		Debug.PushSubsStack("MapInitializer (add_events_module) ","add_events_module",5,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,62);
...
_eventmap.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("Timeline"))),(Object)((_timeline.getObject())));
 BA.debugLineNum = 75;BA.debugLine="Main.CalendarMap.Put(day_module.currentDate, even";
Debug.ShouldStop(1024);
add_events_module.mostCurrent._main._calendarmap /*RemoteObject*/ .runVoidMethod ("Put",(Object)((add_events_module.mostCurrent._day_module._currentdate /*RemoteObject*/ )),(Object)((_eventmap.getObject())));
...
try {
		Debug.PushSubsStack("ooorb_CheckedChange (add_events_module) ","add_events_module",5,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,106);
...
try {
		Debug.PushSubsStack("save_btn_Click (add_events_module) ","add_events_module",5,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,80);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 87;BA.debugLine="If Main.CalendarMap.ContainsKey(Day_MODULE.curren";
Debug.ShouldStop(4194304);
if (add_events_module.mostCurrent._main._calendarmap /*RemoteObject*/ .runMethod(true,"ContainsKey",(Object)((add_events_module.mostCurrent._day_module._currentdate /*RemoteObject*/ ))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 88;BA.debugLine="eventmap = Main.CalendarMap.Get(Day_MODULE.curre";
Debug.ShouldStop(8388608);
_eventmap = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), add_events_module.mostCurrent._main._calendarmap /*RemoteObject*/ .runMethod(false,"Get",(Object)((add_events_module.mostCurrent._day_module._currentdate /*RemoteObject*/ ))));Debug.locals.put("eventmap", _eventmap);
 }else {
...
try {
		Debug.PushSubsStack("SaveCalendar (add_events_module) ","add_events_module",5,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,58);
...
Debug.ShouldStop(33554432);
 BA.debugLineNum = 59;BA.debugLine="Main.kvs.put(\"CalendarKVS\", Main.CalendarMap)";
Debug.ShouldStop(67108864);
add_events_module.mostCurrent._main._kvs /*RemoteObject*/ .runClassMethod (b4a.example.keyvaluestore.class, "_put" /*RemoteObject*/ ,(Object)(BA.ObjectToString("CalendarKVS")),(Object)((add_events_module.mostCurrent._main._calendarmap /*RemoteObject*/ .getObject())));
...
try {
		Debug.PushSubsStack("taskrb_CheckedChange (add_events_module) ","add_events_module",5,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,118);
...
try {
		Debug.PushSubsStack("x_btn_Click (add_events_module) ","add_events_module",5,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,54);
