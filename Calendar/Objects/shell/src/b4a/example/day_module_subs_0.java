...
day_module.mostCurrent.__c.runVoidMethod ("LogImpl","62359306",day_module._currentdate,0);
...
_lbl.runMethod(true,"setText",BA.ObjectToCharSequence(_gettimestring(BA.numberCast(int.class, _h))));
 BA.debugLineNum = 161;BA.debugLine="lbl.Gravity = Gravity.CENTER_VERTICAL";
Debug.ShouldStop(1);
