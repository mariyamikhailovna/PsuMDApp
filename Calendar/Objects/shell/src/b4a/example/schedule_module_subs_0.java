...
try {
		Debug.PushSubsStack("Activity_Pause (schedule_module) ","schedule_module",4,schedule_module.mostCurrent.activityBA,schedule_module.mostCurrent,182);
...
try {
		Debug.PushSubsStack("Activity_Resume (schedule_module) ","schedule_module",4,schedule_module.mostCurrent.activityBA,schedule_module.mostCurrent,178);
...
try {
		Debug.PushSubsStack("Day_btn_Click (schedule_module) ","schedule_module",4,schedule_module.mostCurrent.activityBA,schedule_module.mostCurrent,195);
...
schedule_module.mostCurrent.__c.runVoidMethod ("LogImpl","85308429",_keys,0);
 }
}Debug.locals.put("keys", _keys);
;
...
Debug.locals.put("date", _date);
 BA.debugLineNum = 51;BA.debugLine="Dim eventmap As Map = Main.CalendarMap.Get(date)";
...
try {
		Debug.PushSubsStack("GetTimeString (schedule_module) ","schedule_module",4,schedule_module.mostCurrent.activityBA,schedule_module.mostCurrent,98);
...
try {
		Debug.PushSubsStack("IdentifyColor (schedule_module) ","schedule_module",4,schedule_module.mostCurrent.activityBA,schedule_module.mostCurrent,124);
...
try {
		Debug.PushSubsStack("menu_btn_Click (schedule_module) ","schedule_module",4,schedule_module.mostCurrent.activityBA,schedule_module.mostCurrent,186);
...
try {
		Debug.PushSubsStack("Month_btn_Click (schedule_module) ","schedule_module",4,schedule_module.mostCurrent.activityBA,schedule_module.mostCurrent,209);
if (RapidSub.canDelegate("month_btn_click")) { return b4a.example.schedule_module.remoteMe.runUserSub(false, "schedule_module","month_btn_click");}
 BA.debugLineNum = 209;BA.debugLine="Private Sub Month_btn_Click";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("sched_btn_Click (schedule_module) ","schedule_module",4,schedule_module.mostCurrent.activityBA,schedule_module.mostCurrent,191);
...
try {
		Debug.PushSubsStack("SetDate (schedule_module) ","schedule_module",4,schedule_module.mostCurrent.activityBA,schedule_module.mostCurrent,139);
...
try {
		Debug.PushSubsStack("Week_btn_Click (schedule_module) ","schedule_module",4,schedule_module.mostCurrent.activityBA,schedule_module.mostCurrent,204);
if (RapidSub.canDelegate("week_btn_click")) { return b4a.example.schedule_module.remoteMe.runUserSub(false, "schedule_module","week_btn_click");}
 BA.debugLineNum = 204;BA.debugLine="Private Sub Week_btn_Click";
Debug.ShouldStop(2048);
 BA.debugLineNum = 205;BA.debugLine="Activity.Finish";
Debug.ShouldStop(4096);
schedule_module.mostCurrent._activity.runVoidMethod ("Finish");
 BA.debugLineNum = 206;BA.debugLine="StartActivity(Week_MODULE)";
Debug.ShouldStop(8192);
