...
public static b4a.example.starter _starter = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"currentSong",main._currentsong,"ListView1",main.mostCurrent._listview1,"mediaPlayer",main.mostCurrent._mediaplayer,"musicPlaylist",main.mostCurrent._musicplaylist,"pauseBtn",main.mostCurrent._pausebtn,"SeekBar1",main.mostCurrent._seekbar1,"songRuntime",main.mostCurrent._songruntime,"songTimer",main._songtimer,"songTitle",main.mostCurrent._songtitle,"Starter",Debug.moduleToString(b4a.example.starter.class),"xui",main._xui};
}
}