...
RDebugUtils.currentLine=8323082;
 //BA.debugLineNum = 8323082;BA.debugLine="If ActiveNote.IsInitialized And ActiveNote.noteID";
if (_activenote.IsInitialized /*boolean*/  && _activenote.noteID /*long*/ !=0) { 
RDebugUtils.currentLine=8323083;
 //BA.debugLineNum = 8323083;BA.debugLine="n.noteID = ActiveNote.noteID";
_n.noteID /*long*/  = _activenote.noteID /*long*/ ;
 }else {
RDebugUtils.currentLine=8323087;
 //BA.debugLineNum = 8323087;BA.debugLine="n.noteID = (DateTime.Now * 1000) + Rnd(1, 1000)";
...
RDebugUtils.currentLine=8323098;
 //BA.debugLineNum = 8323098;BA.debugLine="Main.kvs.Put(\"N_\" & n.noteID, n)";
mostCurrent._main._kvs /*b4a.example.keyvaluestore*/ ._put /*String*/ (null,"N_"+BA.NumberToString(_n.noteID /*long*/ ),(Object)(_n));
