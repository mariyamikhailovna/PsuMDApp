...
public static b4a.example.editnote _editnote = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"clock",Debug.moduleToString(b4a.example.clock.class),"clockBtn",main.mostCurrent._clockbtn,"cork",Debug.moduleToString(b4a.example.cork.class),"editnote",Debug.moduleToString(b4a.example.editnote.class),"format24h",main._format24h,"kvs",main._kvs,"note",Debug.moduleToString(b4a.example.note.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"timerClock",main._timerclock,"xui",main._xui};
}
}