...
Sub showHelpPage(page As Int)
	...
	Select page
		Case 0
			...
			helpimage.Bitmap = xui.LoadBitmapResize(File.DirAssets, "icon.png", helpimage.Width, helpimage.Height, True)
		...
		Case 1
			...
			iconButton1.Bitmap = xui.LoadBitmapResize(File.DirAssets, "BtnCalendar.png", helpimage.Width, helpimage.Height, True)
			iconButton2.Bitmap = xui.LoadBitmapResize(File.DirAssets, "Calendar2.png", helpimage.Width, helpimage.Height, True)
			iconButton3.Bitmap = xui.LoadBitmapResize(File.DirAssets, "Calendar3.png", helpimage.Width, helpimage.Height, True)
		Case 2
			titleLbl.Text = "Clock"
		...
		Case 3
			...
			helpimage.Bitmap = xui.LoadBitmapResize(File.DirAssets, "bob.png", helpimage.Width, helpimage.Height, True)
			iconButton1.Bitmap = xui.LoadBitmapResize(File.DirAssets, "BtnCorkboard.png", helpimage.Width, helpimage.Height, True)
			iconButton2.Bitmap = xui.LoadBitmapResize(File.DirAssets, "Cork2.png", helpimage.Width, helpimage.Height, True)
			iconButton3.Bitmap = xui.LoadBitmapResize(File.DirAssets, "Cork3.png", helpimage.Width, helpimage.Height, True)
		Case 4
			...
			helpimage.Bitmap = xui.LoadBitmapResize(File.DirAssets, "bob.png", helpimage.Width, helpimage.Height, True)
			iconButton1.Bitmap = xui.LoadBitmapResize(File.DirAssets, "BtnBook.png", helpimage.Width, helpimage.Height, True)
			iconButton2.Bitmap = xui.LoadBitmapResize(File.DirAssets, "Books2.png", helpimage.Width, helpimage.Height, True)
			iconButton3.Bitmap = xui.LoadBitmapResize(File.DirAssets, "Books3.png", helpimage.Width, helpimage.Height, True)
		Case 5
			...
			helpimage.Bitmap = xui.LoadBitmapResize(File.DirAssets, "bob.png", helpimage.Width, helpimage.Height, True)
			iconButton1.Bitmap = xui.LoadBitmapResize(File.DirAssets, "BtnMusicPlayer Off.png", helpimage.Width, helpimage.Height, True)
			iconButton2.Bitmap = xui.LoadBitmapResize(File.DirAssets, "Mp2.png", helpimage.Width, helpimage.Height, True)
			iconButton3.Bitmap = xui.LoadBitmapResize(File.DirAssets, "Mp3.png", helpimage.Width, helpimage.Height, True)
		Case 6
			...
			helpimage.Bitmap = xui.LoadBitmapResize(File.DirAssets, "bob.png", helpimage.Width, helpimage.Height, True)
			iconButton1.Bitmap = xui.LoadBitmapResize(File.DirAssets, "BtnNotebook.png", helpimage.Width, helpimage.Height, True)
			iconButton2.Bitmap = xui.LoadBitmapResize(File.DirAssets, "Notes2.png", helpimage.Width, helpimage.Height, True)
			iconButton3.Bitmap = xui.LoadBitmapResize(File.DirAssets, "Notes3.png", helpimage.Width, helpimage.Height, True)
		Case 7
			...
			helpimage.Bitmap = xui.LoadBitmapResize(File.DirAssets, "bob.png", helpimage.Width, helpimage.Height, True)
			iconButton1.Bitmap = xui.LoadBitmapResize(File.DirAssets, "BtnComputer.gif", helpimage.Width, helpimage.Height, True)
			iconButton2.Bitmap = xui.LoadBitmapResize(File.DirAssets, "mikuComp2", helpimage.Width, helpimage.Height, True)
			iconButton3.Bitmap = xui.LoadBitmapResize(File.DirAssets, "Comp3", helpimage.Width, helpimage.Height, True)
		Case 8
			...
			helpimage.Bitmap = xui.LoadBitmapResize(File.DirAssets, "bob.png", helpimage.Width, helpimage.Height, True)
			iconButton1.Bitmap = xui.LoadBitmapResize(File.DirAssets, "ImgPlant.png", helpimage.Width, helpimage.Height, True)
			iconButton2.Bitmap = xui.LoadBitmapResize(File.DirAssets, "minion.png", helpimage.Width, helpimage.Height, True)
			iconButton3.Bitmap = xui.LoadBitmapResize(File.DirAssets, "lamptheme.png", helpimage.Width, helpimage.Height, True)
		Case 9
			titleLbl.Text = "Lamp"
			...
			helpimage.Bitmap = xui.LoadBitmapResize(File.DirAssets, "bob.png", helpimage.Width, helpimage.Height, True)
			iconButton1.Bitmap = xui.LoadBitmapResize(File.DirAssets, "BtnLamp.png", helpimage.Width, helpimage.Height, True)
			iconButton2.Bitmap = xui.LoadBitmapResize(File.DirAssets, "Lamp2.png", helpimage.Width, helpimage.Height, True)
			iconButton3.Bitmap = xui.LoadBitmapResize(File.DirAssets, "Lamp3.png", helpimage.Width, helpimage.Height, True)
		Case 10
