...
try {
		Debug.PushSubsStack("closeL_Click (clock) ","clock",2,clock.mostCurrent.activityBA,clock.mostCurrent,209);
if (RapidSub.canDelegate("closel_click")) { return b4a.example.clock.remoteMe.runUserSub(false, "clock","closel_click");}
 BA.debugLineNum = 209;BA.debugLine="Private Sub closeL_Click";
Debug.ShouldStop(65536);
 BA.debugLineNum = 210;BA.debugLine="settingsPnl.Visible = False";
...
try {
		Debug.PushSubsStack("longBtn_Click (clock) ","clock",2,clock.mostCurrent.activityBA,clock.mostCurrent,198);
if (RapidSub.canDelegate("longbtn_click")) { return b4a.example.clock.remoteMe.runUserSub(false, "clock","longbtn_click");}
 BA.debugLineNum = 198;BA.debugLine="Private Sub longBtn_Click";
Debug.ShouldStop(32);
 BA.debugLineNum = 199;BA.debugLine="secondsRemain = longDef";
Debug.ShouldStop(64);
...
Debug.ShouldStop(33554432);
 BA.debugLineNum = 187;BA.debugLine="secondsRemain = pomoDef";
Debug.ShouldStop(67108864);
clock._secondsremain = clock._pomodef;
 BA.debugLineNum = 188;BA.debugLine="timerState = 0";
Debug.ShouldStop(134217728);
clock._timerstate = BA.numberCast(int.class, 0);
 BA.debugLineNum = 189;BA.debugLine="updateLbl";
Debug.ShouldStop(268435456);
_updatelbl();
...
try {
		Debug.PushSubsStack("saveBtn_Click (clock) ","clock",2,clock.mostCurrent.activityBA,clock.mostCurrent,213);
if (RapidSub.canDelegate("savebtn_click")) { return b4a.example.clock.remoteMe.runUserSub(false, "clock","savebtn_click");}
 BA.debugLineNum = 213;BA.debugLine="Private Sub saveBtn_Click";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 215;BA.debugLine="If IsNumber(pomoTxt.Text) Then pomoDef = pomoTxt.";
Debug.ShouldStop(4194304);
...
clock._pomodef = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, clock.mostCurrent._pomotxt.runMethod(true,"getText")),RemoteObject.createImmutable(60)}, "*",0, 0));};
 BA.debugLineNum = 216;BA.debugLine="If IsNumber(shortTxt.Text) Then shortDef = shortT";
Debug.ShouldStop(8388608);
...
clock._shortdef = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, clock.mostCurrent._shorttxt.runMethod(true,"getText")),RemoteObject.createImmutable(60)}, "*",0, 0));};
 BA.debugLineNum = 217;BA.debugLine="If IsNumber(longTxt.Text) Then longDef = longTxt.";
Debug.ShouldStop(16777216);
...
clock._longdef = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, clock.mostCurrent._longtxt.runMethod(true,"getText")),RemoteObject.createImmutable(60)}, "*",0, 0));};
 BA.debugLineNum = 219;BA.debugLine="If timerState = 0 Then";
Debug.ShouldStop(67108864);
if (RemoteObject.solveBoolean("=",clock._timerstate,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 220;BA.debugLine="secondsRemain = pomoDef";
Debug.ShouldStop(134217728);
clock._secondsremain = clock._pomodef;
 }else {
 BA.debugLineNum = 223;BA.debugLine="If counter Mod 4 = 0 Then";
Debug.ShouldStop(1073741824);
if (RemoteObject.solveBoolean("=",RemoteObject.solve(new RemoteObject[] {clock._counter,RemoteObject.createImmutable(4)}, "%",0, 1),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 224;BA.debugLine="secondsRemain = longDef";
Debug.ShouldStop(-2147483648);
clock._secondsremain = clock._longdef;
 }else {
 BA.debugLineNum = 226;BA.debugLine="secondsRemain = shortDef";
Debug.ShouldStop(2);
clock._secondsremain = clock._shortdef;
 };
 };
 BA.debugLineNum = 229;BA.debugLine="updateLbl";
Debug.ShouldStop(16);
_updatelbl();
...
try {
		Debug.PushSubsStack("settingsBtn_Click (clock) ","clock",2,clock.mostCurrent.activityBA,clock.mostCurrent,204);
if (RapidSub.canDelegate("settingsbtn_click")) { return b4a.example.clock.remoteMe.runUserSub(false, "clock","settingsbtn_click");}
 BA.debugLineNum = 204;BA.debugLine="Private Sub settingsBtn_Click";
Debug.ShouldStop(2048);
 BA.debugLineNum = 205;BA.debugLine="settingsWindow(250dip, 180dip)";
Debug.ShouldStop(4096);
_settingswindow(clock.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 250))),clock.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 180))));
 BA.debugLineNum = 206;BA.debugLine="settingsPnl.Visible = True";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("shortBtn_Click (clock) ","clock",2,clock.mostCurrent.activityBA,clock.mostCurrent,192);
if (RapidSub.canDelegate("shortbtn_click")) { return b4a.example.clock.remoteMe.runUserSub(false, "clock","shortbtn_click");}
 BA.debugLineNum = 192;BA.debugLine="Private Sub shortBtn_Click";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 193;BA.debugLine="secondsRemain = shortDef";
Debug.ShouldStop(1);
clock._secondsremain = clock._shortdef;
 BA.debugLineNum = 194;BA.debugLine="timerState = 1";
Debug.ShouldStop(2);
clock._timerstate = BA.numberCast(int.class, 1);
...
try {
		Debug.PushSubsStack("skipBtn_Click (clock) ","clock",2,clock.mostCurrent.activityBA,clock.mostCurrent,233);
if (RapidSub.canDelegate("skipbtn_click")) { return b4a.example.clock.remoteMe.runUserSub(false, "clock","skipbtn_click");}
 BA.debugLineNum = 233;BA.debugLine="Private Sub skipBtn_Click";
Debug.ShouldStop(256);
 BA.debugLineNum = 234;BA.debugLine="If timerState = 0 Then";
Debug.ShouldStop(512);
if (RemoteObject.solveBoolean("=",clock._timerstate,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 235;BA.debugLine="counter = counter + 1";
Debug.ShouldStop(1024);
clock._counter = RemoteObject.solve(new RemoteObject[] {clock._counter,RemoteObject.createImmutable(1)}, "+",1, 1);
 BA.debugLineNum = 237;BA.debugLine="If counter Mod 4 = 0 Then";
Debug.ShouldStop(4096);
if (RemoteObject.solveBoolean("=",RemoteObject.solve(new RemoteObject[] {clock._counter,RemoteObject.createImmutable(4)}, "%",0, 1),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 238;BA.debugLine="secondsRemain = longDef";
Debug.ShouldStop(8192);
clock._secondsremain = clock._longdef;
 }else {
 BA.debugLineNum = 240;BA.debugLine="secondsRemain = shortDef";
Debug.ShouldStop(32768);
clock._secondsremain = clock._shortdef;
 };
 BA.debugLineNum = 242;BA.debugLine="timerState = 1";
Debug.ShouldStop(131072);
clock._timerstate = BA.numberCast(int.class, 1);
 }else 
{ BA.debugLineNum = 244;BA.debugLine="Else If timerState = 1 Then";
Debug.ShouldStop(524288);
if (RemoteObject.solveBoolean("=",clock._timerstate,BA.numberCast(double.class, 1))) { 
 BA.debugLineNum = 245;BA.debugLine="secondsRemain = pomoDef";
Debug.ShouldStop(1048576);
clock._secondsremain = clock._pomodef;
 BA.debugLineNum = 246;BA.debugLine="timerState = 0";
Debug.ShouldStop(2097152);
clock._timerstate = BA.numberCast(int.class, 0);
 }}
;
...
Debug.ShouldStop(16777216);
_updatelbl();
 BA.debugLineNum = 250;BA.debugLine="timerCount.Enabled = False";
Debug.ShouldStop(33554432);
clock._timercount.runMethod(true,"setEnabled",clock.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 251;BA.debugLine="playing = False";
Debug.ShouldStop(67108864);
clock._playing = clock.mostCurrent.__c.getField(true,"False");
 BA.debugLineNum = 252;BA.debugLine="playBtn.Text = \"Start\"";
Debug.ShouldStop(134217728);
clock.mostCurrent._playbtn.runMethod(true,"setText",BA.ObjectToCharSequence("Start"));
