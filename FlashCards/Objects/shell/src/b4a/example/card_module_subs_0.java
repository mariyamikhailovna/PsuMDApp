...
try {
		Debug.PushSubsStack("Activity_Create (card_module) ","card_module",3,card_module.mostCurrent.activityBA,card_module.mostCurrent,24);
...
Debug.ShouldStop(8388608);
 BA.debugLineNum = 27;BA.debugLine="Activity.LoadLayout(\"Layout4\")";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("canceldelete_Click (card_module) ","card_module",3,card_module.mostCurrent.activityBA,card_module.mostCurrent,149);
if (RapidSub.canDelegate("canceldelete_click")) { return b4a.example.card_module.remoteMe.runUserSub(false, "card_module","canceldelete_click");}
 BA.debugLineNum = 149;BA.debugLine="Private Sub canceldelete_Click";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 150;BA.debugLine="deleteconfirmation.Visible = False";
Debug.ShouldStop(2097152);
...
try {
		Debug.PushSubsStack("confirmdelete_Click (card_module) ","card_module",3,card_module.mostCurrent.activityBA,card_module.mostCurrent,140);
...
RemoteObject _cards = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
 BA.debugLineNum = 140;BA.debugLine="Private Sub confirmdelete_Click";
Debug.ShouldStop(2048);
 BA.debugLineNum = 141;BA.debugLine="Dim tappedDeck As Map = Main.deck.Get(Main.select";
Debug.ShouldStop(4096);
_tappeddeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), card_module.mostCurrent._main._deck /*RemoteObject*/ .runMethod(false,"Get",(Object)((card_module.mostCurrent._main._selecteddeck /*RemoteObject*/ ))));Debug.locals.put("tappedDeck", _tappeddeck);Debug.locals.put("tappedDeck", _tappeddeck);
 BA.debugLineNum = 142;BA.debugLine="Dim cards As List = tappedDeck.Get(Subdeck_Module";
Debug.ShouldStop(8192);
...
_cards = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _tappeddeck.runMethod(false,"Get",(Object)((card_module.mostCurrent._subdeck_module._selectedsubdeck /*RemoteObject*/ ))));Debug.locals.put("cards", _cards);Debug.locals.put("cards", _cards);
 BA.debugLineNum = 144;BA.debugLine="cards.RemoveAt(numtag)";
Debug.ShouldStop(32768);
_cards.runVoidMethod ("RemoveAt",(Object)(card_module._numtag));
 BA.debugLineNum = 145;BA.debugLine="ShowSubdeckCards(cards)";
Debug.ShouldStop(65536);
_showsubdeckcards(_cards);
 BA.debugLineNum = 146;BA.debugLine="deleteconfirmation.Visible = False";
...
try {
		Debug.PushSubsStack("deletebtn_click (card_module) ","card_module",3,card_module.mostCurrent.activityBA,card_module.mostCurrent,94);
...
try {
		Debug.PushSubsStack("editbtn_Click (card_module) ","card_module",3,card_module.mostCurrent.activityBA,card_module.mostCurrent,82);
...
try {
		Debug.PushSubsStack("ShowSubdeckCards (card_module) ","card_module",3,card_module.mostCurrent.activityBA,card_module.mostCurrent,39);
...
_p.runVoidMethod ("setColor",card_module.mostCurrent.__c.getField(false,"Colors").getField(true,"White"));
 BA.debugLineNum = 51;BA.debugLine="ScrollView1.Panel.AddView(p, 10dip, topPos, Scrol";
Debug.ShouldStop(262144);
