...
try {
		Debug.PushSubsStack("Activity_Create (active_recall) ","active_recall",8,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,25);
...
active_recall.mostCurrent._deckname_label.runMethod(true,"setText",BA.ObjectToCharSequence(active_recall.mostCurrent._subdeck_module._selectedsubdeck /*RemoteObject*/ ));
 BA.debugLineNum = 38;BA.debugLine="ShuffleCards(cards)";
Debug.ShouldStop(32);
_shufflecards(active_recall.mostCurrent._cards);
 BA.debugLineNum = 40;BA.debugLine="ShowCard";
...
try {
		Debug.PushSubsStack("Activity_Pause (active_recall) ","active_recall",8,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,69);
...
try {
		Debug.PushSubsStack("Activity_Resume (active_recall) ","active_recall",8,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,65);
...
try {
		Debug.PushSubsStack("backbtn_Click (active_recall) ","active_recall",8,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,111);
if (RapidSub.canDelegate("backbtn_click")) { return b4a.example.active_recall.remoteMe.runUserSub(false, "active_recall","backbtn_click");}
 BA.debugLineNum = 111;BA.debugLine="Private Sub backbtn_Click";
Debug.ShouldStop(16384);
 BA.debugLineNum = 113;BA.debugLine="showAnswerbtn.Text = \"Show Answer\"";
...
active_recall._currentindex = RemoteObject.solve(new RemoteObject[] {active_recall._currentindex,RemoteObject.createImmutable(1)}, "-",1, 1);
 BA.debugLineNum = 115;BA.debugLine="If currentindex < 0 Then";
Debug.ShouldStop(262144);
if (RemoteObject.solveBoolean("<",active_recall._currentindex,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 116;BA.debugLine="currentindex = cards.Size -1";
...
try {
		Debug.PushSubsStack("goback_Click (active_recall) ","active_recall",8,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,106);
if (RapidSub.canDelegate("goback_click")) { return b4a.example.active_recall.remoteMe.runUserSub(false, "active_recall","goback_click");}
 BA.debugLineNum = 106;BA.debugLine="Private Sub goback_Click";
Debug.ShouldStop(512);
...
try {
		Debug.PushSubsStack("nextbtn_Click (active_recall) ","active_recall",8,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,93);
if (RapidSub.canDelegate("nextbtn_click")) { return b4a.example.active_recall.remoteMe.runUserSub(false, "active_recall","nextbtn_click");}
 BA.debugLineNum = 93;BA.debugLine="Private Sub nextbtn_Click";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 95;BA.debugLine="showAnswerbtn.Text = \"Show Answer\"";
Debug.ShouldStop(1073741824);
active_recall.mostCurrent._showanswerbtn.runMethod(true,"setText",BA.ObjectToCharSequence("Show Answer"));
 BA.debugLineNum = 96;BA.debugLine="currentindex = currentindex +1";
Debug.ShouldStop(-2147483648);
active_recall._currentindex = RemoteObject.solve(new RemoteObject[] {active_recall._currentindex,RemoteObject.createImmutable(1)}, "+",1, 1);
 BA.debugLineNum = 98;BA.debugLine="If currentindex >= cards.Size Then";
Debug.ShouldStop(2);
if (RemoteObject.solveBoolean("g",active_recall._currentindex,BA.numberCast(double.class, active_recall.mostCurrent._cards.runMethod(true,"getSize")))) { 
 BA.debugLineNum = 99;BA.debugLine="ShuffleCards(cards)";
Debug.ShouldStop(4);
_shufflecards(active_recall.mostCurrent._cards);
 BA.debugLineNum = 100;BA.debugLine="MsgboxAsync(\"You've finished your subdeck\", \"Con";
Debug.ShouldStop(8);
active_recall.mostCurrent.__c.runVoidMethod ("MsgboxAsync",(Object)(BA.ObjectToCharSequence("You've finished your subdeck")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Congratulations"))),active_recall.processBA);
 BA.debugLineNum = 101;BA.debugLine="currentindex = 0";
Debug.ShouldStop(16);
active_recall._currentindex = BA.numberCast(int.class, 0);
 };
 BA.debugLineNum = 103;BA.debugLine="ShowCard";
Debug.ShouldStop(64);
_showcard();
...
try {
		Debug.PushSubsStack("showAnswerbtn_Click (active_recall) ","active_recall",8,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,74);
...
RemoteObject _card = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 74;BA.debugLine="Private Sub showAnswerbtn_Click";
Debug.ShouldStop(512);
...
_card = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), active_recall.mostCurrent._cards.runMethod(false,"Get",(Object)(active_recall._currentindex)));Debug.locals.put("card", _card);Debug.locals.put("card", _card);
 BA.debugLineNum = 79;BA.debugLine="If showAnswerbtn.Text = \"Show Answer\" Then";
Debug.ShouldStop(16384);
if (RemoteObject.solveBoolean("=",active_recall.mostCurrent._showanswerbtn.runMethod(true,"getText"),BA.ObjectToString("Show Answer"))) { 
 BA.debugLineNum = 81;BA.debugLine="Answer.Text = card.Get(\"A\")";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("ShowCard (active_recall) ","active_recall",8,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,55);
if (RapidSub.canDelegate("showcard")) { return b4a.example.active_recall.remoteMe.runUserSub(false, "active_recall","showcard");}
RemoteObject _card = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 55;BA.debugLine="Sub ShowCard";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 58;BA.debugLine="Dim card As Map = cards.Get(currentindex)";
Debug.ShouldStop(33554432);
_card = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_card = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), active_recall.mostCurrent._cards.runMethod(false,"Get",(Object)(active_recall._currentindex)));Debug.locals.put("card", _card);Debug.locals.put("card", _card);
 BA.debugLineNum = 60;BA.debugLine="Question.Text = card.Get(\"Q\")";
Debug.ShouldStop(134217728);
active_recall.mostCurrent._question.runMethod(true,"setText",BA.ObjectToCharSequence(_card.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Q"))))));
 BA.debugLineNum = 61;BA.debugLine="Answer.Text = \"\"";
Debug.ShouldStop(268435456);
active_recall.mostCurrent._answer.runMethod(true,"setText",BA.ObjectToCharSequence(""));
...
try {
		Debug.PushSubsStack("ShuffleCards (active_recall) ","active_recall",8,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,44);
...
Debug.locals.put("cardList", _cardlist);
 BA.debugLineNum = 44;BA.debugLine="Sub ShuffleCards(cardList As List)";
Debug.ShouldStop(2048);
 BA.debugLineNum = 46;BA.debugLine="For i = cardList.Size-1 To 1 Step -1";
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 47;BA.debugLine="Dim j As Int = Rnd(0, i+1)";
Debug.ShouldStop(16384);
_j = active_recall.mostCurrent.__c.runMethod(true,"Rnd",(Object)(BA.numberCast(int.class, 0)),(Object)(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_i),RemoteObject.createImmutable(1)}, "+",1, 1)));Debug.locals.put("j", _j);Debug.locals.put("j", _j);
 BA.debugLineNum = 49;BA.debugLine="Dim temp As Object = cardList.Get(i)";
Debug.ShouldStop(65536);
_temp = _cardlist.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i)));Debug.locals.put("temp", _temp);Debug.locals.put("temp", _temp);
 BA.debugLineNum = 50;BA.debugLine="cardList.Set(i, cardList.Get(j))";
Debug.ShouldStop(131072);
_cardlist.runVoidMethod ("Set",(Object)(BA.numberCast(int.class, _i)),(Object)(_cardlist.runMethod(false,"Get",(Object)(_j))));
 BA.debugLineNum = 51;BA.debugLine="cardList.Set(j, temp)";
Debug.ShouldStop(262144);
