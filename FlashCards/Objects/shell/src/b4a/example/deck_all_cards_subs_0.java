...
try {
		Debug.PushSubsStack("Activity_Create (deck_all_cards) ","deck_all_cards",6,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,20);
...
Debug.ShouldStop(524288);
 BA.debugLineNum = 23;BA.debugLine="Activity.LoadLayout(\"Layout7\")";
Debug.ShouldStop(4194304);
deck_all_cards.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Layout7")),deck_all_cards.mostCurrent.activityBA);
 BA.debugLineNum = 24;BA.debugLine="deckname.Text = Main.item_longclick";
Debug.ShouldStop(8388608);
deck_all_cards.mostCurrent._deckname.runMethod(true,"setText",BA.ObjectToCharSequence(deck_all_cards.mostCurrent._main._item_longclick /*RemoteObject*/ ));
 BA.debugLineNum = 25;BA.debugLine="cards.Initialize";
Debug.ShouldStop(16777216);
deck_all_cards.mostCurrent._cards.runVoidMethod ("Initialize");
 BA.debugLineNum = 27;BA.debugLine="Dim chosendeck As Map = Main.deck.Get(Main.select";
Debug.ShouldStop(67108864);
_chosendeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_chosendeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), deck_all_cards.mostCurrent._main._deck /*RemoteObject*/ .runMethod(false,"Get",(Object)((deck_all_cards.mostCurrent._main._selecteddeck /*RemoteObject*/ ))));Debug.locals.put("chosendeck", _chosendeck);Debug.locals.put("chosendeck", _chosendeck);
...
try {
		Debug.PushSubsStack("Activity_Pause (deck_all_cards) ","deck_all_cards",6,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,86);
...
try {
		Debug.PushSubsStack("Activity_Resume (deck_all_cards) ","deck_all_cards",6,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,82);
...
try {
		Debug.PushSubsStack("addbtn_Click (deck_all_cards) ","deck_all_cards",6,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,91);
...
try {
		Debug.PushSubsStack("backbtn_Click (deck_all_cards) ","deck_all_cards",6,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,95);
...
try {
		Debug.PushSubsStack("ShowALLCards (deck_all_cards) ","deck_all_cards",6,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,44);
