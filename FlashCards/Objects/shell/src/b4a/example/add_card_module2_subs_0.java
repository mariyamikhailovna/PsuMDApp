...
try {
		Debug.PushSubsStack("Activity_Create (add_card_module2) ","add_card_module2",7,add_card_module2.mostCurrent.activityBA,add_card_module2.mostCurrent,22);
...
Debug.ShouldStop(2097152);
 BA.debugLineNum = 25;BA.debugLine="Activity.LoadLayout(\"Layout6\")";
Debug.ShouldStop(16777216);
add_card_module2.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Layout6")),add_card_module2.mostCurrent.activityBA);
 BA.debugLineNum = 28;BA.debugLine="Dim tappeddeck As Map = Main.deck.Get(Main.select";
Debug.ShouldStop(134217728);
_tappeddeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), add_card_module2.mostCurrent._main._deck /*RemoteObject*/ .runMethod(false,"Get",(Object)((add_card_module2.mostCurrent._main._selecteddeck /*RemoteObject*/ ))));Debug.locals.put("tappeddeck", _tappeddeck);Debug.locals.put("tappeddeck", _tappeddeck);
 BA.debugLineNum = 30;BA.debugLine="subdeckname.text = Card_Module.subdeck";
...
add_card_module2.mostCurrent._subdeckname.runMethod(true,"setText",BA.ObjectToCharSequence(add_card_module2.mostCurrent._card_module._subdeck /*RemoteObject*/ ));
 BA.debugLineNum = 32;BA.debugLine="If Card_Module.isedit = True Then";
...
if (RemoteObject.solveBoolean("=",add_card_module2.mostCurrent._card_module._isedit /*RemoteObject*/ ,add_card_module2.mostCurrent.__c.getField(true,"True"))) { 
 BA.debugLineNum = 33;BA.debugLine="Dim flashcard As List = tappeddeck.Get(Card_Modu";
Debug.ShouldStop(1);
...
_flashcard = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _tappeddeck.runMethod(false,"Get",(Object)((add_card_module2.mostCurrent._card_module._subdeck /*RemoteObject*/ ))));Debug.locals.put("flashcard", _flashcard);Debug.locals.put("flashcard", _flashcard);
 BA.debugLineNum = 34;BA.debugLine="Dim card As Map = flashcard.Get(Card_Module.edit";
Debug.ShouldStop(2);
...
_card = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _flashcard.runMethod(false,"Get",(Object)(add_card_module2.mostCurrent._card_module._editindex /*RemoteObject*/ )));Debug.locals.put("card", _card);Debug.locals.put("card", _card);
 BA.debugLineNum = 35;BA.debugLine="QuestionET.Text = card.Get(\"Q\")";
Debug.ShouldStop(4);
add_card_module2.mostCurrent._questionet.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(_card.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Q"))))));
 BA.debugLineNum = 36;BA.debugLine="AnswerET.Text = card.Get(\"A\")";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("Activity_Pause (add_card_module2) ","add_card_module2",7,add_card_module2.mostCurrent.activityBA,add_card_module2.mostCurrent,49);
...
try {
		Debug.PushSubsStack("Activity_Resume (add_card_module2) ","add_card_module2",7,add_card_module2.mostCurrent.activityBA,add_card_module2.mostCurrent,45);
...
try {
		Debug.PushSubsStack("backbtn_Click (add_card_module2) ","add_card_module2",7,add_card_module2.mostCurrent.activityBA,add_card_module2.mostCurrent,56);
if (RapidSub.canDelegate("backbtn_click")) { return b4a.example.add_card_module2.remoteMe.runUserSub(false, "add_card_module2","backbtn_click");}
 BA.debugLineNum = 56;BA.debugLine="Private Sub backbtn_Click";
...
try {
		Debug.PushSubsStack("SaveCard_Click (add_card_module2) ","add_card_module2",7,add_card_module2.mostCurrent.activityBA,add_card_module2.mostCurrent,61);
...
RemoteObject _cards = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 61;BA.debugLine="Private Sub SaveCard_Click";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 63;BA.debugLine="Dim tappeddeck As Map = Main.deck.Get(Main.select";
Debug.ShouldStop(1073741824);
_tappeddeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), add_card_module2.mostCurrent._main._deck /*RemoteObject*/ .runMethod(false,"Get",(Object)((add_card_module2.mostCurrent._main._selecteddeck /*RemoteObject*/ ))));Debug.locals.put("tappeddeck", _tappeddeck);Debug.locals.put("tappeddeck", _tappeddeck);
 BA.debugLineNum = 65;BA.debugLine="If Card_Module.isEdit = True Then";
Debug.ShouldStop(1);
if (RemoteObject.solveBoolean("=",add_card_module2.mostCurrent._card_module._isedit /*RemoteObject*/ ,add_card_module2.mostCurrent.__c.getField(true,"True"))) { 
 BA.debugLineNum = 66;BA.debugLine="Card_Module.isEdit = False";
Debug.ShouldStop(2);
add_card_module2.mostCurrent._card_module._isedit /*RemoteObject*/  = add_card_module2.mostCurrent.__c.getField(true,"False");
 BA.debugLineNum = 69;BA.debugLine="If QuestionET.Text = \"\" Then";
Debug.ShouldStop(16);
if (RemoteObject.solveBoolean("=",add_card_module2.mostCurrent._questionet.runMethod(true,"getText"),BA.ObjectToString(""))) { 
 BA.debugLineNum = 70;BA.debugLine="MsgboxAsync(\"Enter the Question!\", \"Error\")";
Debug.ShouldStop(32);
...
{ BA.debugLineNum = 71;BA.debugLine="Else if AnswerET.Text = \"\" Then";
Debug.ShouldStop(64);
if (RemoteObject.solveBoolean("=",add_card_module2.mostCurrent._answeret.runMethod(true,"getText"),BA.ObjectToString(""))) { 
 BA.debugLineNum = 72;BA.debugLine="MsgboxAsync(\"Enter the Answer!\", \"Error\")";
...
add_card_module2.mostCurrent.__c.runVoidMethod ("MsgboxAsync",(Object)(BA.ObjectToCharSequence("Enter the Answer!")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Error"))),add_card_module2.processBA);
 ...
 BA.debugLineNum = 75;BA.debugLine="Dim Editcards As List = tappeddeck.Get(Card_Mod";
...
_editcards = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _tappeddeck.runMethod(false,"Get",(Object)((add_card_module2.mostCurrent._card_module._subdeck /*RemoteObject*/ ))));Debug.locals.put("Editcards", _editcards);Debug.locals.put("Editcards", _editcards);
 BA.debugLineNum = 76;BA.debugLine="Dim card As Map = Editcards.Get(Card_Module.edi";
Debug.ShouldStop(2048);
_card = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_card = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _editcards.runMethod(false,"Get",(Object)(add_card_module2.mostCurrent._card_module._editindex /*RemoteObject*/ )));Debug.locals.put("card", _card);Debug.locals.put("card", _card);
 BA.debugLineNum = 77;BA.debugLine="card.Put(\"Q\", QuestionET.text)";
Debug.ShouldStop(4096);
_card.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("Q"))),(Object)((add_card_module2.mostCurrent._questionet.runMethod(true,"getText"))));
 BA.debugLineNum = 78;BA.debugLine="card.Put(\"A\", AnswerET.text)";
...
;
 BA.debugLineNum = 80;BA.debugLine="SaveDecks";
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 89;BA.debugLine="If QuestionET.Text = \"\" Then";
Debug.ShouldStop(16777216);
if (RemoteObject.solveBoolean("=",add_card_module2.mostCurrent._questionet.runMethod(true,"getText"),BA.ObjectToString(""))) { 
 BA.debugLineNum = 90;BA.debugLine="MsgboxAsync(\"Enter the Question!\", \"Error\")";
Debug.ShouldStop(33554432);
add_card_module2.mostCurrent.__c.runVoidMethod ("MsgboxAsync",(Object)(BA.ObjectToCharSequence("Enter the Question!")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Error"))),add_card_module2.processBA);
 }else 
{ BA.debugLineNum = 91;BA.debugLine="Else if AnswerET.Text = \"\" Then";
Debug.ShouldStop(67108864);
if (RemoteObject.solveBoolean("=",add_card_module2.mostCurrent._answeret.runMethod(true,"getText"),BA.ObjectToString(""))) { 
 BA.debugLineNum = 92;BA.debugLine="MsgboxAsync(\"Enter the Answer!\", \"Error\")";
Debug.ShouldStop(134217728);
add_card_module2.mostCurrent.__c.runVoidMethod ("MsgboxAsync",(Object)(BA.ObjectToCharSequence("Enter the Answer!")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Error"))),add_card_module2.processBA);
 }else {
 BA.debugLineNum = 97;BA.debugLine="Dim flashcards As List = tappeddeck.Get(Card_Mod";
Debug.ShouldStop(1);
...
_flashcards = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _tappeddeck.runMethod(false,"Get",(Object)((add_card_module2.mostCurrent._card_module._subdeck /*RemoteObject*/ ))));Debug.locals.put("flashcards", _flashcards);Debug.locals.put("flashcards", _flashcards);
 BA.debugLineNum = 100;BA.debugLine="Dim cards As Map";
Debug.ShouldStop(8);
_cards = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("cards", _cards);
 BA.debugLineNum = 101;BA.debugLine="cards.initialize";
Debug.ShouldStop(16);
_cards.runVoidMethod ("Initialize");
 BA.debugLineNum = 102;BA.debugLine="cards.Put(\"Q\", QuestionET.Text)";
Debug.ShouldStop(32);
_cards.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("Q"))),(Object)((add_card_module2.mostCurrent._questionet.runMethod(true,"getText"))));
 BA.debugLineNum = 103;BA.debugLine="cards.Put(\"A\", AnswerET.Text)";
Debug.ShouldStop(64);
_cards.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("A"))),(Object)((add_card_module2.mostCurrent._answeret.runMethod(true,"getText"))));
 BA.debugLineNum = 106;BA.debugLine="flashcards.Add(cards)";
Debug.ShouldStop(512);
_flashcards.runVoidMethod ("Add",(Object)((_cards.getObject())));
 BA.debugLineNum = 107;BA.debugLine="QuestionET.Text = \"\"";
Debug.ShouldStop(1024);
add_card_module2.mostCurrent._questionet.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 108;BA.debugLine="AnswerET.Text = \"\"";
Debug.ShouldStop(2048);
add_card_module2.mostCurrent._answeret.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 110;BA.debugLine="SaveDecks";
Debug.ShouldStop(8192);
_savedecks();
 BA.debugLineNum = 112;BA.debugLine="MsgboxAsync(\"Card is Successfully Saved\", \"Card";
Debug.ShouldStop(32768);
...
try {
		Debug.PushSubsStack("SaveDecks (add_card_module2) ","add_card_module2",7,add_card_module2.mostCurrent.activityBA,add_card_module2.mostCurrent,41);
if (RapidSub.canDelegate("savedecks")) { return b4a.example.add_card_module2.remoteMe.runUserSub(false, "add_card_module2","savedecks");}
 BA.debugLineNum = 41;BA.debugLine="Sub SaveDecks";
Debug.ShouldStop(256);
 BA.debugLineNum = 42;BA.debugLine="Main.kvs.Put(\"deck_data\", Main.deck)";
Debug.ShouldStop(512);
add_card_module2.mostCurrent._main._kvs /*RemoteObject*/ .runClassMethod (b4a.example.keyvaluestore.class, "_put" /*RemoteObject*/ ,(Object)(BA.ObjectToString("deck_data")),(Object)((add_card_module2.mostCurrent._main._deck /*RemoteObject*/ .getObject())));
