...
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Layout")),main.mostCurrent.activityBA);
 BA.debugLineNum = 52;BA.debugLine="Dim radius As Int = Addbtn.Width/2";
...
_cd = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.ColorDrawable");Debug.locals.put("cd", _cd);
 BA.debugLineNum = 54;BA.debugLine="cd.Initialize(Colors.Gray, radius)";
Debug.ShouldStop(2097152);
_cd.runVoidMethod ("Initialize",(Object)(main.mostCurrent.__c.getField(false,"Colors").getField(true,"Gray")),(Object)(_radius));
 BA.debugLineNum = 55;BA.debugLine="Addbtn.Background = cd";
...
main._deck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), main._kvs.runClassMethod (b4a.example.keyvaluestore.class, "_get" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("deck_data"))));
 BA.debugLineNum = 89;BA.debugLine="refreshbtn_Click";
...
try {
		Debug.PushSubsStack("Addbtn_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,106);
if (RapidSub.canDelegate("addbtn_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","addbtn_click");}
 BA.debugLineNum = 106;BA.debugLine="Private Sub Addbtn_Click";
Debug.ShouldStop(512);
 BA.debugLineNum = 108;BA.debugLine="If addpanel.Visible = True Then";
...
if (RemoteObject.solveBoolean("=",main.mostCurrent._addpanel.runMethod(true,"getVisible"),main.mostCurrent.__c.getField(true,"True"))) { 
 BA.debugLineNum = 109;BA.debugLine="addpanel.Visible = False";
Debug.ShouldStop(4096);
main.mostCurrent._addpanel.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 };
 BA.debugLineNum = 111;BA.debugLine="addpanel.Visible = True";
...
try {
		Debug.PushSubsStack("addcards_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,177);
...
RemoteObject _tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 177;BA.debugLine="Private Sub addcards_Click";
Debug.ShouldStop(65536);
 BA.debugLineNum = 178;BA.debugLine="Dim tappeddeck As Map = deck.Get(item_longclick)";
Debug.ShouldStop(131072);
...
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), main._deck.runMethod(false,"Get",(Object)((main._item_longclick))));Debug.locals.put("tappeddeck", _tappeddeck);Debug.locals.put("tappeddeck", _tappeddeck);
 BA.debugLineNum = 179;BA.debugLine="If tappeddeck.Size = 0 Then";
Debug.ShouldStop(262144);
if (RemoteObject.solveBoolean("=",_tappeddeck.runMethod(true,"getSize"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 180;BA.debugLine="MsgboxAsync(\"Create A Sub-Deck first\", \"Error\")";
Debug.ShouldStop(524288);
...
main.mostCurrent._decksettingpanel.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 184;BA.debugLine="StartActivity(Add_Card_Module)";
...
try {
		Debug.PushSubsStack("browse_cards_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,203);
if (RapidSub.canDelegate("browse_cards_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","browse_cards_click");}
 BA.debugLineNum = 203;BA.debugLine="Private Sub browse_cards_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 204;BA.debugLine="decksettingpanel.Visible = False";
Debug.ShouldStop(2048);
main.mostCurrent._decksettingpanel.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 205;BA.debugLine="StartActivity(DECK_ALL_CARDS)";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("cancel_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,114);
if (RapidSub.canDelegate("cancel_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","cancel_click");}
 BA.debugLineNum = 114;BA.debugLine="Private Sub cancel_Click";
Debug.ShouldStop(131072);
 BA.debugLineNum = 116;BA.debugLine="addpanel.Visible = False";
Debug.ShouldStop(524288);
main.mostCurrent._addpanel.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 118;BA.debugLine="et1.Text = \"\"";
Debug.ShouldStop(2097152);
...
try {
		Debug.PushSubsStack("cancelbtn_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,208);
if (RapidSub.canDelegate("cancelbtn_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","cancelbtn_click");}
 BA.debugLineNum = 208;BA.debugLine="Private Sub cancelbtn_Click";
Debug.ShouldStop(32768);
 BA.debugLineNum = 209;BA.debugLine="decksettingpanel.Visible = False";
Debug.ShouldStop(65536);
main.mostCurrent._decksettingpanel.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("cancelnew_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,233);
if (RapidSub.canDelegate("cancelnew_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","cancelnew_click");}
 BA.debugLineNum = 233;BA.debugLine="Private Sub cancelnew_Click";
Debug.ShouldStop(256);
 BA.debugLineNum = 234;BA.debugLine="newdeckname.text = False";
Debug.ShouldStop(512);
...
try {
		Debug.PushSubsStack("cancelnewsubdeck_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,259);
if (RapidSub.canDelegate("cancelnewsubdeck_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","cancelnewsubdeck_click");}
 BA.debugLineNum = 259;BA.debugLine="Private Sub cancelnewsubdeck_Click";
Debug.ShouldStop(4);
 BA.debugLineNum = 260;BA.debugLine="newsubdecket.Text = \"\"";
Debug.ShouldStop(8);
main.mostCurrent._newsubdecket.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 261;BA.debugLine="newsubdeckpanel.Visible = False";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("confirmnew_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,212);
...
RemoteObject _names = RemoteObject.createImmutable("");
 BA.debugLineNum = 212;BA.debugLine="Private Sub confirmnew_Click";
Debug.ShouldStop(524288);
 BA.debugLineNum = 213;BA.debugLine="Dim getsubdeck As Map";
Debug.ShouldStop(1048576);
_getsubdeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("getsubdeck", _getsubdeck);
 BA.debugLineNum = 214;BA.debugLine="If newdeckname.Text = \"\" Then";
Debug.ShouldStop(2097152);
if (RemoteObject.solveBoolean("=",main.mostCurrent._newdeckname.runMethod(true,"getText"),BA.ObjectToString(""))) { 
 BA.debugLineNum = 215;BA.debugLine="MsgboxAsync(\"New Name must have a name\", \"Error\"";
Debug.ShouldStop(4194304);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 218;BA.debugLine="For Each names As String In deck.keys";
Debug.ShouldStop(33554432);
{
...
Debug.locals.put("names", _names);
 BA.debugLineNum = 219;BA.debugLine="getsubdeck = deck.Get(item_longclick)";
...
_getsubdeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), main._deck.runMethod(false,"Get",(Object)((main._item_longclick))));Debug.locals.put("getsubdeck", _getsubdeck);
 BA.debugLineNum = 220;BA.debugLine="If newdeckname.Text = names Then";
Debug.ShouldStop(134217728);
if (RemoteObject.solveBoolean("=",main.mostCurrent._newdeckname.runMethod(true,"getText"),_names)) { 
 BA.debugLineNum = 221;BA.debugLine="MsgboxAsync(\"Deck Name Already Exist\", \"Error\")";
...
;
 BA.debugLineNum = 225;BA.debugLine="deck.Remove(item_longclick)";
Debug.ShouldStop(1);
main._deck.runVoidMethod ("Remove",(Object)((main._item_longclick)));
 BA.debugLineNum = 226;BA.debugLine="deck.Put(newdeckname.Text, getsubdeck)";
Debug.ShouldStop(2);
main._deck.runVoidMethod ("Put",(Object)((main.mostCurrent._newdeckname.runMethod(true,"getText"))),(Object)((_getsubdeck.getObject())));
 BA.debugLineNum = 227;BA.debugLine="newdeckname.text = \"\"";
Debug.ShouldStop(4);
main.mostCurrent._newdeckname.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 228;BA.debugLine="SaveDecks";
Debug.ShouldStop(8);
_savedecks();
 BA.debugLineNum = 229;BA.debugLine="refreshbtn_Click";
Debug.ShouldStop(16);
_refreshbtn_click();
 BA.debugLineNum = 230;BA.debugLine="renamepanel.Visible = False";
Debug.ShouldStop(32);
main.mostCurrent._renamepanel.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("create_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,122);
...
RemoteObject _names = RemoteObject.createImmutable("");
 BA.debugLineNum = 122;BA.debugLine="Private Sub create_Click";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 125;BA.debugLine="Dim newsubdeck As Map";
Debug.ShouldStop(268435456);
_newsubdeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("newsubdeck", _newsubdeck);
 BA.debugLineNum = 127;BA.debugLine="newsubdeck.initialize";
Debug.ShouldStop(1073741824);
_newsubdeck.runVoidMethod ("Initialize");
 BA.debugLineNum = 130;BA.debugLine="For Each names As String In deck.Keys";
Debug.ShouldStop(2);
{
...
Debug.locals.put("names", _names);
 BA.debugLineNum = 131;BA.debugLine="If et1.Text = names Then";
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("=",main.mostCurrent._et1.runMethod(true,"getText"),_names)) { 
 BA.debugLineNum = 132;BA.debugLine="MsgboxAsync(\"Deck Already Exist\", \"Error\")";
Debug.ShouldStop(8);
...
;
 BA.debugLineNum = 138;BA.debugLine="If et1.Text = \"\" Then";
Debug.ShouldStop(512);
if (RemoteObject.solveBoolean("=",main.mostCurrent._et1.runMethod(true,"getText"),BA.ObjectToString(""))) { 
 BA.debugLineNum = 139;BA.debugLine="MsgboxAsync(\"Deck must have a name\", \"Error\")";
Debug.ShouldStop(1024);
main.mostCurrent.__c.runVoidMethod ("MsgboxAsync",(Object)(BA.ObjectToCharSequence("Deck must have a name")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Error"))),main.processBA);
 ...
 BA.debugLineNum = 142;BA.debugLine="addpanel.Visible = False";
Debug.ShouldStop(8192);
main.mostCurrent._addpanel.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 143;BA.debugLine="LVdecks.AddSingleLine(et1.Text)";
Debug.ShouldStop(16384);
main.mostCurrent._lvdecks.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(main.mostCurrent._et1.runMethod(true,"getText"))));
 BA.debugLineNum = 146;BA.debugLine="deck.Put(et1.Text, newsubdeck)";
Debug.ShouldStop(131072);
main._deck.runVoidMethod ("Put",(Object)((main.mostCurrent._et1.runMethod(true,"getText"))),(Object)((_newsubdeck.getObject())));
 BA.debugLineNum = 147;BA.debugLine="SaveDecks";
Debug.ShouldStop(262144);
_savedecks();
 BA.debugLineNum = 149;BA.debugLine="et1.Text = \"\"";
Debug.ShouldStop(1048576);
main.mostCurrent._et1.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
 };
...
try {
		Debug.PushSubsStack("create_subdeck_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,198);
if (RapidSub.canDelegate("create_subdeck_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","create_subdeck_click");}
 BA.debugLineNum = 198;BA.debugLine="Private Sub create_subdeck_Click";
Debug.ShouldStop(32);
 BA.debugLineNum = 199;BA.debugLine="newsubdeckpanel.Visible = True";
Debug.ShouldStop(64);
main.mostCurrent._newsubdeckpanel.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 200;BA.debugLine="decksettingpanel.Visible = False";
...
try {
		Debug.PushSubsStack("createnewsubdeck_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,238);
...
RemoteObject _subdeck = RemoteObject.createImmutable("");
 BA.debugLineNum = 238;BA.debugLine="Private Sub createnewsubdeck_Click";
Debug.ShouldStop(8192);
 BA.debugLineNum = 239;BA.debugLine="If newsubdecket.Text = \"\" Then";
Debug.ShouldStop(16384);
if (RemoteObject.solveBoolean("=",main.mostCurrent._newsubdecket.runMethod(true,"getText"),BA.ObjectToString(""))) { 
 BA.debugLineNum = 240;BA.debugLine="MsgboxAsync(\"New Sub Deck must have a name\", \"Er";
Debug.ShouldStop(32768);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 243;BA.debugLine="Dim createdeck As Map = deck.Get(item_longclick)";
Debug.ShouldStop(262144);
...
_createdeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), main._deck.runMethod(false,"Get",(Object)((main._item_longclick))));Debug.locals.put("createdeck", _createdeck);Debug.locals.put("createdeck", _createdeck);
 BA.debugLineNum = 244;BA.debugLine="Dim flashcard As List";
Debug.ShouldStop(524288);
_flashcard = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("flashcard", _flashcard);
 BA.debugLineNum = 245;BA.debugLine="flashcard.Initialize";
Debug.ShouldStop(1048576);
_flashcard.runVoidMethod ("Initialize");
 BA.debugLineNum = 246;BA.debugLine="For Each subdeck As String In createdeck.Keys";
Debug.ShouldStop(2097152);
{
...
Debug.locals.put("subdeck", _subdeck);
 BA.debugLineNum = 247;BA.debugLine="If newsubdecket.Text = subdeck Then";
Debug.ShouldStop(4194304);
if (RemoteObject.solveBoolean("=",main.mostCurrent._newsubdecket.runMethod(true,"getText"),_subdeck)) { 
 BA.debugLineNum = 248;BA.debugLine="MsgboxAsync(\"Subdeck Already Exist\", \"Error\")";
Debug.ShouldStop(8388608);
...
;
 BA.debugLineNum = 252;BA.debugLine="createdeck.Put(newsubdecket.Text, flashcard)";
Debug.ShouldStop(134217728);
_createdeck.runVoidMethod ("Put",(Object)((main.mostCurrent._newsubdecket.runMethod(true,"getText"))),(Object)((_flashcard.getObject())));
 BA.debugLineNum = 253;BA.debugLine="SaveDecks";
Debug.ShouldStop(268435456);
_savedecks();
 BA.debugLineNum = 254;BA.debugLine="newsubdecket.Text = \"\"";
Debug.ShouldStop(536870912);
main.mostCurrent._newsubdecket.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 255;BA.debugLine="newsubdeckpanel.Visible = False";
Debug.ShouldStop(1073741824);
main.mostCurrent._newsubdeckpanel.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 256;BA.debugLine="StartActivity(Subdeck_Module)";
Debug.ShouldStop(-2147483648);
...
try {
		Debug.PushSubsStack("delete_deck_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,192);
if (RapidSub.canDelegate("delete_deck_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","delete_deck_click");}
 BA.debugLineNum = 192;BA.debugLine="Private Sub delete_deck_Click";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 193;BA.debugLine="deck.Remove(item_longclick)";
Debug.ShouldStop(1);
main._deck.runVoidMethod ("Remove",(Object)((main._item_longclick)));
 BA.debugLineNum = 194;BA.debugLine="decksettingpanel.Visible = False";
Debug.ShouldStop(2);
main.mostCurrent._decksettingpanel.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 195;BA.debugLine="refreshbtn_Click";
Debug.ShouldStop(4);
_refreshbtn_click();
...
try {
		Debug.PushSubsStack("LVdecks_ItemClick (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,162);
...
Debug.locals.put("Value", _value);
 BA.debugLineNum = 162;BA.debugLine="Private Sub LVdecks_ItemClick (Position As Int, Va";
Debug.ShouldStop(2);
 BA.debugLineNum = 164;BA.debugLine="selecteddeck = Value";
Debug.ShouldStop(8);
main._selecteddeck = BA.ObjectToString(_value);
 BA.debugLineNum = 165;BA.debugLine="StartActivity(Subdeck_Module)";
Debug.ShouldStop(16);
main.mostCurrent.__c.runVoidMethod ("StartActivity",main.processBA,(Object)((main.mostCurrent._subdeck_module.getObject())));
...
try {
		Debug.PushSubsStack("LVdecks_ItemLongClick (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,168);
...
Debug.locals.put("Position", _position);
Debug.locals.put("Value", _value);
 BA.debugLineNum = 168;BA.debugLine="Private Sub LVdecks_ItemLongClick (Position As Int";
Debug.ShouldStop(128);
 BA.debugLineNum = 170;BA.debugLine="decksettingpanel.Visible = True";
Debug.ShouldStop(512);
main.mostCurrent._decksettingpanel.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 171;BA.debugLine="item_longclick = Value";
Debug.ShouldStop(1024);
main._item_longclick = BA.ObjectToString(_value);
 BA.debugLineNum = 172;BA.debugLine="selecteddeck = Value";
Debug.ShouldStop(2048);
main._selecteddeck = BA.ObjectToString(_value);
...
try {
		Debug.PushSubsStack("refreshbtn_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,154);
...
RemoteObject _deckname = RemoteObject.createImmutable("");
 BA.debugLineNum = 154;BA.debugLine="Private Sub refreshbtn_Click";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 156;BA.debugLine="LVdecks.clear";
Debug.ShouldStop(134217728);
main.mostCurrent._lvdecks.runVoidMethod ("Clear");
 BA.debugLineNum = 157;BA.debugLine="For Each deckName As String In deck.keys";
Debug.ShouldStop(268435456);
{
...
Debug.locals.put("deckName", _deckname);
 BA.debugLineNum = 158;BA.debugLine="LVdecks.AddSingleLine(deckName)";
Debug.ShouldStop(536870912);
...
try {
		Debug.PushSubsStack("rename_deck_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,187);
if (RapidSub.canDelegate("rename_deck_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","rename_deck_click");}
 BA.debugLineNum = 187;BA.debugLine="Private Sub rename_deck_Click";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 188;BA.debugLine="decksettingpanel.Visible = False";
Debug.ShouldStop(134217728);
main.mostCurrent._decksettingpanel.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 189;BA.debugLine="renamepanel.Visible = True";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("SaveDecks (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,102);
if (RapidSub.canDelegate("savedecks")) { return b4a.example.main.remoteMe.runUserSub(false, "main","savedecks");}
 BA.debugLineNum = 102;BA.debugLine="Sub SaveDecks";
Debug.ShouldStop(32);
 BA.debugLineNum = 103;BA.debugLine="kvs.Put(\"deck_data\", deck)";
Debug.ShouldStop(64);
