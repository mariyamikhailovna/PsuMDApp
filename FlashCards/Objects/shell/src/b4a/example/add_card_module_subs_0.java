...
try {
		Debug.PushSubsStack("Activity_Create (add_card_module) ","add_card_module",7,add_card_module.mostCurrent.activityBA,add_card_module.mostCurrent,22);
...
Debug.ShouldStop(2097152);
 BA.debugLineNum = 28;BA.debugLine="Activity.LoadLayout(\"Layout3\")";
Debug.ShouldStop(134217728);
add_card_module.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Layout3")),add_card_module.mostCurrent.activityBA);
 BA.debugLineNum = 31;BA.debugLine="Dim tappeddeck As Map =  Main.deck.Get(Main.selec";
Debug.ShouldStop(1073741824);
_tappeddeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), add_card_module.mostCurrent._main._deck /*RemoteObject*/ .runMethod(false,"Get",(Object)((add_card_module.mostCurrent._main._selecteddeck /*RemoteObject*/ ))));Debug.locals.put("tappeddeck", _tappeddeck);Debug.locals.put("tappeddeck", _tappeddeck);
...
try {
		Debug.PushSubsStack("Activity_Pause (add_card_module) ","add_card_module",7,add_card_module.mostCurrent.activityBA,add_card_module.mostCurrent,44);
...
try {
		Debug.PushSubsStack("Activity_Resume (add_card_module) ","add_card_module",7,add_card_module.mostCurrent.activityBA,add_card_module.mostCurrent,40);
...
try {
		Debug.PushSubsStack("backbtn_Click (add_card_module) ","add_card_module",7,add_card_module.mostCurrent.activityBA,add_card_module.mostCurrent,89);
...
try {
		Debug.PushSubsStack("SaveCard_Click (add_card_module) ","add_card_module",7,add_card_module.mostCurrent.activityBA,add_card_module.mostCurrent,52);
...
Debug.ShouldStop(524288);
 BA.debugLineNum = 56;BA.debugLine="Dim tappeddeck As Map = Main.deck.Get(Main.select";
...
try {
		Debug.PushSubsStack("SaveDecks (add_card_module) ","add_card_module",7,add_card_module.mostCurrent.activityBA,add_card_module.mostCurrent,47);
...
Debug.ShouldStop(16384);
 BA.debugLineNum = 48;BA.debugLine="Main.kvs.Put(\"deck_data\", Main.deck)";
Debug.ShouldStop(32768);
add_card_module.mostCurrent._main._kvs /*RemoteObject*/ .runClassMethod (b4a.example.keyvaluestore.class, "_put" /*RemoteObject*/ ,(Object)(BA.ObjectToString("deck_data")),(Object)((add_card_module.mostCurrent._main._deck /*RemoteObject*/ .getObject())));
