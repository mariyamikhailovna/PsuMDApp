...
try {
		Debug.PushSubsStack("activerecall_Click (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,148);
...
RemoteObject _flashacards = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
 BA.debugLineNum = 148;BA.debugLine="Private Sub activerecall_Click";
Debug.ShouldStop(524288);
 BA.debugLineNum = 151;BA.debugLine="number_of_cards = 0";
Debug.ShouldStop(4194304);
subdeck_module._number_of_cards = BA.numberCast(int.class, 0);
 BA.debugLineNum = 153;BA.debugLine="Dim chosendeck As Map = alldecks.Get(selecteddeck";
...
_chosendeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), subdeck_module.mostCurrent._alldecks.runMethod(false,"Get",(Object)((subdeck_module.mostCurrent._selecteddeck))));Debug.locals.put("chosendeck", _chosendeck);Debug.locals.put("chosendeck", _chosendeck);
 BA.debugLineNum = 155;BA.debugLine="For Each deckName As String In chosendeck.keys";
...
Debug.locals.put("deckName", _deckname);
 BA.debugLineNum = 156;BA.debugLine="Dim flashacards As List = chosendeck.Get(deckNam";
...
_flashacards = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _chosendeck.runMethod(false,"Get",(Object)((_deckname))));Debug.locals.put("flashacards", _flashacards);Debug.locals.put("flashacards", _flashacards);
 BA.debugLineNum = 157;BA.debugLine="number_of_cards = number_of_cards + flashacards.";
...
;
 BA.debugLineNum = 160;BA.debugLine="AR_confirmationpanel.Visible = True";
...
subdeck_module.mostCurrent._ar_confirmationpanel.runMethod(true,"setVisible",subdeck_module.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 161;BA.debugLine="confirmlabel.Text = \"You got \" & number_of_cards";
Debug.ShouldStop(1);
...
try {
		Debug.PushSubsStack("Activity_Create (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,35);
...
Debug.ShouldStop(4);
 BA.debugLineNum = 40;BA.debugLine="Activity.LoadLayout(\"Layout2\")";
Debug.ShouldStop(128);
subdeck_module.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Layout2")),subdeck_module.mostCurrent.activityBA);
 BA.debugLineNum = 43;BA.debugLine="Dim radius As Int = Addbtn.Width/2";
...
_cd = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.ColorDrawable");Debug.locals.put("cd", _cd);
 BA.debugLineNum = 45;BA.debugLine="cd.Initialize(Colors.Gray, radius)";
...
_cd.runVoidMethod ("Initialize",(Object)(subdeck_module.mostCurrent.__c.getField(false,"Colors").getField(true,"Gray")),(Object)(_radius));
 BA.debugLineNum = 46;BA.debugLine="Addbtn.Background = cd";
Debug.ShouldStop(8192);
subdeck_module.mostCurrent._addbtn.runMethod(false,"setBackground",(_cd.getObject()));
 BA.debugLineNum = 49;BA.debugLine="decknamelabel.Text = selecteddeck";
...
subdeck_module.mostCurrent._decknamelabel.runMethod(true,"setText",BA.ObjectToCharSequence(subdeck_module.mostCurrent._selecteddeck));
 BA.debugLineNum = 51;BA.debugLine="LVSubdecks.SingleLineLayout.Label.textColor = Col";
...
subdeck_module.mostCurrent._lvsubdecks.runMethod(false,"getSingleLineLayout").getField(false,"Label").runMethod(true,"setTextColor",subdeck_module.mostCurrent.__c.getField(false,"Colors").getField(true,"Black"));
 BA.debugLineNum = 53;BA.debugLine="Refresh";
...
try {
		Debug.PushSubsStack("Activity_Pause (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,76);
...
try {
		Debug.PushSubsStack("Activity_Resume (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,72);
...
try {
		Debug.PushSubsStack("Addbtn_Click (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,81);
if (RapidSub.canDelegate("addbtn_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","addbtn_click");}
 BA.debugLineNum = 81;BA.debugLine="Private Sub Addbtn_Click";
Debug.ShouldStop(65536);
 BA.debugLineNum = 83;BA.debugLine="If addpanel2.Visible = False Then";
Debug.ShouldStop(262144);
...
try {
		Debug.PushSubsStack("addcard_Click (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,91);
...
RemoteObject _tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 91;BA.debugLine="Private Sub addcard_Click";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 93;BA.debugLine="Dim tappeddeck As Map = Main.deck.Get(Main.select";
Debug.ShouldStop(268435456);
_tappeddeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), subdeck_module.mostCurrent._main._deck /*RemoteObject*/ .runMethod(false,"Get",(Object)((subdeck_module.mostCurrent._main._selecteddeck /*RemoteObject*/ ))));Debug.locals.put("tappeddeck", _tappeddeck);Debug.locals.put("tappeddeck", _tappeddeck);
 BA.debugLineNum = 94;BA.debugLine="If tappeddeck.Size = 0 Then";
Debug.ShouldStop(536870912);
if (RemoteObject.solveBoolean("=",_tappeddeck.runMethod(true,"getSize"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 95;BA.debugLine="MsgboxAsync(\"Create A Sub-Deck first\", \"Error\")";
...
try {
		Debug.PushSubsStack("addsub_Click (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,101);
if (RapidSub.canDelegate("addsub_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","addsub_click");}
 BA.debugLineNum = 101;BA.debugLine="Private Sub addsub_Click";
Debug.ShouldStop(16);
 BA.debugLineNum = 103;BA.debugLine="addpanel.Visible = True";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("backbtn_Click (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,185);
if (RapidSub.canDelegate("backbtn_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","backbtn_click");}
 BA.debugLineNum = 185;BA.debugLine="Private Sub backbtn_Click";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("cancel_Click (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,106);
if (RapidSub.canDelegate("cancel_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","cancel_click");}
 BA.debugLineNum = 106;BA.debugLine="Private Sub cancel_Click";
Debug.ShouldStop(512);
 BA.debugLineNum = 108;BA.debugLine="addpanel.Visible = False";
Debug.ShouldStop(2048);
subdeck_module.mostCurrent._addpanel.runMethod(true,"setVisible",subdeck_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 109;BA.debugLine="et1.Text = \"\"";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("cancelalter_Click (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,202);
if (RapidSub.canDelegate("cancelalter_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","cancelalter_click");}
 BA.debugLineNum = 202;BA.debugLine="Private Sub cancelalter_Click";
Debug.ShouldStop(512);
 BA.debugLineNum = 203;BA.debugLine="alterpanel.Visible = False";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("cancelconfirmation_Click (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,173);
if (RapidSub.canDelegate("cancelconfirmation_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","cancelconfirmation_click");}
 BA.debugLineNum = 173;BA.debugLine="Private Sub cancelconfirmation_Click";
Debug.ShouldStop(4096);
 BA.debugLineNum = 175;BA.debugLine="AR_confirmationpanel.Visible = False";
...
try {
		Debug.PushSubsStack("cancelrename_Click (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,211);
if (RapidSub.canDelegate("cancelrename_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","cancelrename_click");}
 BA.debugLineNum = 211;BA.debugLine="Private Sub cancelrename_Click";
Debug.ShouldStop(262144);
...
subdeck_module.mostCurrent._renamepanel.runMethod(true,"setVisible",subdeck_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 213;BA.debugLine="renameet.Text = \"\"";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("confirmrename_Click (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,216);
...
RemoteObject _names = RemoteObject.createImmutable("");
 BA.debugLineNum = 216;BA.debugLine="Private Sub confirmrename_Click";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 218;BA.debugLine="Dim getsubdeck As list";
Debug.ShouldStop(33554432);
_getsubdeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("getsubdeck", _getsubdeck);
 BA.debugLineNum = 219;BA.debugLine="Dim tappeddeck As Map = Main.deck.Get(Main.select";
Debug.ShouldStop(67108864);
_tappeddeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), subdeck_module.mostCurrent._main._deck /*RemoteObject*/ .runMethod(false,"Get",(Object)((subdeck_module.mostCurrent._main._selecteddeck /*RemoteObject*/ ))));Debug.locals.put("tappeddeck", _tappeddeck);Debug.locals.put("tappeddeck", _tappeddeck);
 BA.debugLineNum = 220;BA.debugLine="If renameet.Text = \"\" Then";
Debug.ShouldStop(134217728);
if (RemoteObject.solveBoolean("=",subdeck_module.mostCurrent._renameet.runMethod(true,"getText"),BA.ObjectToString(""))) { 
 BA.debugLineNum = 221;BA.debugLine="MsgboxAsync(\"New Name must have a name\", \"Error\"";
Debug.ShouldStop(268435456);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 224;BA.debugLine="For Each names As String In tappeddeck.keys";
Debug.ShouldStop(-2147483648);
{
...
Debug.locals.put("names", _names);
 BA.debugLineNum = 225;BA.debugLine="getsubdeck = tappeddeck.Get(selectedsubdeck)";
Debug.ShouldStop(1);
_getsubdeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _tappeddeck.runMethod(false,"Get",(Object)((subdeck_module._selectedsubdeck))));Debug.locals.put("getsubdeck", _getsubdeck);
 BA.debugLineNum = 226;BA.debugLine="If renameet.Text = names Then";
Debug.ShouldStop(2);
if (RemoteObject.solveBoolean("=",subdeck_module.mostCurrent._renameet.runMethod(true,"getText"),_names)) { 
 BA.debugLineNum = 227;BA.debugLine="MsgboxAsync(\"Sub Deck Name Already Exist\", \"Err";
Debug.ShouldStop(4);
...
;
 BA.debugLineNum = 231;BA.debugLine="tappeddeck.Remove(selectedsubdeck)";
Debug.ShouldStop(64);
_tappeddeck.runVoidMethod ("Remove",(Object)((subdeck_module._selectedsubdeck)));
 BA.debugLineNum = 232;BA.debugLine="tappeddeck.Put(renameet.Text, getsubdeck)";
Debug.ShouldStop(128);
_tappeddeck.runVoidMethod ("Put",(Object)((subdeck_module.mostCurrent._renameet.runMethod(true,"getText"))),(Object)((_getsubdeck.getObject())));
 BA.debugLineNum = 233;BA.debugLine="renameet.text = \"\"";
Debug.ShouldStop(256);
subdeck_module.mostCurrent._renameet.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 234;BA.debugLine="SaveDecks";
Debug.ShouldStop(512);
_savedecks();
 BA.debugLineNum = 235;BA.debugLine="Refresh";
Debug.ShouldStop(1024);
_refresh();
 BA.debugLineNum = 236;BA.debugLine="renamepanel.Visible = False";
Debug.ShouldStop(2048);
subdeck_module.mostCurrent._renamepanel.runMethod(true,"setVisible",subdeck_module.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("create_Click (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,112);
...
RemoteObject _name = RemoteObject.declareNull("Object");
 BA.debugLineNum = 112;BA.debugLine="Private Sub create_Click";
Debug.ShouldStop(32768);
 BA.debugLineNum = 115;BA.debugLine="Dim tappeddeck As Map = alldecks.Get(selecteddeck";
Debug.ShouldStop(262144);
_tappeddeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), subdeck_module.mostCurrent._alldecks.runMethod(false,"Get",(Object)((subdeck_module.mostCurrent._selecteddeck))));Debug.locals.put("tappeddeck", _tappeddeck);Debug.locals.put("tappeddeck", _tappeddeck);
 BA.debugLineNum = 116;BA.debugLine="Dim flashcards As List";
Debug.ShouldStop(524288);
_flashcards = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("flashcards", _flashcards);
 BA.debugLineNum = 118;BA.debugLine="flashcards.initialize";
Debug.ShouldStop(2097152);
_flashcards.runVoidMethod ("Initialize");
 BA.debugLineNum = 121;BA.debugLine="For Each name In tappeddeck.Keys";
Debug.ShouldStop(16777216);
{
...
Debug.locals.put("name", _name);
 BA.debugLineNum = 122;BA.debugLine="If et1.Text = name Then";
Debug.ShouldStop(33554432);
if (RemoteObject.solveBoolean("=",subdeck_module.mostCurrent._et1.runMethod(true,"getText"),BA.ObjectToString(_name))) { 
 BA.debugLineNum = 123;BA.debugLine="MsgboxAsync(\"Sub-Deck Already Exist\", \"Error\")";
Debug.ShouldStop(67108864);
...
;
 BA.debugLineNum = 129;BA.debugLine="If et1.Text = \"\" Then";
Debug.ShouldStop(1);
if (RemoteObject.solveBoolean("=",subdeck_module.mostCurrent._et1.runMethod(true,"getText"),BA.ObjectToString(""))) { 
 BA.debugLineNum = 130;BA.debugLine="MsgboxAsync(\"Sub-Deck must have a name\", \"Error\"";
Debug.ShouldStop(2);
subdeck_module.mostCurrent.__c.runVoidMethod ("MsgboxAsync",(Object)(BA.ObjectToCharSequence("Sub-Deck must have a name")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Error"))),subdeck_module.processBA);
 ...
 BA.debugLineNum = 133;BA.debugLine="addpanel.Visible = False";
Debug.ShouldStop(16);
subdeck_module.mostCurrent._addpanel.runMethod(true,"setVisible",subdeck_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 134;BA.debugLine="LVSubdecks.AddSingleLine(et1.Text)";
Debug.ShouldStop(32);
subdeck_module.mostCurrent._lvsubdecks.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(subdeck_module.mostCurrent._et1.runMethod(true,"getText"))));
 BA.debugLineNum = 135;BA.debugLine="tappeddeck.Put(et1.Text, flashcards)";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("deletesubdeck_Click (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,189);
...
RemoteObject _tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 189;BA.debugLine="Private Sub deletesubdeck_Click";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 190;BA.debugLine="alterpanel.Visible = False";
Debug.ShouldStop(536870912);
subdeck_module.mostCurrent._alterpanel.runMethod(true,"setVisible",subdeck_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 191;BA.debugLine="Dim tappeddeck As Map = Main.deck.get(Main.select";
Debug.ShouldStop(1073741824);
_tappeddeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), subdeck_module.mostCurrent._main._deck /*RemoteObject*/ .runMethod(false,"Get",(Object)((subdeck_module.mostCurrent._main._selecteddeck /*RemoteObject*/ ))));Debug.locals.put("tappeddeck", _tappeddeck);Debug.locals.put("tappeddeck", _tappeddeck);
 BA.debugLineNum = 192;BA.debugLine="tappeddeck.Remove(selectedsubdeck)";
Debug.ShouldStop(-2147483648);
_tappeddeck.runVoidMethod ("Remove",(Object)((subdeck_module._selectedsubdeck)));
 BA.debugLineNum = 193;BA.debugLine="SaveDecks";
Debug.ShouldStop(1);
_savedecks();
 BA.debugLineNum = 194;BA.debugLine="Refresh";
Debug.ShouldStop(2);
_refresh();
...
subdeck_module.mostCurrent._addpanel2 = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");
 //BA.debugLineNum = 21;BA.debugLine="Dim alldecks As Map = Main.deck 'taking the whole";
subdeck_module.mostCurrent._alldecks = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
subdeck_module.mostCurrent._alldecks = subdeck_module.mostCurrent._main._deck /*RemoteObject*/ ;
 //BA.debugLineNum = 22;BA.debugLine="Dim selecteddeck As String = Main.selecteddeck 't";
subdeck_module.mostCurrent._selecteddeck = subdeck_module.mostCurrent._main._selecteddeck /*RemoteObject*/ ;
...
try {
		Debug.PushSubsStack("goback_Click (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,143);
...
try {
		Debug.PushSubsStack("LVSubdecks_ItemClick (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,178);
...
Debug.locals.put("Value", _value);
 BA.debugLineNum = 178;BA.debugLine="Private Sub LVSubdecks_ItemClick (Position As Int,";
Debug.ShouldStop(131072);
 BA.debugLineNum = 180;BA.debugLine="selectedsubdeck = Value 'gives the chsoen subdeck";
Debug.ShouldStop(524288);
subdeck_module._selectedsubdeck = BA.ObjectToString(_value);
 BA.debugLineNum = 182;BA.debugLine="StartActivity(Card_Module)";
Debug.ShouldStop(2097152);
...
try {
		Debug.PushSubsStack("LVSubdecks_ItemLongClick (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,206);
...
Debug.locals.put("Position", _position);
Debug.locals.put("Value", _value);
 BA.debugLineNum = 206;BA.debugLine="Private Sub LVSubdecks_ItemLongClick (Position As";
Debug.ShouldStop(8192);
 BA.debugLineNum = 207;BA.debugLine="alterpanel.Visible = True";
Debug.ShouldStop(16384);
subdeck_module.mostCurrent._alterpanel.runMethod(true,"setVisible",subdeck_module.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 208;BA.debugLine="selectedsubdeck = Value";
Debug.ShouldStop(32768);
subdeck_module._selectedsubdeck = BA.ObjectToString(_value);
...
try {
		Debug.PushSubsStack("Refresh (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,61);
...
Debug.ShouldStop(268435456);
 BA.debugLineNum = 62;BA.debugLine="LVSubdecks.clear";
Debug.ShouldStop(536870912);
subdeck_module.mostCurrent._lvsubdecks.runVoidMethod ("Clear");
 BA.debugLineNum = 64;BA.debugLine="Dim tappeddeck As Map = alldecks.Get(selecteddeck";
Debug.ShouldStop(-2147483648);
_tappeddeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), subdeck_module.mostCurrent._alldecks.runMethod(false,"Get",(Object)((subdeck_module.mostCurrent._selecteddeck))));Debug.locals.put("tappeddeck", _tappeddeck);Debug.locals.put("tappeddeck", _tappeddeck);
 BA.debugLineNum = 67;BA.debugLine="For Each deckName As String In tappeddeck.keys";
Debug.ShouldStop(4);
{
...
_deckname = BA.ObjectToString(group3.runMethod(false,"Get",index3));Debug.locals.put("deckName", _deckname);
Debug.locals.put("deckName", _deckname);
 BA.debugLineNum = 68;BA.debugLine="LVSubdecks.AddSingleLine(deckName)";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("renamesubdeck_Click (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,197);
if (RapidSub.canDelegate("renamesubdeck_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","renamesubdeck_click");}
 BA.debugLineNum = 197;BA.debugLine="Private Sub renamesubdeck_Click";
Debug.ShouldStop(16);
 BA.debugLineNum = 198;BA.debugLine="alterpanel.Visible = False";
Debug.ShouldStop(32);
subdeck_module.mostCurrent._alterpanel.runMethod(true,"setVisible",subdeck_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 199;BA.debugLine="renamepanel.visible = True";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("SaveDecks (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,57);
if (RapidSub.canDelegate("savedecks")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","savedecks");}
 BA.debugLineNum = 57;BA.debugLine="Sub SaveDecks";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 58;BA.debugLine="Main.kvs.Put(\"deck_data\", Main.deck)";
Debug.ShouldStop(33554432);
subdeck_module.mostCurrent._main._kvs /*RemoteObject*/ .runClassMethod (b4a.example.keyvaluestore.class, "_put" /*RemoteObject*/ ,(Object)(BA.ObjectToString("deck_data")),(Object)((subdeck_module.mostCurrent._main._deck /*RemoteObject*/ .getObject())));
...
try {
		Debug.PushSubsStack("startArbtn_Click (subdeck_module) ","subdeck_module",2,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,164);
if (RapidSub.canDelegate("startarbtn_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","startarbtn_click");}
 BA.debugLineNum = 164;BA.debugLine="Private Sub startArbtn_Click";
Debug.ShouldStop(8);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 170;BA.debugLine="StartActivity(ALL_ACTIVE_RECALL)";
Debug.ShouldStop(512);
