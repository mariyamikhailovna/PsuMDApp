...
try {
		Debug.PushSubsStack("Activity_Create (all_active_recall) ","all_active_recall",4,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,26);
...
all_active_recall.mostCurrent.__c.runVoidMethod ("RndSeed",(Object)(all_active_recall.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"getNow")));
 BA.debugLineNum = 35;BA.debugLine="Dim chosendeck As Map = Main.deck.Get(Main.select";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("Activity_Pause (all_active_recall) ","all_active_recall",4,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,86);
...
try {
		Debug.PushSubsStack("Activity_Resume (all_active_recall) ","all_active_recall",4,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,82);
...
try {
		Debug.PushSubsStack("backbtn_Click (all_active_recall) ","all_active_recall",4,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,105);
...
try {
		Debug.PushSubsStack("goback_Click (all_active_recall) ","all_active_recall",4,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,132);
...
try {
		Debug.PushSubsStack("nextbtn_Click (all_active_recall) ","all_active_recall",4,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,116);
...
try {
		Debug.PushSubsStack("showAnswerbtn_Click (all_active_recall) ","all_active_recall",4,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,91);
...
try {
		Debug.PushSubsStack("Showcard (all_active_recall) ","all_active_recall",4,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,74);
...
try {
		Debug.PushSubsStack("ShowProgress (all_active_recall) ","all_active_recall",4,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,55);
...
try {
		Debug.PushSubsStack("ShuffleCards (all_active_recall) ","all_active_recall",4,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,63);
