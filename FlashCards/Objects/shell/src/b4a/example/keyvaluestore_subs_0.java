...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","97012375",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.runMethod(false,"getActivityBA"))),0);
 if (true) break;
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","97077896",RemoteObject.concat(RemoteObject.createImmutable("Failed to serialize object: "),_map.runMethod(false,"Get",(Object)((_key)))),0);
 if (true) break;
